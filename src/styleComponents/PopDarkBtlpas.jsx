...
body .main.world3 {
    .popup-layer .m-popup.dark-btlpas {
        ...
        top: 52px;
        &:before {
            background-image: url(~imgPath/images/back/new/07-Cemetery.jpg);
        ...
        .btlpass-box-all {
            ...
            .btlpass-collect-box-all {
                    ...
                    .btlpass-collect-box-text {
                        ...
                        .ic-event {
                            ...
                            &:before {
                                ...
                                margin: 0 0 0 4px;
                                top: 2px;
                                background-image: url(~imgPath/ic-red-potion-40.png);
                                background-size: 100%;
                                transform: scale(1.4);
                            }
                        }
                ...
                .hero-box-title {
                    ...
                    white-space: nowrap;
                    background: #ae5ed7;
                    filter: drop-shadow(0 1px 0 #8447a3)
                        drop-shadow(0 1px 0 #8447a3)
            ...
            .btlpass-level-box-all {
                ...
                .btlpass-buy-box-all {
                    ...
                    .btlpass-girl {
                        ...
                        position: absolute;
                        bottom: 0;
                        background-image: url(~imgPath/break-girl807.png),
                            radial-gradient(
