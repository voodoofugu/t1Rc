...
.popup-layer .m-popup.openchest {
                ...
                .openchest-bonus {
                    ...
                    &.open {
                        .openchest-pic-chest {
                            @include prefix(
                                animation,
                                anim-change-chest 0.35s linear 10ms forwards
                            );
                            background-image: url(~imgPath/change-sun1.png);
                            background-size: 100%;
                        }
                    ...
                    &.close {
                        .openchest-pic-chest {
                            @include prefix(
                                animation,
                                anim-close-chest 0.45s linear 1s forwards
                            );
                            background-image: url(~imgPath/change-sun3.png);
                            background-size: 100%;
                        }
                    }
    ...
    .openchest-right-box {
        ...
        .openchest-btn-info.left {
            ...
            cursor: pointer;
            display: none;
            background-image: url(~imgPath/info-btn-left.png);
            background-size: 100%;
            &:hover {
                filter: brightness(1.1);
            }
    ...
    .openchest-btn-back {
        ...
        top: 15px;
        left: 0;
        background-image: url(~imgPath/back-btn.png);
        background-size: 100%;
        cursor: pointer;
        &:hover {
            filter: brightness(1.1);
...
.openchest-btn-info {
    ...
    &.right {
        background-image: url(~imgPath/info-btn-right.png);
        background-size: 100%;
    }
    &.left {
        background-image: url(~imgPath/info-btn-left.png);
