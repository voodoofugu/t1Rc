    ...
    .cardreward-box-all {
        ...
        .cardreward-box {
            ...
            .card-box-back {
                ...
                top: 10px;
                left: 12px;
                background-image: url(~imgPath/v2-rb-card-bg.jpg);
                background-size: 100%;
                ...
                .rb-card-light {
                    ...
                    top: 0;
                    left: 0;
                    background-image: url(~imgPath/rb-card-light.png);
                    background-size: 100%;
                    display: none;
                }
            }
        ...
        &.choose {
            .cardreward-box {
                ...
                &.gold {
                    .card-box-back {
                        background-image: url(~imgPath/v2-rb-card-bg-gold.jpg);
                        .card-vis {
                            display: none;
                        }
                        .reward-pic {
                        ...
                        .rb-card-light {
                            display: block;
                            @include prefix(animation, light 1s infinite);
                            @keyframes light {
                                0% {
                ...
                &.silver {
                    .card-box-back {
                        background-image: url(~imgPath/v2-rb-card-bg-silver.jpg);
                        .card-vis {
                            display: none;
                        }
                        .reward-pic {
                ...
                &.bronze {
                    .card-box-back {
                        background-image: url(~imgPath/v2-rb-card-bg-bronze.jpg);
                        .card-vis {
                            display: none;
                        }
                        .reward-pic {
