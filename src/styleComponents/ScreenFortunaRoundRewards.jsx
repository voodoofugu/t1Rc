...
.popup-layer .m-popup.fortuna-main-round-rewards{
    width: 750px; height: 490px; left: 225px; top: 75px;
    &:before{content: ""; background: linear-gradient(136deg, #8e7453 0%, #e3c7a3 50%, #ae916a 85%, #8f7553 100%);}
    .title{color: #572f14;}
    .rewards-main-box{
        width: 710px; height: 410px; position: absolute; top: 70px; left: 20px;
        ...
        .rrevard-box{
            ...
            .rname-box{
                width: 350px; height: 34px; position: absolute; background-color: #ffcb39;
            ...
            .fortuna-reward-box-all{
                ...
                .fortuna-reward-box{
                    ...
                    .fortuna-reward-bg{
                        ...
                        img{width: 45px; position: absolute; top: 2px; left: 2px;} 
                    }
            ...
            &.r2{top: 0; left: 360px;}
            &.r3{top: 120px; left: 0;}
            &.r4{top: 120px; left: 360px;}
            &.r5{top: 240px; left: 0;}
            &.r6{top: 240px; left: 360px;}
...
export default ScreenFortunaRoundRewards;
