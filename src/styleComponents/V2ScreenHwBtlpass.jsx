...
const V2ScreenHwBtlpass = styled.div`
  @charset "utf-8";
...
.popup-layer .m-popup.hw-btlpass-pop {
    ...
    .color-box {
        background-image: url(~imgPath/pop-bg-hw.jpg);
    ...
    .hw-btlpass-box-all {
        ...
        .hw-btlpass-level-box-all {
            ...
            .hw-btlpass-level-simple-box-scroll {
                width: 535px;
                height: 113px;
                position: absolute;
                top: 9px;
                ...
                .hw-btlpass-level-simple,
                .hw-btlpass-level-elite {
                    ...
                    .hw-btlpass-level-rew-box {
                        ...
                        .hw-btlpass-level-rew-num-block {
                            width: 60px;
                            height: 60px;
                            position: absolute;
                            top: 0;
                ...
                .hw-btlpass-level-level {
                    ...
                    // transform: rotate(-90deg) translateX(-1736px)
                    //     translateY(-1739px) scaleX(-1);
                    // white-space: nowrap;
                    .hw-btlpass-level-level-prg {
                        width: 10%;
                        height: 100%;
                        position: relative;
                        background: linear-gradient(
                    ...
                    .hw-btlpass-level-level-num-box {
                        width: 100%;
                        height: 20px;
                        position: absolute;
                        top: 0;
                ...
                .hw-btlpass-level-elite {
                    top: 10px;
                    // transform: rotate(-90deg) translateX(-1686px)
                    //     translateY(-1689px) scaleX(-1);
                    // white-space: nowrap;
                }
            }
        }
...
export default V2ScreenHwBtlpass;
