...
const V2ScreenTitansUpgradeStyles = css`
  body .main {
    .left-side {
      width: 620px;
      height: 555px;
            ...
            .titans-center {
              ...
              .upgrades {
                ...
                .upgrade {
                  ...
                  &.atk .value:before {
                    background-image: url(../img/v2_at_magicgun_2.png);
                  }
                  &.hp .value:before {
                    background-image: url(../img/v2_at_magic_plate_2.png);
                  }
                  &.pow .value:before {
                    background-image: url(../img/v2_at_manabomb_2.png);
                  }
                }
              }
            }
            ...
            .titans-right {
              ...
              .hp-bar-bg {
                ...
                .hp-bar {
                  ...
                  box-shadow: inset 0 14px 0 0 rgba(255, 255, 255, 0.1);
                }
...
export default V2ScreenTitansUpgradeStyles;
