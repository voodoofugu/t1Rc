                            ...
                            .cw-main-right-a-box-edit-box {
                                ...
                                .color-btn {
                                    ...
                                    .color-btn-img {
                                        ...
                                        background-repeat: no-repeat;
                                        &.ns {
                                            background-image: url(~imgPath/cw-ic-ns.png);
                                        }
                                        &.pap {
                                            background-image: url(~imgPath/cw-ic-pap.png);
                                        }
                                        &.rup {
                                            background-image: url(~imgPath/cw-ic-rup.png);
                                        }
                                    }
                                    .color-btn-text {
                                        width: 100%;
                                ...
                                .color-btn.cw-exit {
                                    ...
                                    .color-btn-img {
                                        ...
                                        top: 5px;
                                        left: 5px;
                                        background-image: url(~imgPath/cw-ic-exit.png);
                                        background-size: 100%;
                                        background-repeat: no-repeat;
                                    }
                                    &:active {
