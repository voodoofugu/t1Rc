  ...
  body .main.world3 {
    .popup-layer {
      ...
      .m-popup.fortuna-main.sv-sale {
        ...
        &:before {
          content: "";
          background-image: url(../img/sv-sale-bg4.jpg);
          background-size: 100%;
        }
        ...
        .sv-sale-pack-box {
          ...
          &:before {
            ...
            box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.2),
              inset 0 -1px 0 rgba(0, 0, 0, 0.4), inset 33px 0 0 #76d13c;
          }
          &:after {
            content: "";
            width: 28px;
          ...
          &.buy {
            ...
            &:before {
              box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.2),
                inset 0 -1px 0 rgba(0, 0, 0, 0.4), inset 66px 0 0 #76d13c;
            }
            &:after {
        ...
        .sv-sale-uni-box-all {
          ...
          .sv-uni-all {
            ...
            top: 0;
            left: 0;
            background-image: url(../img/uni-bg-all.png);
            background-size: 100%;
            background-repeat: no-repeat;
            background-position: center;
            &.bf {
              background-image: url(../img/v2-bf-baloon2.png);
          ...
          .sv-chain1 {
            ...
            top: 0;
            left: 0;
            background-image: url(../img/uni-h-chain-1.png);
            background-size: 100%;
            background-repeat: no-repeat;
            background-position: center;
            &.bf {
          ...
          .sv-chain2 {
            ...
            top: 0;
            left: 0;
            background-image: url(../img/uni-h-chain-2.png);
            background-size: 100%;
            background-repeat: no-repeat;
            background-position: center;
            &.bf {
          ...
          .sv-reward-box {
            ...
            box-shadow: inset 0 1px rgba(255, 255, 255, 0.6),
              0 1px 4px 1px rgba(0, 0, 0, 0.4), inset 0 0 0 2px #ff9b37,
              0 0 0 1px #845a37, 0 2px 0 1px #845a37;
            background: url(../img/v2-trophy-bg.jpg), #845a37;
            background-size: 100%;
            background-repeat: no-repeat;
            z-index: 1;
        ...
        .lhero-box {
          ...
          .sv-sale-bonus-box-all {
            ...
            .acbonus-box {
              ...
              left: 1px;
              border-radius: 4px;
              box-shadow: 0 2px 0 #8b7b6e, 0 0 0 1px rgba(0, 0, 0, 0.1),
                0 1px 4px rgba(0, 0, 0, 0.6);
              background: linear-gradient(
                325deg,
                #c5c5c5 0%,
