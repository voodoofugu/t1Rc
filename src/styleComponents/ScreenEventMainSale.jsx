...
const ScreenEventMainSaleStyles = css`
    ...
    body .main.world2,
    body .main.world3 {
        .popup-layer .m-popup.sale-event-pop {
            width: 1006px;
            height: 580px;
            left: 97px;
            top: 30px;
            &.bf-event {
                ...
                .title {
                    ...
                    color: #fff;
                    text-shadow: 0 1px 2px rgba(0, 0, 0, 1), 0 0 1px #413753,
                        0 1px 1px #fff, 0 1px 10px #ffffff;
                }
                .v2-bf-sale {
            ...
            .v2-bf-sale {
                ...
                top: 204px;
                left: 34px;
                background-image: url(../img/v2-event-sale.png);
                background-size: 100%;
                background-repeat: no-repeat;
                color: #fff;
            ...
            .store-button {
                ...
                line-height: 21px;
                &:active {
                    box-shadow: 0 0 2px 1.5px rgba(0, 0, 0, 0.4),
                        inset 0 -18px 5px rgba(200, 119, 37, 0.59),
                        inset 0 -1px 0 #c87725, 0 0 12px #ff0, 0 0 5px #ffc,
                        inset 0 0 10px #ffc, inset 0 0 3px #603806 !important;
                    bottom: 29px;
