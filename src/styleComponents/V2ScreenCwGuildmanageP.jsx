...
const V2ScreenCwGuildmanageP = styled.div`
  @charset "utf-8";
@import "sass_commons.scss";


.popup-layer .m-popup.guildmanage-p{
    width: 590px;
    height: 265px;
    left: 305px;
    top: 80px;
    ...
    .cw-clan-manage-p-box-all{
        width: 530px; height: 160px; position: absolute; top: 80px; left: 30px;
        background-color: #cbaa81;
        box-shadow: 0 1px 2px rgba(0, 0, 0, 0.35);
        .cw-main-right-b-av{
            width: 380px; height: 80px; position: absolute; top: 10px; left: 75px;
            ...
            .cw-main-heroes-box {
                ...
                &.superheroines {
                    ...
                    .fw-as-num{background: linear-gradient(0deg, #1c91bd 0%, #a4e7ff 100%);}
                }
            }
        }
    }
    .cw-clan-manage-p-btn-box{
        width: 385px; height: 50px; position: absolute; bottom: 5px; left: 72px; font-size: 0;
        .color-btn{
            width: 120px; top: 0; margin: 0 4px;
            .color-btn-text{
                font-size: 12px; top: 16px;
            }
            &:active{
                box-shadow: inset 0 -2px 0px rgba(0, 0, 0, 0.20), inset 0 2px 2px rgba(0, 0, 0, 0.20);
                .color-btn-text{top: 17px;}
            }
        }
    }
...
export default V2ScreenCwGuildmanageP;
