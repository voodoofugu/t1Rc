...
const pageStyles = css`
    ...
    .popup-layer .m-popup.fortuna-winpop3 {
        ...
        &:before {
            ...
            filter: brightness(0.6) hue-rotate(330deg)
                drop-shadow(0 1px 1px #fff) drop-shadow(0 0 5px #fff);
    ...
    .main.world3 .popup-layer .m-popup.fortuna-winpop1,
    .main.world3 .popup-layer .m-popup.fortuna-winpop2,
    .main.world3 .popup-layer .m-popup.fortuna-winpop3 {
        &:before {
            background: url(../img/ts_confirm_bk-1.jpg);
            background-size: cover;
