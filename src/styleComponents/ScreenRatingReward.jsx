...
.popup-layer .m-popup.rating-reward {
  ...
  .rating-reward-box {
    ...
    .reward-chest-box {
      ...
      @include prefix(animation, chest-box 0.35s linear 0s);
      @keyframes chest-box {
        0% {
    ...
    &.open {
      .reward-box {
        ...
        @include prefix(animation, reward-box-open 0.35s linear 0s);
    ...
    .reward-box {
      ...
      &.prize {
        ...
        &:before {
          content: "";
          background: linear-gradient(0deg, #ffc131 0%, #ffde21 100%);
        ...
        @include prefix(animation, reward-box-prize 0.4s linear 0s);
