...
body .main {
    .portal-map-box {
        ...
        .header-btn-wrap {
            ...
            .header-bar {
                ...
                &:after {
                    ...
                    transform: translate(-50%, 0%);
                    position: absolute;
                    background-image: url(~imgPath/portal-map-bar-separator.png);
                ...
                .bar-chest {
                    ...
                    &:after {
                        ...
                        top: -1.6px;
                        left: 0px;
                        background-image: url(~imgPath/portal-map-bar-chest.png);
                ...
                .bar-chest-check {
                    &:after {
                        ...
                        top: -1.6px;
                        left: 0px;
                        background-image: url(~imgPath/portal-map-bar-chest-check.png);
                        background-size: 26px;
                        background-position: center;
                    }
                }
        ...
        .chest-pop-up {
            ...
            .girl-1 {
                background-image: url(~imgPath//images/hero-all/tithero-5007/x1/ava/tithero-5007-1-ava.jpg);
            }
            .girl-2 {
                background-image: url(~imgPath//images/hero-all/tithero-5010/x1/ava/tithero-5010-1-ava.jpg);
            }
            .girl-3 {
                background-image: url(~imgPath//images/hero-all/tithero-5009/x1/ava/tithero-5009-1-ava.jpg);
            }
        }
        .chest-pop-up-active {
            transition: transform 0.4s, opacity 0.4s;
