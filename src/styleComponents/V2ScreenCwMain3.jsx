    ...
    body .main{
        .left-side{
            ...
            #ffe199 100%);
                        ...
                        .fw-main-bl-box{
                            width: 1078px; height: 250px; position: absolute; top: 42px; left: 10px;
                            .fw-main-bl{
                                width: 350px; height: 250px; position: absolute;
                                background-color: #9c8b7c;
                                .fw-main-bl-name{
                                ...
                                .fw-main-bl-pic{
                                    width: 150px; height: 150px; position: absolute; top: 40px; left: 100px;
                                    img{width: 150px;}
                                }
                                .color-btn{
                                    width: 160px; height: 40px; position: absolute; bottom: 10px; left: 95px;
                                }
                                &.fraction{right: 0;}
                                &.shop{
                                    left: 364px;
                                    ...
                                    .cw-map-name-box-all{
                                        ...
                                        .cw-map-name-box{
                                            ...
                                            text-align: center;
                                            .cw-map-name, .cw-map-date{
                                                width: 250px; height: auto; position: relative; top: 5px; display: inline-block;
                                                color: #ffc000; font-size: 14px; font-weight: bold;
                                                text-transform: uppercase;
                                                text-shadow: 0 1px 2px rgba(0, 0, 0, 0.75);
                                            }
                                            .cw-map-date{color: #fff; font-size: 16px;}
                                        }
                                        .cw-map-time-box{
                        ...
                        .fw-level-box-all{
                            width: 1078px; height: 200px; position: absolute; bottom: 10px; right: 10px;
                            background-color: #8f7c6e; text-align: center;
                            .fw-sim-el-box{
            ...
            #ffe199 100%);
                                ...
                                .fw-level{
                                    width: 100px; height: 20px; position: absolute; top: 75px; left: 0;
            ...
            #f8b76b 100%);
                            ...
                            .fw-level-simple-box-scroll{
                                width: 962px; height: 186px; position: absolute; top: 5px; right: 5px;
            ...
            #ffe199 100%);
                                ...
                                .fw-level-simple, .fw-level-elite{
                                    ...
                                    .fw-level-rew-box{
                                        ...
                                        .fw-level-rew-num{
                                            width: 60px; height: 12px; position: absolute; bottom: 5px;
                                            color: #3c3737; font-size: 12px; font-weight: bold;
                                        }
                                        ...
                                        .color-btn.green{
                                            ...
                                            &:active{
                                                box-shadow: inset 0 -1px 0px rgba(0, 0, 0, 0.20), inset 0 2px 2px rgba(0, 0, 0, 0.20);
                                        ...
                                        &.collect{
                                            ...
                                            .color-btn.green{visibility: visible;}
                                        }
                                        &.check{
                                            .fw-level-rew-num-check{visibility: visible;}
                                        }
                                        &.block{
                                            .fw-level-rew-num-block{visibility: visible;}
                                        }
                                        &.empty{
                                            background: #3d342d; box-shadow: 0 0 0 rgba(0, 0, 0, 0.35);
                                            .fw-level-rew-num{visibility: hidden;}
                                            .color-btn.green{visibility: hidden;}
                                            .fw-level-rew-num-check{visibility: hidden;}
                                            .fw-level-rew-pic{visibility: hidden;}
                                        }
                                        &.girl{
                                            .fw-level-rew-pic{
                                            ...
                                            .fw-level-rew-num{visibility: hidden;}
                                            .fw-level-rew-good{visibility: visible;}
                                        }
                                    }
                                }
                                .fw-level-level{
                                    width: 2000px; height: 20px; position: relative; top: 5px;
                                    background: linear-gradient(0deg, #584a49 0%, #3b302f 100%);
                                    .fw-level-level-prg{
                                        width: 10%; height: 100%; position: relative;
                                        background: linear-gradient(0deg, #8cdd55 0%, #43a700 50%, #8cdd55 100%);
                                        transition: width 0.3s; text-align: left; font-size: 0;
                                        
                                    }
                                    .fw-level-level-num-box{
                                        width: 100%; height: 20px; position: absolute; top: 0; left: 0; text-align: left;
                                        .fw-level-level-num{
                                            width: 70px; height: 20px; position: relative; display: inline-block;
                                            text-align: center;
                                            color: #fff; font-size: 16px; font-weight: bold; text-shadow: 0 1px 2px rgba(0, 0, 0, 0.35);
                                            &:before{
                                                content: ""; width: 2px; height: 20px; position: absolute; right: 0; top: 0;
                                                background-color: #8f7c6e;
                                            }
                                        }
                                    }
                                }
                                .fw-level-elite{top: 10px;}
                            }
                        }
                        .btn-close-x{
                        ...
                        .fw-btlpass-buy-box-all{
                            width: 170px; height: 200px; position: absolute; bottom: 10px; left: 10px;
                            display: none;
                            .fw-btlpass-girl{
                        ...
                        &.btlpass-buy-box{
                            .fw-btlpass-buy-box-all{display: block;}
                            .fw-level-box-all{
                                width: 900px;
                                .fw-level-simple-box-scroll{
                                    width: 785px;
...
const V2ScreenCwMain3 = styled.div`
  ${V2ScreenCwMain3Styles}
`;

export { V2ScreenCwMain3Styles, V2ScreenCwMain3 };
