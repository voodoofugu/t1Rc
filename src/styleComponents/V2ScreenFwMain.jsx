...
const V2ScreenFwMainStyles = css`
    body .main {
        .left-side {
            width: 620px;
            height: 555px;
                    ...
                    .tab-panel-box.fw-main {
                        ...
                        .fw-btlpass-buy-box-all {
                            ...
                            .fw-btlpass-girl {
                                ...
                                top: 0;
                                left: 0;
                                background-image: url(../img/v2-fw-girl-val.png);
                                &.cw {
...
const V2ScreenFwMain = styled.div`
    ${V2ScreenFwMainStyles}
`;

export { V2ScreenFwMainStyles, V2ScreenFwMain };
