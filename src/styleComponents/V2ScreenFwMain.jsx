...
const V2ScreenFwMain = styled.div`
  @charset "utf-8";
      ...
      &.wide {
        ...
        .tab-panel-box.fw-main {
          ...
          .fw-info {
            ...
            border-radius: 100%;
            cursor: pointer;
            box-shadow: 0 2px 0 #645ba9, 0 2px 4px rgba(0, 0, 0, 0.4);
            color: #fff;
            font-size: 22px;
            line-height: 24px;
            font-weight: 700;
            ...
            &:active {
              top: 10px;
              box-shadow: 0 0px 0 #645ba9, 0 1px 4px rgba(0, 0, 0, 0.6);
            }
          }
          .fw-btlpass-buy-box-all {
            ...
            .fw-btlpass-girl {
              ...
              top: 0;
              left: 0;
              background-image: url(~imgPath/v2-fw-girl-val.png);
              &.cw {
          ...
          .fw-right-side-content-box {
            ...
            .fw-flag-box {
              ...
              top: 20px;
              margin: 0 20px;
              background-image: url(~imgPath/v2-fw-flag-bg.png);

              &.fr1 {
                background-image: url(~imgPath/fr_bg1.png);
              }
              &.fr2 {
                background-image: url(~imgPath/fr_bg2.png);
              }
              &.fr3 {
                background-image: url(~imgPath/fr_bg3.png);
              }
