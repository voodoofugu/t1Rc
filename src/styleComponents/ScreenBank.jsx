  ...
  .heroes-card-list {
    ...
    .hero-card {
      ...
      .asc-lvl {
        ...
        left: -10px;
        top: -2px;
        box-shadow: 0 3px 0px #c87725, inset 0 3px 2px #ffa, 1px 2px 1px #000,
          1px 5px 3px #000;
      ...
      &.disabled {
        ...
        .asc-lvl {
          background: linear-gradient(90deg, #ccc, #eee, #ccc);
          box-shadow: 0 3px 0px #555, inset 0 3px 2px #fff, 1px 2px 1px #000,
            1px 5px 3px #000;
          &:before {
            background: #333;
...
.left-side .left-panel .tab-panel.bank-panel {
  ...
  .bank-tabs-all {
    ...
    .bank-tab {
      ...
      &.vip {
        ...
        top: -1px;
        &.selected {
          background: linear-gradient(to bottom, #580000, #c00000);
          // box-shadow: none;
          // background: #400000;
          // top: -1px;
        }
  ...
  .bank-subwin.vip {
    ...
    .vip-progressor {
      ...
      .vip-prg-box {
        ...
        right: 130px;
        top: 20px;
        background: linear-gradient(to right, #bbbec0, #f6dc70, #e4b626);
        ...
        .vip-prg {
          display: block;
          background: linear-gradient(177deg, #bbbec0, #f6dc70, #e4b626);
          position: absolute;
          left: 0;
          top: 4px;
          bottom: 4px;
        ...
        &.selected {
          ...
          &:after {
            ...
            box-shadow: inset 0 0 1px #ff0, inset 0 0 3px #ff0,
              inset 0 0 7px #500, 0 0 1px #ff0, 0 0 3px #ff0, 0 0 7px #500;
          }
          p.h:before,
          p.h:after {
            content: "";
    ...
    .next-free-gift {
      ...
      .btn-box {
        ...
        .count {
          ...
          box-shadow: 0 0 3px #ff0, inset 0 0 2px #ff0, inset 0 0 10px #000;
          text-shadow: 0 2px 1px #300;
          //margin-bottom: -20px;
        }
      }
  ...
  .bank-subwin.heroes {
    ...
    .heroes-roll-4 {
      ...
      .timer {
        ...
        .time {
          ...
          box-shadow: inset 0 2px 0 #300, 0 0 4px #ff0, 0 0 10px #ff0;
        }
      }
      line-height: 0px;
      font-size: 0;
    ...
    .heroes-random-3 {
      ...
      box-shadow: 0 0 7px #4d3706, inset 0 0 7px #ebc94f, inset 0 0 3px #ebc94f;
      &:before {
        content: "";
        display: block;
        width: 150px;
    ...
    .pack-list {
      ...
      .pack-line {
        ...
        .cr-pack {
          ...
          left: 2px;
          top: 2px;
          box-shadow: inset 0 0 5px #ffc224, inset 0 10px 2px #f7df80,
            inset 0 -8px 2px #d0a929, 0 0 3px #493a0a;
          font-size: 20px;
          font-weight: bold;
          color: #4a3a08;
          text-shadow: 0 0 1px #0d0a01, 0 2px 1px #fff;
        ...
        .cr-pack-vip {
          ...
          box-shadow: inset 0 0 5px #cfd8ff,
            ...
            inset 0 -8px 2px rgba(215, 60, 217, 0.15), 0 0 4px #400646;
          font-size: 20px;
          font-weight: bold;
          color: #3d013d;
          text-shadow: 0 0 1px #3d013d, 0 2px 1px #fff, 0 0 4px #fff,
            0 0 15px #f563ff, 0 0 15px #fbff48;
          // padding-left: 40px;
          .points {
            display: block;
            line-height: 10px;
  ...
  .add-crowns-popup {
    ...
    .btn-close-x {
      ...
      &:before {
        ...
        color: #413753;
        line-height: 30px;
        text-shadow: 0 0 2px #413753, 0 0 2px #413753, 0 0 2px #413753,
          0 0 2px #413753, 0 0 7px #fff, 0 0 7px #fff, 0 0 7px #fff;
      }
      &:after {
        content: "";
        display: block;
    ...
    .res {
      ...
      &.gems {
        ...
        .item {
          ...
          .icon {
            ...
            background: linear-gradient(to bottom, #ffddfe, #b55aa5);
      ...
      &.shards {
        ...
        .item {
          ...
          .icon {
            ...
            background: linear-gradient(to bottom, #84d7fe, #41659c);
      ...
      &.ice_gold {
        background: #1f6bca;
        .item {
          background: linear-gradient(272deg, #195589 0%, #1488bf 100%);
          .desc-box,
          .desc-price,
          .decs-text {
            color: #ffc;
        ...
        .desc-box {
          ...
          .desc-price {
            ...
            &:before {
              ...
              height: calc(100% - 6px);
              background: #3e2b94;
              box-shadow: inset 0px 15px 0px rgba(255, 255, 255, 0.08);
              border-radius: 4px;
            }
        ...
        .btn-panel {
          ...
          .btn-box {
            ...
            .btn-buy {
              ...
              padding-top: 26px;
              &:hover {
                box-shadow: inset 0 -3px 0px #c87725, 0 0 3px rgba(0, 0, 0, 0.4),
                  0 0 6px rgba(255, 255, 255, 0.4);
                filter: brightness(1.1);
              }
              &:active {
                box-shadow: inset 0 -1px 0px #c87725, 0 0 1px rgba(0, 0, 0, 0.4);
              }
              .price {
                line-height: 20px;
                height: 20px;
