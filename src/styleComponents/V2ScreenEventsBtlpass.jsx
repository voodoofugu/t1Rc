                ...
                .btlpass-collect-box-text {
                    ...
                    .ic-event {
                        ...
                        &:before {
                            ...
                            top: 4px;
                            background-image: url(~imgPath/ic-pumpkins.png);
                            background-size: 100%;
                            transform: scale(1.4);
                        }
                        &.hw:before {
                        ...
                        &.bf:before {
                            background-image: url(~imgPath/poly-chip-icon.png);
                        }
                    }
                }
            }
                    ...
                    .btlpass-level-rew-box {
                        ...
                        &.block {
                            &:after {
                                ...
                                top: 3px;
                                right: 3px;
                                background: url(~imgPath/tower-lock.png);
...
.popup-layer .m-popup.events-btlpass-pop.hw {
    &:before {
        background: url(~imgPath/pop-bg-hw.jpg);
        background-size: 100%;
        background-position: center;
        background-repeat: no-repeat;
    }
...
.popup-layer .m-popup.events-btlpass-pop.bf {
    &:before {
        background: url(~imgPath/girl-stand@2x.png), url(~imgPath/v2-bf-pop-bg.jpg);
        ...
        .btlpass-collect-box-all {
            ...
            .btlpass-collect-box {
                ...
                .btlpass-collect-box-text {
                    .ic-event {
                        &:before {
                            background-image: url(~imgPath/ic-tickets-bf.png);
                        }
                    }
                }
            }
...
.popup-layer .m-popup.events-btlpass-pop.xmas {
    &:before {
        background: url(~imgPath/girl-stand@2x.png), url(~imgPath/pop-bg-xmas.jpg);
        background-size: 354px 160px, 100%;
        background-position: -60px 350px, center;
        background-repeat: no-repeat;
    }
        ...
        .btlpass-collect-box-all {
            ...
            .btlpass-collect-box {
                ...
                .btlpass-collect-box-text {
                    ...
                    .ic-event {
                        &:before {
                            background-image: url(~imgPath/ic-tickets-xmas.png);
                        }
                    }
                }
            }
...
.popup-layer .m-popup.events-btlpass-pop.vl {
    &:before {
        background: url(~imgPath/girl-stand@2x.png), url(~imgPath/v2-vl-pop-bg.jpg);
        background-size: 354px 160px, 100%;
        background-position: -60px 350px, center;
        background-repeat: no-repeat;
    }
        ...
        .btlpass-collect-box-all {
            ...
            .btlpass-collect-box {
                ...
                .btlpass-collect-box-text {
                    ...
                    .ic-event {
                        &:before {
                            background-image: url(~imgPath/ic-tickets-vl.png);
                        }
                    }
                }
            }
...
.popup-layer .m-popup.events-btlpass-pop.rpg {
    &:before {
        background: url(~imgPath/ts_confirm_bk-1.jpg);
        background-size: 100%;
        background-position: center;
        background-repeat: no-repeat;
    }
...
.popup-layer .m-popup.events-btlpass-pop.spring {
    &:before {
        background: url(~imgPath/girl-stand@2x.png), url(~imgPath/march-pop-bg.jpg);
        background-size: 354px 160px, 100%;
        background-position: -60px 350px, center;
        background-repeat: no-repeat;
    }
        ...
        .btlpass-collect-box-all {
            ...
            .btlpass-collect-box {
                ...
                .btlpass-collect-box-text {
                    ...
                    .ic-event {
                        &:before {
                            background-image: url(~imgPath/ic-march-flower-pink.png);
                        }
                    }
                }
            }
        ...
        .btlpass-collect-box-all {
            .btlpass-collect-box {
                .btlpass-collect-box-text {
                    .ic-event {
                        &:before {
                            background-image: url(~imgPath/ic-march-flower-dark-blue.png);
...
export default V2ScreenEventsBtlpass;
