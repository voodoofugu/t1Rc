        ...
        .room {
          ...
          &.opened {
            ...
            &.selected {
              ...
              box-shadow: inset 0 3px 10px rgba(0, 0, 0, 0.77), 0 0 3px #fff,
                0 0 10px #ff0, 0 0 15px #ff0;
            }
          }
          &.selected {
            border: solid 2px #ffa;
  ...
  .main .popup-layer .reborn-popup {
    ...
    .content {
      ...
      .text-0 {
        ...
        padding: 0px 10px;
        color: #ffa;
        text-shadow: 0 1px 1px #6c0122, 0 1px 10px #6c0122, 0 1px 15px #6c0122;
      }
      .text-1,
      .text-2,
      .text-3 {
      ...
      .text-2 {
        ...
        .price.snowflake {
          ...
          padding: 0px 15px;
          background: #ffd543;
          box-shadow: 0 0 15px #ffd543, 0 0 5px #ffd543, inset 0 0 10px #fff,
            inset 2px 5px 10px #fff, inset 0px 15px 25px #fff;
          border-radius: 44px;
        ...
        .price.dpc {
          ...
          padding: 0px 5px;
          background: #ffd543;
          box-shadow: 0 0 15px #ffd543, 0 0 5px #ffd543, inset 0 0 5px #fff,
            inset 2px 5px 5px #fff;
          border-radius: 44px;
        }
        .price.luck_res {
          &:before {
