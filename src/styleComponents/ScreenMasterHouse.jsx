            ...
            .rightside-box-all {
              ...
              .stats-box-all {
                .stats-box {
                  ...
                  &:hover {
                    background: linear-gradient(#ceac79, #ae927e);
                    transform: scale(1);
                    &:before {
                      opacity: 1;
                    }
                  ...
                  .st-bonus-box {
                    ...
                    .bn-price {
                      ...
                      line-height: 30px;
                      &.animation {
                        animation: st-bonus-anim 0.55s ease-in 10ms;
                      }
                    }
                  ...
                  &:after {
                    ...
                    background-position: -27px -26px, 157px -26px, -27px 375px,
                      157px 375px;
                    background-repeat: no-repeat;
                    background-size: 50px auto;
                    pointer-events: none;
                    filter: drop-shadow(0 0 2px rgba(0, 0, 0, 0.4))
                      drop-shadow(0 0 1px rgba(0, 0, 0, 0.6)) brightness(1.2);
                    pointer-events: none;
                  }
                }
              }
                  ...
                  .abil-card-box {
                    ...
                    .skills-ef {
                      ...
                      &.cd {
                        ...
                        box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.6),
                          ...
                          inset 0 70px 24px rgba(255, 156, 110, 0.3),
                          0 1px 4px rgba(0, 0, 0, 0.8),
                          inset 0 0 4px 2px rgba(0, 0, 0, 0.4);
                      }
                      &.pwr {
                        ...
                        box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.6),
                          ...
                          inset 0 0 2px 2px rgba(0, 0, 0, 0.2),
                          inset 0 70px 24px rgba(255, 255, 255, 0.3),
                          0 1px 4px rgba(0, 0, 0, 0.8),
                          inset 0 0 4px 2px rgba(0, 0, 0, 0.4);
                        &:before,
                        &:after {
                          background-position: -585px -68px, -243px -68px;
                        }
                      }
                      &.dur {
                        ...
                        box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.6),
                          ...
                          inset 0 0 2px 2px rgba(0, 0, 0, 0.2),
                          inset 0 70px 24px rgba(255, 248, 110, 0.3),
                          0 1px 4px rgba(0, 0, 0, 0.8),
                          inset 0 0 4px 2px rgba(0, 0, 0, 0.4);
                        &:before,
                        &:after {
                          background-position: -593px -135px, -236px -135px;
                        }
                      }
                      &.new {
                        background-blend-mode: luminosity;
                        box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.6),
                          ...
                          inset 0 0 2px 2px rgba(0, 0, 0, 0.2),
                          inset 0 70px 24px rgba(98, 143, 239, 0.4),
                          0 1px 4px rgba(0, 0, 0, 0.8),
                          inset 0 0 4px 2px rgba(0, 0, 0, 0.4);
                        &:before,
                        &:after {
                          background-image: url(../img/suphero-squad-frame-all@x2.png),
                            ...
                            url(../img/suphero-squad-frame-all@x2.png),
                            url(../img/suphero-squad-frame-all@x2.png);
                          background-position: -584px -280px, -246px -280px,
                            -595px -280px, -235px -280px;
                          filter: brightness(1.1);
                        }
                      }
                      &:before,
                      &:after {
                        ...
                        background-image: url(../img/suphero-squad-frame-all@x2.png),
                          url(../img/suphero-squad-frame-all@x2.png);
                        background-position: -576px 4px, -252px 4px;
                        background-repeat: no-repeat;
                        background-size: 973px auto;
                        border-radius: 0 0 10px 10px;
                      }
                    ...
                    &:after {
                      ...
                      background-image: url(../img/corner-02.png),
                        url(../img/corner-02.png), url(../img/corner-02.png),
                        url(../img/corner-02.png);
                      background-position: -27px -26px, 709px -26px, -27px 96px,
                        709px 96px;
                      background-repeat: no-repeat;
                      background-size: 50px auto;
                      filter: drop-shadow(0 0 2px rgba(0, 0, 0, 0.4))
              ...
              .skin-box-all {
                ...
                &:before {
                  ...
                  top: -11px;
                  left: -11px;
                  box-shadow: 0px 418px 0 #dd9542, 776px 418px 0 #dd9542,
                    776px 0 0 #dd9542;
                  border-radius: 14px;
                  z-index: 1;
                  pointer-events: none;
