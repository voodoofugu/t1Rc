        ...
        .right-box-f {
          ...
          .kingpack-box {
            ...
            &:before {
              ...
              border-radius: 8px;
              box-shadow: inset 0 0 80px #ffecbd, inset 0 0 100px #ffecbd;
            }
            .cardnameback {
              height: 50px;
              min-width: 102px;
            ...
            .buy-box {
              ...
              top: 302px;
              left: 5px;
              background-color: rgba(248, 211, 139, 0.75);
          ...
          .kingpack-box {
            ...
            &:before {
              ...
              box-shadow: inset 0 0 80px #ffe59f, inset 0 0 100px #ffe59f;
            }
            .moregold-box {
              &.king {
                top: 208px;
...
export default ScreenUnipopStarterpackStyles;
