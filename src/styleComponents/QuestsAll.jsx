            ...
            .quests-list-all-box {
                ...
                .journal-parth-box-all {
                    ...
                    .daily-mission-box {
                        .daily-reward {
                            ...
                            &.active {
                                ...
                                &:before {
                                    ...
                                    animation: 8s linear 0s normal none infinite
                                        running lockflare;
                                    width: 90px;
                                    height: 90px;
                                    left: -10px;
                        ...
                        &.completed {
                            background: url(~imgPath/congratulation-bg.png);
                            background-repeat: no-repeat;
                        ...
                        .journal-parth-box {
                            ...
                            .journal-parth-block {
                                ...
                                .daily-parth-box {
                                    ...
                                    background: url(~imgPath/completed-banner.png),
                                        url(~imgPath/smoke-bg.png),
                                        linear-gradient(
                                            135deg,
                                            #584b48,
                                            #7d6463
                                        );
                                    background-position: right -8px, 0px -50px,
                                        0;
                                    background-repeat: no-repeat;
                    ...
                    .journal-parth-header {
                        ...
                        .quest-switch-section {
                            ...
                            .section-name {
                                ...
                                &.tutor {
                                    background: url(~imgPath/banner-bg2.png);
                                    background-position: center 0;
                                    background-size: auto 100%;
                                    background-repeat: no-repeat;
                                    &:before,
