...
const V2Unipop20PsePop = styled.div`
  @charset "utf-8";
@import "sass_commons.scss";

.popup-layer .m-popup.unipop-pse-pop{
    ...
    .unipop-box-content-all{
        ...
        .unipop-box-right-box{
            ...
            .right-box-f{
                ...
                .sexped-center-box{
                    width: 190px; height: 360px; position: absolute; top: 60px; left: 225px;
                    background-image: url(~imgPath/v2-sexped-pse.jpg);
                    .sexped-center-box-name{
                        width: 220px; height: 30px; position: absolute; top: -5px; left: -15px;
                        background-image: url(~imgPath/wpck-ram.png);
                        background-size: 100%;
                        background-repeat: no-repeat;
                        color:#fff; font-size: 12px; font-weight: bold; text-transform: uppercase; line-height: 24px;
                    }
                }
                .sexped-girl-left-box{
                    width: 215px; height: 420px; position: absolute; top: 60px; left: 0;
                    .sexped-girl{
                        position: absolute; right: -38px;
                    }
                    .sexped-girl-buble{
                        width: auto; height: auto; position: absolute; top: 170px; right: -40px;
                        background-color: #fff;
                        @include prefix(border-radius, 20px);
                        border: 2px solid #000;
                        box-shadow: 0 6px 8px rgba(0, 0, 0, 0.35);
                        color: #000; font-size: 14px; font-weight: bold; text-transform: uppercase;
                        padding: 10px 20px;

                    }
                    .sexped-reward-box-all{
                        width: 205px; height: 180px; position: absolute; bottom: 5px; left: 5px;
                        font-size: 0;
                        .sexped-reward{
                ...
                .sexped-girl-right-box{
                    width: 215px; height: 420px; position: absolute; top: 60px; right: 0;
                    .sexped-girl{
                        position: absolute; right: -22px;
                    }
                    .sexped-girl-buble{
                        width: auto; height: auto; position: absolute; top: 150px; left: -55px;
                        background-color: #fff;
                        @include prefix(border-radius, 20px);
                        border: 2px solid #000;
                        box-shadow: 0 6px 8px rgba(0, 0, 0, 0.35);
                ...
                .color-btn.green{
                    width: 200px; top: 428px;
                    .color-btn-text{font-size: 18px;}
                }
            }
        }
    }
...
export default V2Unipop20PsePop;
