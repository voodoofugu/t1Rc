...
const V2ScreenWorldDistrictStyles = css`
      ...
      .loc-box {
        ...
        .lock-num-box {
          ...
          box-shadow: inset 0 1px 1px rgba(255, 255, 255, 0.2),
            inset 0 0 0 3px #db8932, inset 0 2px 2px 3px rgba(0, 0, 0, 0.2),
...
const V2ScreenWorldDistrict = styled.div`
  ${V2ScreenWorldDistrictStyles}
`;

export { V2ScreenWorldDistrictStyles, V2ScreenWorldDistrict };
