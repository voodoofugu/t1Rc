...
.popup-layer .m-popup.wpck3{
    ...
    .content-all{
        ...
        .prize-one-box, .prize-two-box, .prize-three-box{
            width: 480px; height: 380px; position: absolute; background-color: rgba(255, 255, 255, 0.45);
        ...
        .prize-two-box{margin-left: 260px; display: none;}
        .prize-three-box{
            width: 220px; margin-left: 520px;
            .box1{
                width: 220px; height: 190px; position: absolute;
                .prize-name-box.small{
                    top: 2px;
                }
                .prize-box{
                    width: 120px; height: 120px; position: absolute; top: 40px; margin-left: 50px;
                    @include background-gold; @include prefix(border-radius, 10px);
            ...
            .box2{
                ...
                .girl-avatar-box{
                    width: 100px; height: 113px; position: absolute; top: 60px; margin-left: 60px;
                    @include background-gold; @include prefix(border-radius, 10px);
                    box-shadow: 0 2px 2px rgba(0, 0, 0, 0.35);
                    .girl-avatar{
                        width: 90px; height: 103px; position: absolute; top: 5px; margin-left: -45px;
                        @include prefix(border-radius, 8px); 
                    }
                    .prize-promote-box{
                        width: 42px; height: 56px; top: 68px; margin-left: -22px;
                        .prize-promote-text{
...
.prize-name-box{
    ...
    line-height: 26px; text-shadow: 0 1px 2px rgba(0, 0, 0, 0.45);
    &.small{font-size: 12px; top: 270px;}
}
.wpck-plus, .wpck-plus1, .wpck-plus2{
    width: 40px; height: 8px; position: absolute;
    background-color: #3d94b3;
    &:before{
        content: ""; width: 8px; height: 40px; position: absolute; top: -16px; margin-left: 0px;
        background-color: #3d94b3;
    }
}
.wpck-plus-text{
