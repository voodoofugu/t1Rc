...
const V2ScreenMainRelicsPopStyles = css`
      ...
      .pse-count-res-box {
        ...
        .pse-count-res-text {
          ...
          .ic-pse-keygirl {
            ...
            margin-right: 5px;
            top: 6px;
            background-image: url(../img/fapop-ic02.png);
            background-size: 100%;
      ...
      .main-relics-set-box {
        ...
        .main-relics-set {
          ...
          .main-relics-set-pic {
            ...
            top: 15px;
            margin: 0 auto;
            background-image: url(../img/card-ic-koloda@2x.png);
            background-size: 100%;
            background-repeat: no-repeat;
          }
          ...
          &.r2 {
            .main-relics-set-pic {
              background-image: url(../img/card-ic-koloda2@2x.png);
            }
          }
          &.r3 {
            .main-relics-set-pic {
              width: 150px;
              background-image: url(../img/card-ic-koloda3@2x.png);
            }
          }
          &.r4 {
            .main-relics-set-pic {
              width: 150px;
              background-image: url(../img/card-ic-koloda4@2x.png);
            }
          }
        }
      }
      .main-relics-bonus-box {
        ...
        .relics-pack-opened-box {
          ...
          &:before {
            ...
            top: 80px;
            left: -16px;
            background-image: url(../img/noobpackback.png);
            background-size: 100%;
          }
  ...
  body .main.world3 {
    .popup-layer .m-popup.main-relics-pop.vl {
      ...
      &:before {
        background-image: url(../img/v2-vl-pop-bg.jpg);
        background-size: 100%;
  ...
  body .main.world3 {
    .popup-layer .m-popup.main-relics-pop.march {
      ...
      &:before {
        background-image: url(../img/march-pop-bg.jpg);
        background-size: 100%;
        box-shadow: 0px 2px 0px rgba(255, 255, 255, 0.35),
          0px -3px 1px rgba(0, 0, 0, 0.4),
          0px 2px 2px 1px rgba(255, 255, 255, 0.6),
...
export default V2ScreenMainRelicsPopStyles;
