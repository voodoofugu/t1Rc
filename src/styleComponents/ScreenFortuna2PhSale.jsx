...
const pageStyles = css`
  .popup-layer .m-popup.fortuna-main.ph-sale {
    ...
    left: 27px;
    top: 20px;
    background: linear-gradient(-22deg, #dacdcb 0%, #b29c99 50%, #dacdcb 100%);
    &:before {
      content: "";
      background-image: url(../img/sv-sale-bg3.jpg);
      background-size: 100%;
    }
    .title {
      background: linear-gradient(90deg, #dacdcb 0%, #b29c99 50%, #dacdcb 100%);
      border: solid 4px #9e9393;
      color: #fff;
      box-shadow: 0 1px 10px #392d26, inset 0 2px 10px #fff,
        inset 0 28px 5px rgba(202, 192, 190, 0.15);
    }
    .btn-close-x {
      background: linear-gradient(22deg, #dacdcb, #dacdcb, #b29c99, #dacdcb);
      border: solid 4px #ccb8b5;
    }
    .sv-sale-pack-box {
      width: 460px;
      height: 512px;
      ...
      left: 18px;
      border-radius: 8px;
      background-color: rgba(133, 116, 113, 0.5);
    ...
    .sv-sale-egg-box-all {
      ...
      .sv-egg-all {
        ...
        top: 0;
        left: 0;
        background-image: url(../img/ph-bg1.png);
        background-size: 100%;
      }
      // .sv-heart-right{
      //     width: 200px; height: 300px; position: absolute; top: 0; left: 200px;
      //     background-image: url(../img/ph-bg2.png); background-size: 100%;
      ...
      &.one {
        .sv-egg-all {
          background-image: url(../img/ph-bg1-p.png);
        }
        .sv-chain1 {
          display: none;
        }
      ...
      &.two {
        .sv-egg-all {
          background-image: url(../img/ph-bg2.png);
        }
        .sv-chain2 {
          display: none;
        }
