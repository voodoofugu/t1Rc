...
.popup-layer .m-popup.fortuna-main.ph-sale {
  ...
  &:before {
    content: "";
    background-image: url(~imgPath/sv-sale-bg3.jpg);
    background-size: 100%;
  }
  .title {
    background: linear-gradient(
  ...
  .sv-sale-egg-box-all {
    ...
    .sv-egg-all {
      ...
      top: 0;
      left: 0;
      background-image: url(~imgPath/ph-bg1.png);
      background-size: 100%;
    }
    // .sv-heart-right{
    //     width: 200px; height: 300px; position: absolute; top: 0; left: 200px;
    //     background-image: url(~imgPath/ph-bg2.png); background-size: 100%;
    ...
    &.one {
      .sv-egg-all {
        background-image: url(~imgPath/ph-bg1-p.png);
      }
      .sv-chain1 {
        display: none;
      }
    ...
    &.two {
      .sv-egg-all {
        background-image: url(~imgPath/ph-bg2.png);
      }
      .sv-chain2 {
        display: none;
      }
