        ...
        .hero-left-box {
          .filter-box {
            ...
            .filter-btn-wrap {
              ...
              .filter-btn {
                ...
                border-radius: 6px;
                &:hover {
                  background: linear-gradient(0deg, #ffc64c 0%, #fffeb4 100%);
                }
                .btn-text {
          ...
          .suphero-all-box {
            ...
            .suphero-btn-card-add {
              ...
              margin: 5px;
              border-radius: 6px;
              box-shadow: 0 2px 0 #a5865a, 0px 4px 4px 1px rgba(0, 0, 0, 0.35),
            ...
            .suphero-card {
              ...
              &.check {
                .hero-pic-box {
                  ...
                  box-shadow: inset 0 1px 1px rgba(255, 255, 255, 0.8),
                    0px 2px 0px #299d29, 0px 2px 6px 1px #2eff12c7,
              ...
              .hero-pic-box {
                ...
                border-radius: 6px;
                box-shadow: 0 0 5px rgba(0, 0, 0, 0.6), 0 2px 0 #8e7453;
                .hero-pic {
                  img {
                    width: 90px;
                    height: 103px;
      ...
      .suphero-rightside-box-all {
        ...
        .rlevel-box {
          ...
          box-shadow: inset 0 1px 1px rgba(255, 255, 255, 0.2),
            inset 0 -2px 0px rgba(0, 0, 0, 0.2), 0 1px 1px rgba(0, 0, 0, 0.4);
          .rname-box {
            width: 100%;
            height: 30px;
            position: absolute;
          ...
          .bonus-lvl-box {
            ...
            .bonus-lvl-box-bonus-box {
              ...
              box-shadow: 0px 3px 0px #c87725, 0px 5px 2px rgba(0, 0, 0, 0.25),
        ...
        .rlevel-box {
          ...
          .bonus-hero-pic-box-all {
            ...
            .bonus-hero-pic-box {
              ...
              top: 6px;
              left: 10px;
              background: linear-gradient(0deg, #867366 0%, #cac0b9 100%);
              border-radius: 10px;
          ...
          &.upgrade {
            ...
            .girl-bonus-box {
              ...
              .sh2-prgbar-all {
                ...
                overflow: hidden;
                border-radius: 4px;
                box-shadow: 0 0 0 1px #453434, 0 1px 2px rgba(0, 0, 0, 0.4);
                .sh2-prgbar {
                  width: 90%;
                  height: 100%;
                  position: absolute;
          ...
          .rlevel-box {
            ...
            &.upgrade {
              ...
              .girl-bonus-box {
                ...
                .sh2-prgbar-all {
                  background: linear-gradient(0deg, #5f5673 0%, #3a3445 100%);
                  box-shadow: 0 0 0 1px #393445, 0 1px 2px rgba(0, 0, 0, 0.4);
                }
              }
              .bonus-hero-pic-box-upgrade {
                background: linear-gradient(0deg, #706686 0%, #c0b9ca 100%);
    ...
    .qsun-all-box {
      ...
      .qsun-box {
        ...
        .btn-buy.green {
          ...
          &:not(.disabled):active {
            box-shadow: inset 0 -2px 0px #648d34, inset 0 3px 3px #537729,
              0 0 5px #f4db91, 0 0 9px #f4db91, 0 0 11px #f4db91;
          }
        }
        .end-banner {
          display: none;
    ...
    .sun-buy-box {
      ...
      .essebtn-box {
        ...
        .essebtn {
          ...
          &:hover {
            box-shadow: inset 0 -4px 0 #c57b21, 0 0 5px #e8d0b2, 0 0 9px #e8d0b2,
              0 0 11px #e8d0b2;
          }
          &:active {
    ...
    .essence-card-box {
      ...
      &.bottom {
        ...
        &:before {
          ...
          margin-left: -150px;
          border-radius: 8px;
          background: linear-gradient(0deg, #af946f, #dbbf9c 31%, #8f7553);
          box-shadow: inset 0 0 6px #5a472f;
        }
        .essence-but-box {
          width: 120px;
