...
body .main .left-side .left-panel.wide .tab-panel-box.suphero,
body .main .m-popup.angels-supheros-added .content {
    .content-box-all {
                    ...
                    .suphero-card {
                        ...
                        &.svlock {
                            .sh2-svlock {
                                ...
                                top: 40px;
                                left: -4px;
                                background-image: url(~imgPath/legendary-lock-sv.png);
                                background-size: 100%;
                            }
                        }
                        &.lock {
            ...
            .lhero-box {
                ...
                .big-herostar-box {
                    ...
                    .big-hero-star {
                        ...
                        height: 100%;
                        position: absolute;
                        background: url(~imgPath/big-hero-star05-bg.png);
                        background-size: 100%;
                        &:before {
                            content: "";
                            width: 100%;
                            ...
                            left: 0;
                            top: 0;
                            background: url(~imgPath/big-hero-star05.png);
                            background-size: 100%;
                        }
                        &.lvl00 {
                            &:before {
                                ...
                                background-repeat: no-repeat;
                                background-size: 454%;
                                background-image: url(~imgPath/big-hero-star05.png);
                            }
                        }
                        &.lvl02 {
                            &:before {
                        ...
                        &.ult {
                            &:before {
                                ...
                                background-repeat: no-repeat;
                                background-size: 100%;
                                background: url(~imgPath/big-hero-star05-purple.png);
                            }
                        }
                    }
                }
                ...
                .bonus-hero-pic-box-all {
                    ...
                    .bonus-hero-pic-box {
                        ...
                        .zlupa {
                            ...
                            top: 80px;
                            left: 80px;
                            background-image: url(~imgPath/cursor-plus.png);
                            background-size: 100%;
                            cursor: pointer;
                        }
                        .herostar-box {
            ...
            .trophy-res-box {
                ...
                &.chest {
                    &:before {
                        ...
                        top: 1px;
                        left: 3px;
                        background-image: url(~imgPath/sh-icon-chest-128.png);
                        background-size: 100%;
                        background-repeat: no-repeat;
                    }
                }
                    ...
                    .trophy-res-box {
                        ...
                        &.spirit2 {
                            ...
                            &:before {
                                ...
                                top: 1px;
                                left: 3px;
                                background-image: url(~imgPath/sh-icon-chest-dark-32.png);
                                background-size: 100%;
                                background-repeat: no-repeat;
                            }
                        }
...
body .main.world3 {
    ...
    .m-popup.angels-supheros-added {
        ...
        .content-box-all {
            ...
            .leftside-box-all {
                background: linear-gradient(180deg, #5e49bf 0%, #7f6de5 100%);
                .hero-left-box {
                    .filter-box {
                        background: #472d84;
                        .filter-btn-wrap {
            ...
            .suphero-rightside-box-all {
                background: linear-gradient(180deg, #3e1d73 0%, #402276 100%);
                .lhero-box {
                    background: linear-gradient(
                        155.68deg,
                        #8e46d0 6.11%,
                    ...
                    .bottom-star-box-girl-count-box {
                        box-shadow: 0 2px 0 rgba(255, 255, 255, 0.2),
                            0 -2px 0 rgba(255, 255, 255, 0.2), 0 -4px 0 #5f3fb9,
                            0 -10px 6px rgba(0, 0, 0, 0.5),
                            inset 0 -0.5px 0.5px rgba(0, 0, 0, 0.2),
                            inset 0 1px 0.5px rgba(0, 0, 0, 0.2);
                    }
                ...
                .rlevel-box.congra {
                    &:before,
                    &:after {
                        filter: brightness(0.5) hue-rotate(270deg) opacity(0.6)
                            drop-shadow(0 1px 0.5px rgba(255, 255, 255, 0.3));
                    }
                }
            }
        ...
        .suphero-avatar-box {
            ...
            box-shadow: 0px 2px 0px #79299d, 0px 4px 4px 1px rgba(0, 0, 0, 0.35);
            .suphero-avatar-wrap {
...
body .main.world3 .left-side .left-panel.wide .tab-panel-box.suphero {
    background: #ab97b7;
}
body .main .m-popup.angels-supheros-added {
    &:before {
        background: linear-gradient(180deg, #574b4a 0%, #544746 100%);
    }
}
body .main.world3 .m-popup.angels-supheros-added {
    .content-box-all {
        background: none;
    }
}
...
.popup-layer .m-popup.chest-quest {
    ...
    .qhero-box {
        ...
        &:before {
            ...
            margin-left: -126px;
            @include prefix(border-radius, 8px);
            background-image: url(~imgPath/girl-djavol-all.jpg);
            background-size: 100%;
        ...
        .prg-keys-box {
            ...
            .keys-pic {
                ...
                &:before {
                    ...
                    top: 4px;
                    margin-left: -16px;
                    background-image: url(~imgPath/ico-keys.png);
                    background-size: 100%;
                }
            }
        }
    ...
    .shero-card-box {
        ...
        .topname-box {
            ...
            .lrare-box {
                ...
                margin-left: 6px;
                &.uncommon {
                    background-image: url(~imgPath/cur-u.png);
                    background-size: 100%;
                }
                &.common {
                    background-image: url(~imgPath/cur-c.png);
                    background-size: 100%;
                }
                &.rare {
                    background-image: url(~imgPath/cur-r.png);
                    background-size: 100%;
                }
                &.epic {
                    background-image: url(~imgPath/cur-e.png);
                    background-size: 100%;
                }
            }
            .lhero-name-box {
        ...
        .acpass-bonus-box {
            ...
            .pcbonus-box {
                ...
                @include prefix(border-radius, 0 0 0 10px);
            ...
            .pcbonus-box {
                ...
                @include prefix(border-radius, 0 0 10px 0);
            }
        }
        .star-bonus-box {
            width: 222px;
    ...
    .sun-buy-box {
        ...
        .essebtn-box {
            ...
            .essebtn {
                ...
                &:active {
                    box-shadow: inset 0 0 6px #975b10, inset 0 -2px 0 #975b10,
                        0 0 5px #e8d0b2, 0 0 9px #e8d0b2, 0 0 11px #e8d0b2;
                    .coron-price {
                        top: -3px;
                    }
                    .coron-icon {
        ...
        .sun-box {
            ...
            top: -5px;
            margin-left: 370px;
            background-image: url(~imgPath/sunduk-150.png);
            background-size: 100%;
            &.open {
                background-image: url(~imgPath/sunduk-150-open.png);
                background-size: 100%;
            }
        }
        .sb-num-box {
...
.popup-layer .m-popup.action-start {
    ...
    .ashero-box {
        ...
        &:before {
            ...
            margin-left: -130px;
            @include prefix(border-radius, 8px);
            background-image: url(~imgPath/girl-back-bn.jpg);
            background-size: 100%;
            box-shadow: inset 0 0 6px #5a472f;
        }
    }
...
.popup-layer .m-popup.essence-buy {
    ...
    .essence-card-box {
        ...
        .essence-but-box {
            ...
            top: 30px;
            margin-left: 55px;
            background-image: url(~imgPath/ic-krasn-butil@2x.png);
            background-size: 100%;
            &.lvl2 {
                width: 180px;
                height: 120px;
                background-image: url(~imgPath/best-essence.png);
                background-size: 100%;
                margin-left: 30px;
            }
            &.lvl3 {
