...
const V2ScreenCwGuildflag = styled.div`
  @charset "utf-8";
@import "sass_commons.scss";


.popup-layer .m-popup.guildflag{
    width: 870px; height: 480px; left: 165px; top: 80px;
    .title{color: #572f14;}
    .color-box{
    ...
    .cw-clanflag-back-box{
        width: 280px; height: 300px; position: absolute; top: 80px; left: 30px;
        background-color: #cbaa81;
        box-shadow: 0 1px 2px rgba(0, 0, 0, 0.35);
        .cw-clanflag-back-box-scroll{
            width: 260px; height: 280px; position: absolute; top: 10px; left: 10px;
            ...
            .cw-clanflag-back{
                ...
                &.select{
                    background-color: rgba(243, 214, 176, 0.35);
                }
            }
        }
    }
    .cw-clanflag-logo-box{
        width: 280px; height: 300px; position: absolute; top: 80px; left: 330px;
        background-color: #cbaa81;
        box-shadow: 0 1px 2px rgba(0, 0, 0, 0.35);
        .cw-clanflag-logo-box-scroll{
            width: 260px; height: 280px; position: absolute; top: 10px; left: 10px;
            overflow: hidden; overflow-y: scroll;
            font-size: 0;
            &::-webkit-scrollbar-track {
    ...
    .cw-clanflag-logo-end-box{
        width: 210px; height: 300px; position: absolute; top: 80px; left: 630px;
        background-color: #f3d6b0;
        box-shadow: 0 1px 2px rgba(0, 0, 0, 0.35);
        .cw-clan-logo-bg, .cw-clan-logo{
            width: 140px; height: 140px; position: absolute; top: 80px; left: 35px;
            img{width: 140px;}
            .cw-clan-logo{
                top: 0; left: 0;
            }
        }
        .cw-clanflag-logo-end-text-box{
            width: 230px; height: 33px; position: absolute; top: 4px; left: -10px;
            background-image: url(~imgPath/wpck-ram.png);
            background-size: 100%;
            background-repeat: no-repeat;
            .cw-clanflag-logo-end-text{
                width: 100%; height: auto; position: absolute; top: 2px;
...
export default V2ScreenCwGuildflag;
