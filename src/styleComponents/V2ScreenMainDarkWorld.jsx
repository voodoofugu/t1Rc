...
const V2ScreenMainDarkWorld = styled.div`
  @charset "utf-8";
...
body .main.world3 {
    ...
    .guildhall-res-box-all {
        background: #8c76a9;
        box-shadow: inset 0 1px 1px rgba(255, 255, 255, 0.4), 0 2px 0 #8c76a9,
            ...
            .dark_gold {
                .f-dark_gold {
                    &:before {
                        ...
                        background-image: url(~imgPath/ico-dark.png);
                        background-size: 100%;
                        margin: 0 4px;
        ...
        .resource-panel {
            ...
            .resource-dark_gold {
                ...
                box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.35),
                    inset 0px -3px 0px rgba(0, 74, 160, 0.55);
                ...
                .value {
                    ...
                    box-shadow: inset 0px 15px 0px rgba(255, 255, 255, 0.15),
                ...
                .value-bonus {
                    ...
                    box-shadow: inset 0px 12px 0px rgba(255, 255, 255, 0.15),
    ...
    .quest-box-all {
        background: linear-gradient(180deg, #3d2959 0%, #4d386c 100%);
        background: linear-gradient(
                290deg,
        ...
        .quest-box-scroll {
            ...
            .quest-box {
                &.wrap {
                    background: #241b35;
                    &:before {
                        border-bottom: 10px solid #241b35;
                        top: -31px;
                    }
                    &:after {
                        border-top: 10px solid #241b35;
                        bottom: -31px;
                    }
                    .quest-wrap {
                        &:before {
                    ...
                    &.closed {
                        .quest-wrap {
                            &:before {
                                filter: grayscale(0.8) hue-rotate(220deg);
                            }
                        }
                    }
                }
        ...
        .opt-panel-box {
            .color-bg {
                ...
                box-shadow: inset 0 1px 1px rgba(255, 255, 255, 0.2),
                    ...
                    0 2px 0 #474059;
                &:before {
                    border-top: 10px solid #584f6e;
                    filter: drop-shadow(0 2px 0 #474059);
                }
            }
            .btn {
                background: linear-gradient(30deg, #2d2a3d, #827c9a, #dddce2);
                box-shadow: inset 0 0 5px #000, inset 0 0 7px #827c9a,
    ...
    .left-side {
        ...
        .tabs-all-box {
            ...
            .tabs-all {
                ...
                box-shadow: inset 0 1px 1px rgba(255, 255, 255, 0.4),
                    0 2px 0 #8c76a9, 0 0 0 1px rgba(0, 0, 0, 0.4);
                &:before {
                    content: "";
                    width: 54px;
                    height: 36px;
        ...
        .left-panel {
            ...
            &:before {
                ...
                border-bottom: 8px solid #8c76a9;
                background: none;
            ...
            .heroes-list-all-box {
                ...
                top: 0;
                left: 0;
                background: linear-gradient(180deg, #4b3a67 0%, #715596 100%);
                box-shadow: inset 0 0 0 4px #8c76a9,
                ...
                .all-heroes-box {
                    ...
                    .all-heroes-box-scroll {
                        ...
                        .hero-card-box-all {
                            .hero-card {
                                background: linear-gradient(#716088, #61478d);
                                box-shadow: inset 0 1px 0
                                        rgba(255, 255, 255, 0.6),
                                    inset 0 0 0 2px #ff9b37,
                                    inset 0 0 2px 2px rgba(0, 0, 0, 0.2),
                                    inset 0 44px 24px rgba(199, 110, 255, 0.28),
            ...
            .tab-panel-box {
                border: solid 4px #8c76a9 !important;
                border-top: none !important;
                border-radius: 10px 18px 18px 18px;
                box-shadow: inset 0 4px 0 #8c76a9,
            ...
            .skills-all-box {
                ...
                .skills-all {
                    ...
                    .skills-pic {
                        ...
                        box-shadow: inset 0px -5px 0px #442d9d,
                        ...
                        &:active {
                            box-shadow: inset 0 -2px 0 #391ea1,
                                0 2px 4px rgba(0, 0, 0, 0.55),
                                0 0 0 2px rgba(0, 0, 0, 0.1),
                                inset 0 1px 1px rgba(255, 255, 255, 0.06);
                            img {
                        ...
                        &.idle {
                            ...
                            box-shadow: inset 0 3px 0px #211a3c,
                                inset 0 0 6px #2b223e;
                            background: linear-gradient(
                                to top,
                                #a185d3,
                                #75649e,
                        ...
                        &.in-progress {
                            ...
                            box-shadow: inset 0 3px 0px #271454,
                                inset 0 0 6px #130a2c;
                            background: linear-gradient(
                                to top,
                                #3b29a1,
                                #7951c8,
    ...
    .right-side {
        ...
        .buster-box {
            ...
            .buster-btn.buster-time {
                .buster-icn {
                    background: url(~imgPath/darkworld-watch-icn.png);
                    background-size: cover;
                    background-repeat: no-repeat;
                    background-position: center;
                }
            }
            .buster-btn.buster-dark {
                .buster-icn {
                    background: url(~imgPath/darkworld-dark-coins-icn.png);
                    background-size: cover;
                    background-repeat: no-repeat;
                    background-position: center;
                }
            }
            .buster-btn.buster-dps {
                .buster-icn {
                    background: url(~imgPath/darkworld-dps-icn.png);
                    background-size: cover;
                    background-repeat: no-repeat;
                    background-position: center;
                }
        ...
        .back-boss-box {
            ...
            .color-btn {
                ...
                top: 0;
                left: 0;
                background: linear-gradient(180deg, #c7f9ff 0%, #3ae6f1 100%);
                .color-btn-text {
                    top: 12px;
                    color: #2f2d2d;
                ...
                &:before,
                &:after {
                    filter: brightness(80%) hue-rotate(148deg);
                    -webkit-filter: brightness(80%) hue-rotate(148deg);
                }
            }
        }
    }
    .popup-layer {
        .m-popup {
            ...
            &:before {
                ...
                box-shadow: 0px 2px 0px rgba(255, 255, 255, 0.35),
                    ...
                    inset 0px 4px 6px 1px rgba(0, 0, 0, 0.35);
            }
            .title {
                background: none;
                box-shadow: none;
            ...
            .btn-close-x {
                ...
                &:before {
                    color: #43297b;
                    text-shadow: 0 0 2px #43297b, 0 0 2px #43297b,
                        0 0 2px #43297b, 0 0 2px #43297b, 0 0 7px #fff,
                        0 0 7px #fff;
                }
            }
        }
        ...
        .m-popup.busters.watch {
            .content {
                .buster-imgs-box {
                    .buster-icn {
                        background-image: url(~imgPath/darkworld-watch-icn.png);
                    }
                }
            }
        }
        .m-popup.busters.dark-coins {
            .content {
                .buster-imgs-box {
                    .buster-icn {
        ...
        .m-popup.busters.dps {
            .content {
                .buster-imgs-box {
                    .buster-icn {
                        background-image: url(~imgPath/darkworld-dps-icn.png);
                    }
                }
            }
        }
        ...
        .m-popup.angel-chests-info {
            .content {
                ...
                .angels-skrollbox-wrap {
                    background: linear-gradient(180deg, #383167, #5648ae);
                    .angels-skrollbox {
                        .angel-avatar-box {
                            background: linear-gradient(
                                155.68deg,
                ...
                .chest-points-box {
                    ...
                    .chest-points-icn {
                        background-image: url(~imgPath/darkworld-chest-points-chip-icon.png);
                    }
                    .chest-points-value {
                        background: #383167;
                        &:before {
        ...
        .m-popup.reborn-dark-popup {
            ...
            &:after {
                ...
                left: -138px;
                bottom: -52px;
                background-image: url(~imgPath/break-girl730.png);
                background-repeat: no-repeat;
            ...
            .re-pop-bg {
                ...
                width: 1200px;
                height: 640px;
                background-image: url(~imgPath/darkworld-re-pop-bg.png);
                background-repeat: no-repeat;
            ...
            .content {
                ...
                .rewards-wrap {
                    ...
                    background-position: 0 80px, 0 0px;
                    background-repeat: no-repeat;
                    &:before,
                    &:after {
                        content: "";
                    ...
                    .reward-box {
                        ...
                        &:last-child {
                            &:after {
                                ...
                                width: 66px;
                                height: 56px;
                                background-image: url(~imgPath/darkworld-angel-pop-btn-bg.png);
                                background-repeat: no-repeat;
                                background-position: center;
                                background-size: cover;
                                filter: brightness(0)
                ...
                .reborn-btn-wrap {
                    ...
                    .reborn-progress {
                                ...
                                .info-box {
                                    ...
                                    .text {
                                        ...
                                        &:before {
                                            ...
                                            border-right: 10px solid #eecc60;
                                            border-radius: 2px;
                                            position: absolute;
                                            top: 50%;
                                            transform: translateY(-50%);
                        ...
                        .btn-simple-gold {
                            text-shadow: 0 1.2px 1.2px rgba(255, 255, 255, 0.6);
                            &:hover {
                                box-shadow: inset 0 0 0 1px rgba(0, 0, 0, 0.2),
                                    inset 0 -20px 5px rgba(200, 119, 37, 0.59),
                                    inset 0 -3px 0px #c87725, 0 0 12px #ff0,
                            ...
                            &:active {
                                box-shadow: inset 0 0 0 1px rgba(0, 0, 0, 0.2),
                                    ...
                                    inset 0 1px 1px #c87725, 0 0 10px #ff0,
...
export default V2ScreenMainDarkWorld;
