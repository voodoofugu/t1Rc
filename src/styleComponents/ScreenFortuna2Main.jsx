...
body .main {
        ...
        .shop-chest-box-all {
            ...
            .res-shop-btn {
                ...
                &:before {
                    ...
                    top: -10px;
                    left: -25px;
                    background-image: url(~imgPath/v2-shop-icon.png);
                    background-size: 100%;
                    background-repeat: no-repeat;
                }
            }
    ...
    .right-side {
        ...
        .world-portal {
            ...
            .pretty-holder {
                background-image: url(~imgPath/facia-1.png);
                width: 110px;
                height: 30px;
                position: absolute;
        ...
        .popup-in {
                ...
                .title {
                    ...
                    .btn-title {
                        ...
                        box-shadow: inset 0 1px 1px 1px rgba(255, 255, 255, 0.6),
                            0 1px 2px rgba(0, 0, 0, 0.4), 0 0 0 2px #ffb12998;
                    }
                }
                .color-box {
                    &:before {
            ...
            .m-popup.sign-in {
                &:after {
                    ...
                    left: 146px;
                    bottom: 10px;
                    background: url(~imgPath/break-girl27.png);
                }
                .title {
                    .btn-title.sign-in {
                        background: rgba(0, 0, 0, 0.1);
                        box-shadow: inset 0 1px 2px 2px rgba(51, 35, 0, 0.24),
