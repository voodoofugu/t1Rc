...
.popup-layer .m-popup.fortuna-main-round-rating{
    width: 750px; height: 530px; left: 225px; top: 55px;
    &:before{content: ""; background: linear-gradient(136deg, #8e7453 0%, #e3c7a3 50%, #ae916a 85%, #8f7553 100%);}
    .title{color: #572f14;}
    .rating-main-box{
        width: 730px; height: 460px; top: 60px; left: 10px; position: absolute;
        ...
        .fw-right-side-content-box{
            ...
            .fw-rating-ped-box-all{
                width: 128px; height: 390px; position: absolute; bottom: 5px; left: 5px;
                .fw-rating-ped-box-p1, .fw-rating-ped-box-p2, .fw-rating-ped-box-p3{
                    width: 100%; height: 145px; position: absolute; top: 0; left: 0;
                ...
                .fw-rating-ped-box-p2{
                    height: 125px; top: 152px;
                    padding: 30px 3px 0px;

                    .fw-rating-ped-pic{top: 12px; left: 25px;}
                }
                .fw-rating-ped-box-p3{
                    height: 105px; top: 285px;
                    .fw-rating-ped-pic{top: 2px; left: 25px;}
                }
                .fw-master-pic{
                    width: 66px; height: 66px; position: absolute; top: 0; left: 0;
                ...
                &.check-p1{
                    .fw-rating-ped-box-p1{
                        .fw-rating-ped-pic{left: 0;}
                    }
                    .fw-master-pic{top: 40px; left: 100px;}
                }
                &.check-p2{
                    .fw-rating-ped-box-p2{
                        .fw-rating-ped-pic{left: 0;}
                    }
                    .fw-master-pic{top: 182px; left: 100px;}
                }
                &.check-p3{
                    .fw-rating-ped-box-p3{
                        .fw-rating-ped-pic{left: 0;}
                    }
                    .fw-master-pic{top: 305px; left: 100px;}
                }
            }
            .rating-scroll-name-box {
                width: 576px; height: 24px; position: absolute; top: 5px; right: 15px;
                color: #eed9cb;
                font-weight: bold;
                line-height: 24px;
                font-size: 14px;
            ...
            .rating-scroll-box{
                ...
                .rating-scroll {
                    display: block; position: absolute; left: 0px; top: 0px; bottom: 0px; right: 0px;
                    overflow-y: scroll;
                    padding-top: 0px;
                    padding-right: 6px;
        ...
        .color-btn{
            ...
            width: 220px; height: 40px; position: absolute; bottom: 10px; left: 243px;
