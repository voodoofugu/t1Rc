...
.popup-layer .m-popup.witch-cauldron-scroll{
    ...
    .color-box{
        background: linear-gradient(#1B2833 0%, #456885 50%, #243645 85%, #1d2c38 100%);
        &:before{display: none};
        &:after{display: none};
    }
    ...
    .witch-cauldron-scroll-boiler-all{
        ...
        &:before{
            ...
            top: 20px;
            margin-left: -20px;
            background-image: url(~imgPath/v2-nsale-plus.png); background-size: 100%;
        }
    ...
    .witch-cauldron-scroll-all{
        ...
        .witch-cauldron-scroll-scroll{
            ...
            .witch-cauldron-scroll-card{
                ...
                background: linear-gradient(0deg, #fede92 0%, #f4c558 18%, #ffe098 60%, #f5c85d 85%, #fddd90 100%);
                @include prefix(border-radius, 10px);
                box-shadow: inset 0 -6px 0 rgba(0, 0, 0, .25), 0px 2px 2px rgba(0, 0, 0, .7);
                ...
                .witch-cauldron-scroll-card-label{
                    ...
                    font-size: 18px;
                    line-height: 40px;
                    @include prefix(border-radius, 0px 0px 2px 2px);
                }
            }
        }
    }
...
export default V2ScreenWitchCauldronScroll;
