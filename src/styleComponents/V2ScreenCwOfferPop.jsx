...
.popup-layer .m-popup.cw-offers-pop{
    ...
    .offers-card-box{
        ...
        .offers-but-box{
            width: 180px; height: 180px; position: absolute; top: 10px; left: 25px;
            img{
                width: 100%;
            }
        }
        .offers-text-box{
            ...
            background: linear-gradient(180deg, #917858 0%, #c8ac88 100%);
            ...
            .offers-text{
                ...
                text-shadow: 0 1px 1px #0d0a01;
            }
        }
        //.offers-price, .offers-bonus{
        ...
        .keybtn-box{
            ...
            box-shadow: inset 0 0 4px #907654;
            .keybtn{
                width: 160px; height: 42px; position: relative; text-align: center; top: 7px;
