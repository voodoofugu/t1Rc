        ...
        .tab-panel-box.guildhall {
          ...
          .leftside-box-all {
            ...
            .guildhall-leftside-title-box {
              ...
              top: 0;
              left: 0;
              background: linear-gradient(0deg, #584a49 0%, #897165 100%);
            ...
            .guildhall-leftside-building {
              ...
              top: 36px;
              left: 0;
              background-image: url(~imgPath/v2-guild-building-bg.png);
              background-size: 90%;
              background-repeat: no-repeat;
              background-position: center;
              .guild-building-pic-guildhall {
                width: 363px;
                height: 254px;
                position: absolute;
                top: 0px;
              ...
              .reborn-box-all {
                ...
                .reborn-box-count-box {
                  width: 86px;
                  height: 26px;
                  position: absolute;
                  top: 6px;
                  left: 40px;
                  background: linear-gradient(180deg, #584a49 0%, #897165 100%);
            ...
            .guildhall-lvlup-box {
              ...
              .guildhall-lvlup-count-box {
                ...
                box-shadow: inset 0 1px 1px rgba(255, 255, 255, 0.2),
                  0 1px 2px rgba(0, 0, 0, 0.35), 0 0 0 1px rgba(0, 0, 0, 0.1);
          ...
          .guildhall-rightside-box-all {
            ...
            .guildhall-rightside-bonus-box {
              ...
              //   top: 0;
              //   right: 0;
              //   background: linear-gradient(0deg, #69a445 0%, #7eca52 100%);
              // }
              .guildhall-bonus {
                width: 120px;
                height: 40px;
                ...
                &:before {
                  ...
                  top: 0;
                  left: -2px;
                  background-image: url(~imgPath/trophy-bonus-dpc.png);
                  background-size: 100%;
                  background-repeat: no-repeat;
                }
                &.gold {
                  &:before {
                    content: "";
                    background-image: url(~imgPath/trophy-bonus-gold.png);
                  }
                }
                &.gems {
                  &:before {
                ...
                &.dpc {
                  &:before {
                    content: "";
                    background-image: url(~imgPath/trophy-bonus-dps.png);
                  }
                }
              }
            }
            .guildhall-base-box {
              ...
              top: 50px;
              left: 0;
              background-image: url(~imgPath/base_bk-end.jpg);
              background-size: 100%;
              background-repeat: no-repeat;
              .room {
                width: 61px;
            ...
            .guildhall-rightside-lvlup-box-all {
              width: 100%;
              height: 92px;
              position: absolute;
              bottom: 6px;
              ...
              .guildhall-lvlup-box {
                ...
                &.diamond {
                  left: 364px;
                  .guildhall-lvlup-count-box:after {
                    content: "";
                    background-image: url(~imgPath/trophy-bonus-diamond.png);
                  }
                }
              }
              .guildhall-room-lvlup-box {
                width: 150px;
                height: 92px;
                position: absolute;
                top: 0;
                ...
                .guildhall-room-lvlup-box-small {
                  width: 156px;
                  height: 50px;
                  position: absolute;
                  bottom: 0;
