    ...
    .rating-left-box {
      ...
      .rating-topbtn-box {
        ...
        .rating-timer-box {
          ...
          box-shadow: inset 0 1px 2px rgba(255, 255, 255, 0.2),
            ...
            0 1px 4px 0 rgba(0, 0, 0, 0.45), 0 0 0 1px rgba(0, 0, 0, 0.1);
          .btn-text1 {
            display: none;
            width: 136px;
            text-align: center;
      ...
      .rating-scroll-name-box {
        ...
        box-shadow: 0 1px 1px rgba(255, 255, 255, 0.1),
          inset 0px 1px 1px rgba(0, 0, 0, 0.1), 0 4px 4px rgba(0, 0, 0, 0.15),
      ...
      .rating-card-list-box {
        ...
        &.podium {
          &:before {
            ...
            bottom: -6px;
            left: -52px;
            background-image: url(../img/girl-stand@2x.png);
            background-size: 100%;
...
export default ScreenRatingMaintabStyles;
