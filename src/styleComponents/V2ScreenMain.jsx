...
.m-popup.bonus-x3 {
    &:after {
        ...
        height: 48px;
        padding-top: 22px;
        background: url(~imgPath/timer-back.png);
...
body .main.world3 {
    ...
    .header {
        ...
        .resource-panel {
            ...
            .resource-gold {
                ...
                .resource-btn-add {
                    ...
                    top: 0px;
                    left: 156px;
                    @include prefix(border-radius, 0 30px 30px 0);
                    cursor: pointer;
                    filter: drop-shadow(0 1px 0.5px rgba(255, 255, 255, 0.795));
                    &:hover {
                        &:before {
            ...
            .resource-vip {
                ...
                .value-vip-ticket {
                    ...
                    &:before {
                        ...
                        top: 0;
                        left: 2px;
                        background-image: url(~imgPath/v2-res-diamond.png);
                        background-size: 100%;
                        background-repeat: no-repeat;
                    }
                }
                .value-vip-ticket {
                    ...
                    &:before {
                        ...
                        top: 0;
                        left: 2px;
                        background-image: url(~imgPath/v2-res-ticket.png);
                        background-size: 100%;
                        background-repeat: no-repeat;
                    }
                }
                ...
                &.lvl0 {
                    .viplvl {
                        background-image: url(~imgPath/2vip-s3.png);
                        background-size: 100%;
                    }
                }
                &.lvl1 {
                    .viplvl {
                        background-image: url(~imgPath/2vip-s1.png);
                        background-size: 100%;
                    }
                }
                &.lvl2 {
                    .viplvl {
                        background-image: url(~imgPath/2vip-s2.png);
                        background-size: 100%;
                    }
                }
                &.lvl3 {
                ...
                &.lvl4 {
                    .viplvl {
                        background-image: url(~imgPath/2vip-s4.png);
                        background-size: 100%;
                    }
                }
                &.lvl5 {
                    .viplvl {
                        background-image: url(~imgPath/2vip-s5.png);
                        background-size: 100%;
                    }
                }
                &.lvl6 {
                    .viplvl {
                        background-image: url(~imgPath/2vip-s6.png);
                        background-size: 100%;
                    }
                }
                &.lvl7 {
                    .viplvl {
                        background-image: url(~imgPath/2vip-s7.png);
                        background-size: 100%;
                    }
                }
                &.lvl8 {
                    .viplvl {
                        background-image: url(~imgPath/2vip-s8.png);
                        background-size: 100%;
                    }
                }
                &.lvl9 {
                    .viplvl {
                        background-image: url(~imgPath/2vip-s9.png);
                        background-size: 100%;
                    }
                }
                &.lvl10 {
                    .viplvl {
                        background-image: url(~imgPath/2vip-s10.png);
                        background-size: 100%;
                    }
                }
                .vip-diamond-text,
        ...
        .shop-chest-box-all {
            ...
            .res-chest-btn {
                ...
                &:before {
                    ...
                    top: -6px;
                    left: 1px;
                    background-image: url(~imgPath/ic-chests-all.png);
                    background-size: 100%;
                    background-repeat: no-repeat;
                }
            }
        ...
        .signinout-btn.in {
            .icon-reg {
                background-image: url(~imgPath/reg-ic-02.png);
            }
        }
        .signinout-btn.out {
            .icon-reg {
                background-image: url(~imgPath/reg-ic-03.png);
            }
        }
    }
    .quest-box-all {
        ...
        &:after {
            ...
            left: 0;
            top: 0;
            background: url(~imgPath/quest-box-bg.png);
            background-position: center;
            background-repeat: no-repeat;
        ...
        .quest-box-scroll {
            ...
            .quest {
                ...
                &.default-hero {
                    ...
                    &:after {
                        ...
                        left: 0;
                        top: 0;
                        background-image: url(~imgPath/images/hero-all/tithero-370/icons/ic-hero.png);
                        background-size: 100%;
                        background-repeat: no-repeat;
                    }
                }
            ...
            .quest.marked {
                ...
                &:after {
                    animation: 7s linear 0s normal none infinite running
                        lockflare;
                    width: 70px;
                    height: 70px;
                    left: 0px;
        ...
        .opt-panel-box {
            ...
            &:before {
                ...
                left: 50%;
                transform: translateX(-50%);
                background-image: url(~imgPath/setting-icn.png);
                background-position: center;
                background-repeat: no-repeat;
                background-size: cover;
                opacity: 0.6;
            ...
            .btn {
                ...
                &.en:after {
                    background-image: url(~imgPath/lang-icon/uk-us.png);
                    background-size: 23px;
                }
                &.de:after {
                    background-image: url(~imgPath/lang-icon/germany.png);
                    background-size: 23px;
                }
                &.fr:after {
                    background-image: url(~imgPath/lang-icon/france.png);
                    background-size: 23px;
                }
                &.ru:after {
                    background-image: url(~imgPath/lang-icon/russia.png);
                    background-size: 23px;
                }
                &.ja:after {
                    background-image: url(~imgPath/lang-icon/japan.png);
                    background-size: 23px;
                }
                &.cn:after {
                    background-image: url(~imgPath/lang-icon/china.png);
                    background-size: 23px;
                }
                &:hover {
        ...
        .btn-discord {
            ...
            &:before {
                ...
                left: 50%;
                transform: translateX(-50%);
                background-image: url(~imgPath/discord-icn.png);
                background-position: center;
                background-repeat: no-repeat;
                background-size: cover;
                opacity: 0.6;
        ...
        .tabs-all-box {
            ...
            .tabs-all {
                ...
                &:before {
                    ...
                    @include prefix(border-radius, 20px 20px 4px 4px);
        ...
        .left-panel {
                        ...
                        .hero-card-box-all {
                            ...
                            .hero-card {
                                ...
                                &.disabled {
                                    .hero-avatar-box {
                                        &:after {
                                            background: url(~imgPath/map-station-lock2.png),
            ...
            .tab-panel-box {
                ...
                box-shadow: inset 0 4px 0 #9c8b7c,
                    inset 0 0 7px rgba(0, 0, 0, 0.1) !important;
            }
                ...
                .womens-btns-content {
                    ...
                    .women-btn-wrap {
                        ...
                        .title {
                            ...
                            height: 42px;
                            line-height: 36px;
                            background-image: url(~imgPath/darkworld-angels-title-bg-lilac.png);
                            background-repeat: no-repeat;
                            background-size: cover;
                            background-position: center;
                            margin-top: 18px;
                            ...
                            .women-btn-box {
                                ...
                                &:hover {
                                    box-shadow: inset 0 1px 1px
                                        ...
                                        0px 1px 5px 3px #00ccffcc,
                                        0px 1px 11px #ffffffb8;
                                }
                            }
                        }
                        &.supheros {
                            .title {
                                background-image: url(~imgPath/darkworld-angels-title-bg-lilac2.png);
                            }
                            .women-btn-box {
                                background: linear-gradient(
                                    155.68deg,
                        ...
                        &.angels {
                            .title {
                                background-image: url(~imgPath/darkworld-angels-title-bg-brown.png);
                            }
                            .women-btn-box {
                                &:hover {
                                    box-shadow: inset 0 1px 1px
    ...
    .right-side {
        ...
        .darkOil-progress-bar-wrap {
            ...
            &:after {
                ...
                left: -8px;
                top: -8px;
                background-image: url(~imgPath/ic-black-butil-160.png);
                background-size: 100%;
                background-repeat: no-repeat;
            }
            .progress-box {
        ...
        .buster-box {
            ...
            .buster-btn.active {
                &:before {
                    ...
                    left: 2px;
                    top: 2px;
                    background: url(~imgPath/paycheck-arrow.png);
                    background-size: 90%;
                    background-repeat: no-repeat;
                    background-position: center;
                    width: 100%;
            ...
            .buster-btn.buster-gold {
                .buster-icn {
                    background: url(~imgPath/change-ic-gold.png);
                    background-size: cover;
                    background-repeat: no-repeat;
                    background-position: center;
                }
        ...
        .monster-prg-box-all {
            ...
            .lvl-prg {
                ...
                &:before {
                    ...
                    right: -5px;
                    bottom: 5px;
                    background-image: url(~imgPath/scul.png);
            ...
            .timer {
                ...
                .time {
                    ...
                    &:before {
                        ...
                        right: -14px;
                        top: -1px;
                        background-image: url(~imgPath/clock2.png);
                        background-size: 100%;
                        background-repeat: no-repeat;
                    }
                    .txt {
        ...
        .back-boss-box {
            ...
            .color-btn {
                ...
                &:before {
                    ...
                    top: 5px;
                    left: 5px;
                    background-image: url(~imgPath/cor-1.png);
                    background-size: 100%;
                    background-repeat: no-repeat;
                }
                &:after {
    ...
    .popup-layer {
            ...
            .content {
                ...
                .buster-imgs-box {
                    ...
                    .buster-stand {
                        ...
                        width: 168px;
                        height: 176px;
                        background-image: url(~imgPath/darkworld-currency-stand.png);
                        background-size: cover;
                        background-repeat: no-repeat;
                        background-position: center;
                    }
                ...
                .title {
                    ...
                    &:after {
                        ...
                        height: 100%;
                        width: 17px;
                        background-image: url(~imgPath/darkworld-angels-title-bg-blue.png);
                        background-repeat: no-repeat;
        ...
        .m-popup.busters.gold-coins {
            .content {
                .buster-imgs-box {
                    .buster-icn {
                        background-image: url(~imgPath/change-ic-gold.png);
                    }
                }
            }
        }
    ...
    .m-popup.pop-reg {
        &.m-popup {
            ...
            .btn-close-x {
                &:before {
                    color: #921b00;
                    text-shadow: 0 0 2px #921b00, 0 0 2px #921b00,
                        0 0 2px #921b00, 0 0 2px #921b00, 0 0 7px #fff,
        ...
        &:after {
            ...
            top: calc(50% + 185px);
            transform: translate(-50%, -50%);
            background: url(~imgPath/rating-girl.png);
            pointer-events: none;
            background-size: cover;
            background-repeat: no-repeat;
        }
        ...
        .content.sign-up1 {
            ...
            .megapack-banner {
                ...
                .g2 {
                    width: 150px;
                    height: 75px;
                    background-image: url(~imgPath/ser-ban-4.jpg);
                    .num {
                        font-size: 40px;
                        line-height: 52px;
                    }
                ...
                .block-a {
                    ...
                    .captcha-wrap {
                        ...
                        &:before {
                            ...
                            width: 18px;
                            height: 18px;
                            background-image: url(~imgPath/ic-refresh.svg);
                            position: absolute;
                            right: 6px;
                            bottom: 6px;
                            opacity: 0.6;
        ...
        .content {
            ...
            .chest-points-box {
                ...
                .chest-points-icn {
                    ...
                    height: 98px;
                    margin-top: 4px;
                    background-image: url(~imgPath/earthworld-chest-points-chip-icon.png);
                    background-position: center;
                    background-repeat: no-repeat;
                    background-size: cover;
                }
...
.color-btn {
    ...
    &.purple {
        ...
        @include prefix(animation, pulse 2s infinite);
        @keyframes pulse {
            0% {
                box-shadow: inset 0 -4px 0 0 rgba(0, 0, 0, 0.25),
                    0 2px 4px 0 rgba(0, 0, 0, 0.55),
                    0 0 0 0 rgba(255, 67, 208, 0.8);
            }
            70% {
                box-shadow: inset 0 -4px 0 0 rgba(0, 0, 0, 0.25),
                    0 2px 4px 0 rgba(0, 0, 0, 0.55),
                    0 0 0 10px rgba(255, 67, 208, 0);
            }
            100% {
                box-shadow: inset 0 -4px 0 0 rgba(0, 0, 0, 0.25),
                    0 2px 4px 0 rgba(0, 0, 0, 0.55),
                    0 0 0 0 rgba(255, 67, 208, 0);
            }
        }
    }
    &.red {
        background: linear-gradient(0deg, #a11010 0%, #ff9e9e 100%);
        @include prefix(animation, pulse_red 2s infinite);
        @keyframes pulse_red {
            0% {
                box-shadow: inset 0 -4px 0 0 rgba(0, 0, 0, 0.25),
                    0 2px 4px 0 rgba(0, 0, 0, 0.55),
                    0 0 0 0 rgba(161, 16, 16, 0.8);
            }
            70% {
                box-shadow: inset 0 -4px 0 0 rgba(0, 0, 0, 0.25),
                    0 2px 4px 0 rgba(0, 0, 0, 0.55),
                    0 0 0 10px rgba(161, 16, 16, 0);
            }
            100% {
                box-shadow: inset 0 -4px 0 0 rgba(0, 0, 0, 0.25),
                    0 2px 4px 0 rgba(0, 0, 0, 0.55),
                    0 0 0 0 rgba(161, 16, 16, 0);
            }
        }
    }
}
