...
const V2ScreenTowerTop = styled.div`
  @charset "utf-8";
                            ...
                            .ped-box {
                                ...
                                &.rate2 {
                                    ...
                                    .ped-box-prize {
                                        ...
                                        height: 70px;
                                        left: 22px;
                                        background-image: url(~imgPath/rating-sign-silver@1x.png);
                                        margin-left: 0;
                                    }
                                }
                                &.rate3 {
                                    ...
                                    .ped-box-prize {
                                        ...
                                        height: 90px;
                                        left: 12px;
                                        background-image: url(~imgPath/rating-sign-gold@1x.png);
                                        margin-left: 0;
                                    }
                                }
                                &.rate4 {
                                    ...
                                    margin-left: 0;
                                    .ped-box-prize {
                                        background-image: url(~imgPath/rating-sign-top@1x.png);
                                        margin-left: 0;
                                    }
                                }
                            }
...
export default V2ScreenTowerTop;
