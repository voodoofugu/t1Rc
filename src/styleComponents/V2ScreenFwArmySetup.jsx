  ...
  .popup-layer .m-popup.army-setup {
    ...
    .fw-as-mercenaries-box-all {
      ...
      .fw-as-mercenaries-box {
        ...
        background-color: #6e5d52;
        background: linear-gradient(180deg, #4f4339 0%, #352c25 100%);
        .fw-as-mercenaries-text1,
        .fw-as-mercenaries-text2 {
          width: 100%;
          height: auto;
          position: relative;
          display: inline-block;
...
const V2ScreenFwArmySetup = styled.div`
  ${V2ScreenFwArmySetupStyles}
`;

export { V2ScreenFwArmySetupStyles, V2ScreenFwArmySetup };
