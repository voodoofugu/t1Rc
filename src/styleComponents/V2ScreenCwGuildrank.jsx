...
.popup-layer .m-popup.guildrank{
    width: 590px; height: 580px; left: 305px; top: 25px;
    .title{color: #572f14;}
    .color-box{
    ...
    .cw-clan-box-all{
        width: 530px; height: 400px; position: absolute; top: 80px; left: 30px;
        background-color: #cbaa81;
        box-shadow: 0 1px 2px rgba(0, 0, 0, 0.35);
        .cw-clan-box-scroll{
            width: 510px; height: 380px; position: absolute; top: 10px; left: 10px;
            ...
            .cw-clan-box{
                ...
                .cw-clan-name-box{
                    width: 200px; height: 70px; position: absolute; top: 5px; left: 180px;
                    .cw-clan-name{
                        max-height: 24px;
                        overflow: hidden;
                        width: auto; height: auto; position: absolute; top: 10px;
                        color: #544746; font-size: 18px; font-weight: bold;
                    }
                    .cw-clan-name-pic{
                        ...
                        .cw-clan-name-pic-num{
                            width: auto; height: auto; position: absolute; left: 30px;
                            color: #544746; font-size: 16px; font-weight: bold;
                        }
                    }
                }
                .cw-clan-lvl-box{
                    width: 110px; height: 70px; position: absolute; top: 5px; right: 0;
                    border-left: 1px solid #cbaa81;
                    .cw-clan-lvl{
                        width: 100px; height: auto; position: absolute; top: 10px; left: 5px;
                        color: #544746; font-size: 18px; font-weight: bold;
                    }
                }
            }
...
export default V2ScreenCwGuildrank;
