    ...
    .fapop-rules-points-box-all {
      ...
      .fapop-rules-points-box {
        ...
        .fapop-rules-points {
          ...
          left: 0;
          &.gray {
            background-image: url(~imgPath/fapop-rules-gray.png);
            background-size: 100%;
          }
          &.green {
            background-image: url(~imgPath/fapop-rules-green.png);
            background-size: 100%;
          }
          &.blue {
            background-image: url(~imgPath/fapop-rules-blue.png);
            background-size: 100%;
          }
          &.yellow {
            background-image: url(~imgPath/fapop-rules-yellow.png);
            background-size: 100%;
          }
