  ...
  .left-side .left-panel .tab-panel.album-panel {
    ...
    .imgs-all {
      ...
      .imgs {
        ...
        &.fav-tags .title {
          ...
          box-shadow: inset 0 20px 0 rgba(255, 255, 255, 0.15),
            inset 0 0 5px #dd7600, inset 0 0 5px #dd7600, inset 0 0 5px #dd7600,
            inset 0 0 7px #dd7600, inset 0 0 7px #dd7600, inset 0 0 7px #dd7600,
    ...
    .btn-add-image {
      ...
      &:hover {
        ...
        box-shadow: inset 0 0px 0px #c87725, 0 0 5px #c87725, 0 0 9px #c87725,
          0 0 11px #c87725;
      }
      &:active {
  ...
  .main .popup-layer .img-lightbox-wrapper {
    ...
    .scroll-controls {
      ...
      .scroll-right {
        ...
        &:not(.disabled):active {
          box-shadow: inset 0 3px 2px #ffa, 0 0px 4px #000, 0 0px 10px #ff0;
          top: 3px;
        }
      }
      .scroll-right {
