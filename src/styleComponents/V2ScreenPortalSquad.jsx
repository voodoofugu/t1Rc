            ...
            &.wide {
                ...
                .tab-panel-box.squads-panel {
                    ...
                    .leftside-box-all {
                        ...
                        top: 39px;
                        left: 0;
                        background: url(~imgPath/hero_bg@2x.png), #725858;
                        ...
                        .suphero-all-box {
                            ...
                            .suphero-squad-wrap {
                                ...
                                .suphero-squad-window:after {
                                    ...
                                    left: -5px;
                                    top: 34px;
                                    background-image: url(~imgPath/squad-corners.png);
                                ...
                                .suphero-squad-heading {
                                    ...
                                    .heading-text {
                                        ...
                                        &:before {
                                            ...
                                            background-image: url(~imgPath/ic-ore-squad.png);
                                ...
                                .suphero-squad-window {
                                    ...
                                    .suphero-specialization {
                                        ...
                                        &:before {
                                            ...
                                            left: -8px;
                                            top: 73px;
                                            background-image: url(~imgPath/specialization-elems-bg.png);
                                    ...
                                    .suphero-card {
                                        ...
                                        &.lvl7 {
                                            ...
                                            .viplvl {
                                                background-image: url(~imgPath/3vip-s7.png);
                                                background-size: 100%;
                                                &:before {
                                                    content: "VII";
                                                }
                                        ...
                                        &.lvl8 {
                                            ...
                                            .viplvl {
                                                background-image: url(~imgPath/3vip-s8.png);
                                                background-size: 100%;
                                                &:before {
                                                    content: "VIII";
                                                }
                                        ...
                                        &.lvl9 {
                                            ...
                                            .viplvl {
                                                background-image: url(~imgPath/3vip-s9.png);
                                                background-size: 100%;
                                                &:before {
                                                    content: "IX";
                                                }
                                        ...
                                        &.lvl10 {
                                            ...
                                            .viplvl {
                                                background-image: url(~imgPath/3vip-s10.png);
                                                background-size: 100%;
                                                &:before {
                                                    content: "X";
                                                }
                        ...
                        .rightbox-wrap {
                            ...
                            .character-information-box {
                                ...
                                &:before {
                                    ...
                                    position: absolute;
                                    top: -11px;
                                    box-shadow: 0px 378px 0 #dd9542,
                                        218px 0 0 #dd9542, 218px 378px 0 #dd9542;
                                    border-radius: 14px;
                                    left: -11px;
                                    filter: drop-shadow(
                                        0 0 2px rgba(0, 0, 0, 0.4)
                                ...
                                .shop-btn {
                                    ...
                                    &.under-shop {
                                        &:before {
                                            background-image: url(~imgPath/v2-xmas-chest-purple.png);
                                            background-size: 88%;
            ...
            .hero-card {
                ...
                .squad-info-buttons {
                    ...
                    .suphero-buttons-info {
                        ...
                        color: #fff;
                        text-shadow: 0px 1px 2px #000000;
                        background: url(~imgPath/banner-squad-bg.png);
                ...
                .squad-card-heroes {
                    ...
                    .squad-card-hero-wrap {
                        ...
                        &:before {
                            ...
                            background: url(~imgPath/2vip-s2@2x.png);
                            background-size: 100%;
                            background-position: center;
                            filter: drop-shadow(
                                2px -2px 2px rgba(0, 0, 0, 0.2)
                        ...
                        &.lvl0 {
                            &:before {
                                background-image: url(~imgPath/2vip-s1@2x.png);
                        ...
                        &.lvl2 {
                            &:before {
                                background-image: url(~imgPath/2vip-s2@2x.png);
                            }
                        }
                        &.lvl3 {
                            &:before {
                                background-image: url(~imgPath/2vip-s3@2x.png);
                            }
                        }
                        &.lvl4 {
                            &:before {
                                background-image: url(~imgPath/2vip-s4@2x.png);
                            }
                        }
                        &.lvl5 {
                            &:before {
                                background-image: url(~imgPath/2vip-s5@2x.png);
                            }
                        }
                        &.lvl6 {
                            &:before {
                                background-image: url(~imgPath/2vip-s6@2x.png);
                            }
                        }
                        &.lvl7 {
                            &:before {
                                background-image: url(~imgPath/3vip-s7@2x.png);
                            }
                        }
                        &.lvl8 {
                            &:before {
                                background-image: url(~imgPath/3vip-s8@2x.png);
                            }
                        }
                        &.lvl9 {
                            &:before {
                                background-image: url(~imgPath/3vip-s9@2x.png);
                            }
                        }
                        &.lvl10 {
                            &:before {
                                background-image: url(~imgPath/3vip-s10@2x.png);
                            }
                        }
                    }
                }
...
export default V2ScreenPortalSquad;
