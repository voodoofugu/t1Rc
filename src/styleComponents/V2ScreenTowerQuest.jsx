      ...
      &.wide {
        ...
        .tab-panel-box.tower-quest {
          ...
          .map-box {
            ...
            top: 39px;
            left: 10px;
            background-image: url(~imgPath/trophy-quest-map-bg.jpg);
            background-size: 100%;
              ...
              .map-quest-box-all {
                ...
                .map-quest-box {
                  ...
                  .s-lock {
                    ...
                    top: 0;
                    left: 0;
                    background-color: rgba(185, 164, 137, 0.4);
            ...
            .s-girl-reward-box {
              ...
              top: 140px;
              left: 429px;
              background: url(~imgPath/raidboss-girl-reward-bg.png);
              background-size: 100%;
              background-repeat: no-repeat;
              .hero-avatar-box {
                width: 98px;
...
.maps-hint {
  ...
  .hint-pic-box-all {
    ...
    .hint-num {
      ...
      text-align: center;
      line-height: 28px;
      text-shadow: 0 2px 4px rgba(0, 0, 0, 0.75), 0 1px 6px rgba(0, 0, 0, 0.85),
