  ...
  .main.world3 {
    .popup-layer {
      ...
      .m-popup.xmas-pop3 {
        ...
        left: 147px;
        top: 52px;
        background: linear-gradient(-22deg, #8faae4, #385dac, #577ac7, #8faae4);
        ...
        .color-box {
          ...
          &:before {
            ...
            top: 350px;
            left: -60px;
            background: url(~imgPath/girl-stand@2x.png);
            background-size: 100%;
              ...
              .prg-all-text {
                ...
                .ic-dildo {
                  &:before {
                    ...
                    margin: 0 5px 0 5px;
                    top: 8px;
                    background-image: url(~imgPath/ic-dildo.png);
                    background-size: 100%;
                  }
                }
              }
...
export default V2ScreenXmasPop1;
