...
const ClanTrophiesStyles = css`
  ...
  .clan-trophies-title-big {
    ...
    border-radius: 28px;
    box-shadow: 0 0 0 2px rgba(0, 0, 0, 0.1), 0 2px 2px 1px rgba(0, 0, 0, 0.2);
    color: #3c3737;
    font-size: 24px;
    font-weight: bold;
  ...
  body .main {
    ...
    .clan-trophies {
      ...
      .titans-garage-row {
        font-size: 0;
        white-space: nowrap;
        transform: rotate(-90deg) translateX(-42px) translateY(-36px) scaleX(-1);
      }
      ...
      .titans-garage-item {
        ...
        .titans-garage-item-inner {
          ...
          border-radius: 6px;
          overflow: hidden;
          box-shadow: inset 0 0 0 2px rgba(0, 255, 234, 0.8), 0 0 10px #000;
              ...
              &.first {
                ...
                .bonus-lvl-box-bonus-box {
                  ...
                  box-shadow: 0px 3px 0px #c87725,
                    0px 5px 2px rgba(0, 0, 0, 0.25), inset 0px 3px 1px #ffffaa;
                }
              }
              &.next {
                background: linear-gradient(
