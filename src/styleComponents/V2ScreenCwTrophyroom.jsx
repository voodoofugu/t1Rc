...
const V2ScreenCwTrophyroomStyles = css`
  body .main {
    .left-side {
      width: 620px;
      height: 555px;
...
const V2ScreenCwTrophyroom = styled.div`
  ${V2ScreenCwTrophyroomStyles}
`;

export { V2ScreenCwTrophyroomStyles, V2ScreenCwTrophyroom };
