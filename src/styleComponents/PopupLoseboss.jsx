...
.popup-layer .m-popup.lose-boss {
    ...
    .lb-girl {
        width: 425px;
        height: 475px;
        background-image: url(~imgPath/back-girl.png);
        position: absolute;
        top: -26px;
        margin-left: -94px;
        background-size: 100%;
    ...
    .lb-content-box {
        ...
        .lb-pic {
            ...
            top: 140px;
            margin-left: 28px;
            background-image: url(~imgPath/lb-pic.jpg);
            background-size: 100%;
        ...
        .lb-checkbox-box {
            ...
            .lb-checkbox {
                ...
                background-image: url(~imgPath/check-off.png);
                background-size: 100%;
                cursor: pointer;
                &:hover {
                ...
                &.active {
                    background-image: url(~imgPath/check-on.png);
                }
            }
            .lb-checkbox-text {
                height: 30px;
