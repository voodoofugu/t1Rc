              ...
              .mine-worker-box-all {
                ...
                .mine-worker-box {
                  ...
                  &:nth-of-type(4) {
                    &.buy {
                      &:before {
                        ...
                        background-position: center 0px, 0% center;
                        background-size: 280px 345px, cover;
                        background-repeat: no-repeat;
                        filter: blur(2px) grayscale(0.5) opacity(0.7)
                          brightness(0.7) sepia(0.4) saturate(0.9);
                  ...
                  &:nth-of-type(2) {
                    &.buy {
                      &:before {
                        background-position: center 0px, 31% center;
                      }
                    }
                  }
                  &:nth-of-type(3) {
                    &.buy {
                      &:before {
                        background-position: center 0px, 70% center;
                      }
                    }
                  }
                  &:nth-of-type(4) {
                  ...
                  &:hover {
                    ...
                    &:nth-of-type(4) {
                      &.buy {
                        &:before {
                          background-position: center -20px, 0% center;
                          filter: blur(0px) grayscale(0.2) opacity(0.9)
                            brightness(0.8) sepia(0) saturate(0.9);
                          transition: ease-in-out 0.14s;
                        }
                      }
                    }
                    &:nth-of-type(2) {
                      &.buy {
                        &:before {
                          background-position: center -20px, 31% center;
                        }
                      }
                    }
                    &:nth-of-type(3) {
                      &.buy {
                        &:before {
                          background-position: center -20px, 70% center;
                        }
                      }
                    }
                    &:nth-of-type(4) {
                      &.buy {
                        &:before {
                          background-position: center -20px, 100% center;
                        }
                      }
                    }
                  }
...
export default V2ScreenMineStyles;
