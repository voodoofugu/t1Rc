...
const ScreenFortuna2PatrickSale = styled.div`
  @charset "utf-8";
...
.popup-layer .m-popup.fortuna-main.patrick-sale {
  ...
  &:before {
    content: "";
    background-image: url(~imgPath/sv-sale-bg2.jpg);
    background-size: 100%;
  }
  .title {
    background: linear-gradient(
  ...
  .sv-sale-heart-box-all {
    ...
    .sv-heart-left {
      ...
      top: 0;
      left: 0;
      background-image: url(~imgPath/pt-h-bg1.png);
      background-size: 100%;
      &:before {
        content: "";
        width: 200px;
        ...
        top: 0;
        left: 0;
        background-image: url(~imgPath/pt-h-bg1-1.png);
        background-size: 100%;
      }
    }
    .sv-heart-right {
      ...
      top: 0;
      left: 200px;
      background-image: url(~imgPath/pt-h-bg2.png);
      background-size: 100%;
      &:before {
        content: "";
        width: 200px;
        ...
        top: 0;
        left: 0;
        background-image: url(~imgPath/pt-h-bg2-1.png);
        background-size: 100%;
      }
    }
    .sv-chain1 {
    ...
    &.one {
      .sv-heart-left {
        background-image: url(~imgPath/pt-h-bg1-g.png);
        &:before {
          content: "";
          background-image: url(~imgPath/pt-h-bg1-1-g.png);
        }
      }
      .sv-chain1 {
        display: none;
    ...
    &.two {
      .sv-heart-right {
        background-image: url(~imgPath/pt-h-bg2-g.png);
        &:before {
          content: "";
          background-image: url(~imgPath/pt-h-bg2-1-g.png);
        }
      }
      .sv-chain2 {
        display: none;
...
export default ScreenFortuna2PatrickSale;
