...
.popup-layer .m-popup.valentine-cauldron{
    ...
    .btn-close-x {
        background: linear-gradient(22deg, #d6c7ff, #dc4ead, #e42aa7, #e4c7ff);
    ...
    .color-box{
        background: linear-gradient(#301b33 0%, #854571 50%, #452441 85%, #381d31 100%);
        &:before{display: none};
        &:after{display: none};
    }
    ...
    .valentine-cauldron-right-box-all{
        ...
        top: 72px;
        left: 220px;
        background-image: url(~imgPath/v2-fapop-vl1.jpg);
...
export default V2ScreenValentineCauldron;
