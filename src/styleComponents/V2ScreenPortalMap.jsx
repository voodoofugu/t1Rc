...
const V2ScreenPortalMapStyles = css`
    body .main {
        background-image: url(../img/images/back/new/12-Undersea-world.jpg);
        .portal-map-box {
            position: absolute;
            width: 1200px;
            height: 640px;
            ...
            .progres-bar {
                ...
                box-shadow: inset 0 1px 0 1px #fffe9a,
                    inset 0 -1px 0 1px #b88c2d, inset 0 5px 0 #cac371,
                    inset 0 0 0 5px #d2d07e, inset 0 0 0 7px rgba(0, 0, 0, 0.2),
                ...
                .bar-scale {
                    ...
                    &:after {
                        ...
                        z-index: 1;
                        background: #77632f;
                        box-shadow: 36.5px 36.5px 0 #77632f,
                            72.5px 72.5px 0 #77632f, 109px 109px 0 #77632f,
                            145px 145px 0 #77632f, 181px 181px 0 #77632f,
                            217.5px 217.5px 0 #77632f, 253.5px 253.5px 0 #77632f,
                            290px 290px 0 #77632f;
                        filter: drop-shadow(
                    ...
                    &:after {
                        ...
                        box-shadow: 36.5px 36.5px 0 #5a4b24,
                            72.5px 72.5px 0 #5a4b24, 109px 109px 0 #5a4b24,
                            145px 145px 0 #5a4b24, 181px 181px 0 #5a4b24,
                            217.5px 217.5px 0 #5a4b24, 253.5px 253.5px 0 #5a4b24,
                            290px 290px 0 #5a4b24;
                    }
                    .bar-scale-patf {
                        height: 22px;
                        position: absolute;
            ...
            .dungTreas-btn {
                ...
                &:before {
                    ...
                    width: 100%;
                    height: 100%;
                    background: url(../img/dungTreas-ic.png);
                    background-position: center;
                    background-repeat: no-repeat;
                    background-size: 100%;
                }
    ...
    .map-locs-wrap {
            ...
            .map-bg {
                ...
                .station-wrap {
                    ...
                    .station {
                        ...
                        left: 0;
                        top: 0;
                        background-image: url(../img/map-station.png);
                        background-repeat: no-repeat;
                        ...
                        &:after {
                            ...
                            position: absolute;
                            background-repeat: no-repeat;
                            background-image: url(../img/map-station-spritesheet.png);
                ...
                .chest-wrap {
                    &:before {
                        ...
                        left: 0;
                        top: 0;
                        background-image: url(../img/map-station-lock1.png);
                        background-repeat: no-repeat;
                    ...
                    &:after {
                        ...
                        top: 0;
                        pointer-events: none;
                        background-image: url(../img/map-station-lock2.png),
                    ...
                    .chest {
                        position: absolute;
                        background-image: url(../img/sh-sq-map-chests.png);
                        width: 78px;
                        height: 78px;
                        pointer-events: auto;
                        background-size: 100%;
                        ...
                        &.ready {
                            ...
                            &:after {
                                ...
                                mix-blend-mode: multiply;
                                animation: 0.6s
                                    cubic-bezier(0.76, 0.01, 0.31, 0.99)
            ...
            &.lock {
                .map-bg {
                    ...
                    .chest-wrap {
                        ...
                        &:after {
                            background: url(../img/v2-lock-ic.png);
                            background-position: center;
                            background-repeat: no-repeat;
        ...
        .inf-btn {
            ...
            position: absolute;
            z-index: 2;
            background: url(../img/gate-icn.png),
        ...
        &.map-01 {
            .loc-box {
                .map-bg {
                    background: url(../img/portal-map-location-01.jpg);
                    &.map-location1 {
        ...
        &.map-02 {
            .loc-box {
                .map-bg {
                    background: url(../img/portal-map-location-02.jpg);
                    &.map-location1 {
                        background-position: 0 -320px;
                        .station-wrap {
                            top: 66px;
...
const V2ScreenPortalMap = styled.div`
    ${V2ScreenPortalMapStyles}
`;

export { V2ScreenPortalMapStyles, V2ScreenPortalMap };
