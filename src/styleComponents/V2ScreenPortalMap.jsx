    ...
    .portal-map-box {
      ...
      .progres-bar {
        ...
        box-shadow: inset 0 1px 0 1px #fffe9a, inset 0 -1px 0 1px #b88c2d,
          ...
          inset 0 0 0 7px rgba(0, 0, 0, 0.2), 0 2px 4px 0 rgba(0, 0, 0, 0.5),
      ...
      .dungTreas-btn {
        ...
        .dungTreas-inf-ic {
          ...
          border-radius: 100%;
          cursor: help;
          box-shadow: inset 0 0 0 1px #fff, inset 0 0 4px rgba(0, 0, 0, 0.6),
      ...
      .chests-scroll-box {
        ...
        .chests-scroll {
          ...
          .pop-up-girl {
            ...
            position: relative;
            overflow: hidden;
            box-shadow: 0 -1px rgba(255, 255, 255, 0.6), 0 0 0 1px #ff9b37,
              0 1px 4px 2px rgba(0, 0, 0, 0.4), 0 0 0 2px rgba(0, 0, 0, 0.2);
  ...
  .map-locs-wrap {
          ...
          .chest {
            ...
            &.ready {
              ...
              &:after {
                ...
                pointer-events: none;
                mix-blend-mode: multiply;
                animation: 0.6s cubic-bezier(0.76, 0.01, 0.31, 0.99) infinite
                  running pulsation;
              }
              .chest-notif {
                opacity: 1;
        ...
        .map-bg {
          ...
          .chest-wrap {
            ...
            &:after {
              ...
              filter: brightness(0.2) drop-shadow(0 1px 2px rgba(0, 0, 0, 0.8));
            }
          }
          &:hover {
            &:after {
    ...
    .inf-btn {
      ...
      .inf-text {
        ...
        font-weight: 700;
        text-shadow: 0 1px 0.5px rgb(255, 255, 255),
          0 1px 2px rgba(255, 255, 255, 0.6), 0 1px 4px rgba(255, 255, 255, 0.2);
        border-radius: 6px;
        z-index: 2;
        box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.4);
        filter: drop-shadow(0 1px 0 #b58a2c) drop-shadow(0 2px 0 #b58a2c)
