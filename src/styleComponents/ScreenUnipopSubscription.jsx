        ...
        .right-box-f {
          ...
          .sub-box-all {
            ...
            .sub-box {
              ...
              position: relative;
              display: inline-block;
              background-image: url(../img/sub-bg-silver.png);
              background-size: 100%;
              background-repeat: no-repeat;
              &.gold {
                background-image: url(../img/sub-bg-gold.png);
                background-size: 100%;
                background-repeat: no-repeat;
              }
              .sub-box-name-box {
          ...
          .sub-bg-girl {
            ...
            bottom: 0;
            left: -30px;
            background-image: url(../img/sub-bg-girl.png);
            background-size: 100%;
            background-repeat: no-repeat;
          }
        }
  ...
  .store-button {
    ...
    &:hover {
      ...
      box-shadow: 0 0 0 1px rgba(0, 0, 0, 0.2),
        ...
        0 0 12px #ff0, 0 0 5px #ffc, inset 0 0 10px #ffc, inset 0 0 3px #603806;
    }
    &:active {
      top: 261px;
      box-shadow: 0 0 0 1px rgba(0, 0, 0, 0.2),
