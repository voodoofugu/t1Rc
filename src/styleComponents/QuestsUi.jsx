    ...
    .popup-layer {
        .quest-popup {
            ...
            .balloon {
                ...
                top: 88px;
                border-radius: 50px;
                box-shadow: 0 0 25px #000, inset 0 0 1px #22d6ee,
                    inset 0 0 50px #22d6ee, inset 0 0 75px #22d6ee;
                pointer-events: all;
                &:before {
                    content: "";
                    display: block;
                    ...
                    position: relative;
                    top: 37px;
                    box-shadow: 0 0 3px #abfdff, 0 0 10px #abfdff,
                        0 0 15px #abfdff;
                    opacity: 0.5;
                }
                .title {
                    ...
                    font-weight: bold;
                    color: #02374e;
                    text-shadow: 0 1px 3px #fff, 0 0 20px #abfdff,
                        0 0 20px #abfdff, 0 0 20px #abfdff, 0 0 20px #abfdff,
                        0 0 20px #abfdff, 0 0 20px #abfdff;
                    margin-top: 15px;
                ...
                .rewards {
                    ...
                    .n {
                        ...
                        right: 0;
                        text-align: left;
                        text-shadow: 0 0 2px #01233b, 0 0 3px #01233b,
                            0 1px 10px #fff, 0 0 10px #fff, 0 0 10px #fff,
                            0 0 10px #fff;
                    }
                    .icon {
                        display: block;
