...
const pageStyles = css`
        ...
        .rating-card-scroll-list-box {
          ...
          .scroll-card-box {
            ...
            box-shadow: inset 0 1px 1px rgba(255, 255, 255, 0.2),
              inset 0 -3px 0 rgba(0, 0, 0, 0.3), 0 1px 6px rgba(0, 0, 0, 0.6);
            ...
            .top-name-card-box {
              ...
              .top-name-card {
                ...
                text-align: center;
                line-height: 26px;
                box-shadow: inset 0 -1.5px 0.5px rgba(0, 0, 0, 0.1);
                &.scenes {
                  width: 141px;
                  left: 100px;
                  background-color: #4a3e35;
  ...
  .rating-slot-box {
    ...
    top: 28px;
    left: 102px;
    background: linear-gradient(0deg, #6d5e52 0%, #493d34 51%, #6b5c50 100%);
