...
const pageStyles = css`
  .popup-layer .m-popup.hero-popup {
    ...
    .color-box {
      background: url(../img/tabs-menu-bg.png), url(../img/tabs-menu-bg.png),
      ...
      .hero-info-box-all {
        ...
        .hclass {
          ...
          box-shadow: 0 2px 0px #393229,
            inset 0 11px 1px rgba(255, 255, 255, 0.15), inset 0 1px 12px #336,
            inset 0 0 5px #ffc;
        }
      }
      .icon-t-shirt {
      ...
      .color-btn.gold {
        ...
        &:after {
          ...
          filter: brightness(0.2)
            drop-shadow(0 1px 1px rgba(255, 255, 255, 0.2)) grayscale(0.6)
            opacity(0.3);
        }
        &:before {
          left: -68px;
        ...
        &:hover {
          ...
          &:after {
            filter: brightness(0.18)
              drop-shadow(0 1px 1px rgba(255, 255, 255, 0.3)) grayscale(0.6)
              opacity(0.3);
          }
        }
        .color-btn-text {
        ...
        &.disabled {
          ...
          &:after {
            filter: brightness(0.2)
              drop-shadow(0 1px 1px rgba(255, 255, 255, 0.4)) opacity(0.3);
          }
        }
      }
    }
      ...
      .dps-dpc-panel-box.hero {
        ...
        .dps {
          ...
          .dps-title {
            ...
            padding-top: 1px;
            text-align: center;
            box-shadow: 0 3px 0px #c87725, 0 5px 0px #3d3737, -1px 0 0px #3d3737,
              inset 0 3px 1px #ffa;
            &:before {
              content: "";
              display: block;
      ...
      .next {
        ...
        .arrow {
          ...
          &:before {
            ...
            background: linear-gradient(-45deg, #e9c44f, #efd368, #f7eec7);
