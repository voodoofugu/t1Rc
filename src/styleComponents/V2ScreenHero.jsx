...
.popup-layer .m-popup.hero-popup {
    ...
    .color-box {
        background: url(~imgPath/tabs-menu-bg.png), url(~imgPath/tabs-menu-bg.png),
            url(~imgPath/tabs-menu-bg.png);
    ...
    .hero-left-side {
        ...
        .icon-t-shirt {
            ...
            top: 0;
            left: 0;
            background-image: url(~imgPath/icon-t-shirt.png);
            background-size: 100%;
        }
    ...
    .hero-right-side {
        ...
        .hero-abils {
            ...
            .abil {
                ...
                padding: 0;
                position: relative;
                background: url(~imgPath/smoke-bg.png),
                ...
                box-shadow: inset 0 1px 1px rgba(255, 255, 255, 0.4),
                    inset 0 0 0 2px #c87726, inset 0 4px 10px rgba(0, 0, 0, 0.2),
                ...
                .icon {
                    ...
                    box-shadow: 0 -1px 1px #f7f1cd, 0 0 0 2px #c87726,
                        0 2px 6px rgba(0, 0, 0, 0.8), 0 0 8px rgba(0, 0, 0, 0.4);
                }
                .name,
                .text {
                    overflow: hidden;
    ...
    .hero-nav {
        ...
        .next {
            ...
            text-shadow: 0 1px 2px rgba(255, 255, 255, 0.8);
            position: relative;
            @include prefix(border-top-right-radius, 7px);
            @include prefix(border-bottom-right-radius, 7px);
            ...
            &.disabled:active {
                ...
                line-height: 30px;
                box-shadow: inset 0 -2px 0px rgba(0, 0, 0, 0.2), 0 0 3px #3d3737;
                .arrow:before {
                    background: #897668;
        ...
        .next {
            ...
            @include prefix(border-top-left-radius, 7px);
            @include prefix(border-bottom-left-radius, 7px);
            .arrow {
                right: auto;
                left: 100%;
                &:before {
...
body .main.world3 .popup-layer .m-popup.hero-popup {
    .hero-right-side {
        background: linear-gradient(#736886, #5b566f);
    }
    .btn-inf {
        background: linear-gradient(22deg, #d7c7ff, #b4abff, #5429ff, #c8c7ff);
