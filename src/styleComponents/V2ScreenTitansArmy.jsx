...
.popup-layer .m-popup.at-army-setup{
    width: 970px; height: 620px; left: 115px; top: 10px;
    .title{color: #572f14;}
    .color-box{
    ...
    .at-filter-box-all{
        width: 920px; height: 40px; position: absolute; top: 70px; left: 26px;
        .at-filter-box{
            width: 640px; height: 40px; position: absolute; top: 0; left: 0;
            background-color: #54463c;
            .at-filter{
                width: 90px; height: 30px; position: absolute; top: 10px; left: 0;
                .at-filter-name{
                    width: 100%; height: auto; position: relative; display: inline-block; top: -4px;
            ...
            .at-filter-btn-box{
                width: 550px; height: 26px; position: absolute; top: 7px; right: 0;
                font-size: 0;
                .color-btn{
    ...
    .at-girl-box{
        width: 920px; height: 220px; position: absolute; top: 120px; left: 26px;
        background-color: #6e5d52;
        .at-girl-box-scroll{
            width: 910px; height: 210px; position: absolute; top: 5px; left: 5px;
            ...
            &::-webkit-scrollbar-thumb {
                background: linear-gradient(0deg, #ffe199, #f4c657, #f4c657, #ffe199);
            }
            .hero-avatar-box{
                ...
                &.locked{
                    .at-army-locked-box{display: table;}
                }
            }
        }
    }
    .at-army-box-all{
        width: 920px; height: 255px; position: absolute; top: 340px; left: 26px;
        background-color: #6e5d52;
        ...
        .team{
            ...
            .t-slot{
                ...
                &:before{
                    content: "\002B"; width: 100%; height: 100%; position: absolute; top: 0; left: 0;
                    color: #6e5d52; font-size: 90px; line-height: 150px;
                }
                ...
                .specialization{
                    ...
                    background: linear-gradient(180deg, #8e7453, #ae916a, #8f7553, #e3c7a3 60%);
                }
                .ava{
                    position: absolute;
                    top: 21px;
                ...
                .pwr{
                    ...
                    background: linear-gradient(0deg, #fddd8e, #f4c658, #ffe198 60%);
                }
        ...
        .at-army-box{
            width: 920px; height: 50px; position: absolute; top: 0; left: 0;
            background-color: #6e5d52;
            background: linear-gradient(180deg, #4f4339 0%, #352c25 100%);
            .at-army-text{
                width: 100%; height: auto; position: relative; display: inline-block; top: 16px;
                color: #f0e3a8; font-weight: bold; font-size: 14px; text-transform: uppercase;
            }
        }
    }
}
...
export default V2ScreenTitansArmy;
