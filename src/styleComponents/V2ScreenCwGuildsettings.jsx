...
const V2ScreenCwGuildsettings = styled.div`
  @charset "utf-8";
@import "sass_commons.scss";


.popup-layer .m-popup.guildsettings{
    width: 590px; height: 590px; left: 305px; top: 25px;
    .title{color: #572f14;}
    .color-box{
    ...
    .cw-clan-settings-box-all{
        width: 530px; height: 430px; position: absolute; top: 80px; left: 30px;
        background-color: #cbaa81;
        box-shadow: 0 1px 2px rgba(0, 0, 0, 0.35);
        .cw-clan-settings-name-box{
            width: 460px; height: 30px; position: absolute; top: 50px; left: 35px;
            .cw-clan-settings-name{
                width: 460px; height: 30px; position: absolute;
                background-color: #fff;
                color: #544746; font-size: 18px; font-weight: bold; line-height: 30px;
                box-shadow: inset 0 0 2px rgba(0, 0, 0, 0.35);
            }
            .cw-clan-edit{
                width: 440px; height: 30px; position: absolute; left: 10px; text-transform: capitalize;
        ...
        .cw-clan-settings-clanlogo-box-all{
            width: 460px; height: 170px; position: absolute; top: 90px; left: 35px;
            background-color: #d8bb96;
            .cw-clan-logo-box{
                cursor: pointer;
                width: 104px; height: 104px; position: absolute; top: 10px; left: 178px;
                background: linear-gradient(0deg, #347ca1, #4db9d0 100%);
                @include prefix(border-radius, 100%);
                box-shadow: 0 1px 2px rgba(0, 0, 0, 0.35);
                &:before{
                    content: ""; width: 100px; height: 100px; position: absolute; top: 2px; left: 2px;
                    background-color: #fff;
                    @include prefix(border-radius, 100%);
                    box-shadow: inset 0 0 10px rgba(0, 0, 0, 0.15);
                }
                .cw-clan-logo-bg, .cw-clan-logo{
                    width: 80px; height: 80px; top: 12px; left: 12px;
                    img{width: 80px;}
                    .cw-clan-logo{
                        top: 0; left: 0;
                    }
            ...
            .color-btn.choose{
                width: 120px; height: 30px; top: 125px;
                .color-btn-text{
                    top: 5px
                }
                &:active{
        ...
        .cw-clan-settings-text-box{
            width: 460px; height: 100px; position: absolute; bottom: 10px; left: 35px; display: table;
            background-color: #fff;
            box-shadow: inset 0 0 4px rgba(0, 0, 0, 0.35);
            .cw-clan-settings-text{
                width: 440px; height: auto; position: relative; display: table-cell; vertical-align: middle; padding: 0 20px;
                color: #544746; font-size: 14px; font-weight: bold;
            }
        }
    }
    .color-btn.disband{
        width: 180px; top: 525px; left: 95px;
...
export default V2ScreenCwGuildsettings;
