    ...
    .main-bg-scroll-box {
        ...
        .sexped-bg-map-scroll-box {
            ...
            .sexped-bg-map {
                ...
                height: 640px;
                position: relative;
                background-image: url(~imgPath/v2-sexped-bg2.jpg);
                background-size: 100%;
                background-repeat: no-repeat;
            }
            .sexped-nods-box {
                ...
                .sexped-nods-pic {
                    ...
                    bottom: 0;
                    left: 0;
                    background-image: url(~imgPath/v2-sexped-nods-sprite-120-1.png);
                ...
                &.lastDone {
                    &:after {
                        content: url(~imgPath/fapop-ic01.png);
                        width: 100px;
                        height: 150px;
                        position: absolute;
                        top: -35px;
                ...
                &.sexped-nods-box--30 {
                    ...
                    .sexped-nods-pic {
                        ...
                        background-size: cover;
                        background-repeat: no-repeat;
                        background-image: url(~imgPath/v2-sexped-nods-sprite.png);
                ...
                .tabs-menu-btn {
                    ...
                    .txt {
                        ...
                        &:before {
                            ...
                            width: 30px;
                            height: 30px;
                            background: url(~imgPath/ic-girls-pieces.png);
                            background-position: 0 0;
                            background-repeat: no-repeat;
                        ...
                        .hero-avatar-box {
                            ...
                            &.selected {
                                ...
                                box-shadow: inset 0 1px 1px
                                        hsla(0, 0%, 100%, 0.8),
                                    0 2px 0 #299d29,
                                    0 2px 6px 1px rgba(46, 255, 18, 0.780392),
...
.dpc-dps-sp {
    .title {
        ...
        .icon-buff {
            background-image: url(~imgPath/tab-07@2x.png);
...
export default V2ScreenSexpedMain;
