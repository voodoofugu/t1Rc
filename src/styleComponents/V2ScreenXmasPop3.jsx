      ...
      .popup-layer .m-popup.xmas-pop3 {
        ...
        .xmas-daily-prg-box-all {
          ...
          .xmas-prg-bar-box {
            ...
            .xmas-prg-name-pic {
              ...
              box-shadow: inset 0 1px 1px rgba(255, 255, 255, 0.2),
                inset 0 -2px 1px rgba(0, 0, 0, 0.1), 0 0 0 1px #11597a,
              ...
              &:before {
                ...
                top: 2px;
                left: 4px;
                background-image: url(../img/ic-dildo-gold.png);
                background-size: 100%;
              }
            }
            .xmas-prg-bar {
          ...
          .xmas-prg-girl {
            ...
            left: 0;
            bottom: 0;
            background-image: url(../img/break-girl-mas-event-pass-02.png);
          ...
          .xmas-reward-chest-box {
            ...
            text-align: center;
            &:hover {
              background: linear-gradient(0deg, #fed95f 0%, #fff8d9 100%);
              .xmas-level-rew-pic {
            ...
            .xmas-prg-bar-num-line {
              ...
              .xmas-prg-bar-num {
                ...
                filter: drop-shadow(0 -0.5px 0 #f7eec7)
                  drop-shadow(0 -0.5px 0 #f7eec7)
          ...
          .xmas-daily-box {
            ...
            .daily-parth-box {
              ...
              .daily-prgbar-all {
                ...
                bottom: 11px;
                left: 11px;
                background: linear-gradient(#11597a, #136084, #11597a);
                border-radius: 3px;
                overflow: hidden;
                box-shadow: 0 0 0 1px #11597a,
...
export default V2ScreenXmasPop3Styles;
