...
const ScreenFortuna2MainMAINStyles = css`
  .popup-layer .m-popup.fortuna-main-2 {
    ...
    &.ny2019 {
      background: linear-gradient(-22deg, #c7dfff, #2677d4, #56a2f8, #c7dfff);
      &:before {
        content: "";
        background: #5e8db4;
      }
      .title {
        color: #fff;
        background: linear-gradient(to right, #c7dfff, #56a2f8, #c7dfff);
...
export default ScreenFortuna2MainMAINStyles;
