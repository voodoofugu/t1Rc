...
body .main {
    .mine-event-screen-chest {
        width: 100%;
        height: 100%;
        background-image: url(~imgPath/./v2-mn-bg-chest.jpg);
        background-size: 100%;
        position: absolute;
        top: 0;
        overflow: hidden;
        ...
        .mn-chest-box {
            ...
            &.chest-silver {
                top: 105px;
                left: 55px;
                background-image: url(~imgPath/v2-mn-chest-silver.png);
                background-size: 100%;
                background-repeat: no-repeat;
            }
            &.chest-gold {
                top: 85px;
                left: 448px;
                background-image: url(~imgPath/v2-mn-chest-gold.png);
                background-size: 100%;
                background-repeat: no-repeat;
            }
            &.chest-bronze {
                top: 105px;
                right: 65px;
                background-image: url(~imgPath/v2-mn-chest-bronze.png);
                background-size: 100%;
                background-repeat: no-repeat;
            }
            &.silver-open {
...
body .main.world3 {
    .mine-event-screen-chest {
        background-image: url(~imgPath/v2-mn-bg-darkworld-chest.jpg);
        .mine-event-screen-head-box {
            .mine-event-screen-head {
                .x-info-btn {
                    background: linear-gradient(
