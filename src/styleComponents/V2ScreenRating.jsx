...
const V2ScreenRatingStyles = css`
    body .main{
        .left-side{
            ...
            .left-panel{
                ...
                &.wide.rating{
                    ...
                    .heroes-list-all-box{
                        width: 522px;
                        .rating-topbtn-box{
                            width: 500px; height: 80px; position: absolute; top: 10px; left: 10px;
                            .rating-timer-box{
                                ...
                                .rating-timer, .rating-timer-text{
                                    width: 100%; height: 16px; position: absolute; top: 6px;
                                    text-align: center; font-size: 16px; text-transform: uppercase; color: #fff000; top: 4px;
                                    font-weight: bold; line-height: 16px; text-shadow: 0 2px 6px rgba(0, 0, 0, 0.45);
                                }
                                .rating-timer-text{
                                    height: 16px; top: 22px;
                                    font-size: 12px; text-transform: uppercase; color: #fff;
                                    line-height: 16px;
                                }
                                &.time-up{
                                    cursor: pointer;
                                    .btn-text1 {display: block;}
                                    .rating-timer, .rating-timer-text{ display: none; }
                                }
                            }
                        }
                        .color-btn{
                            width: 150px; position: absolute; top: 20px; right: 10px;
                        }
                    }
                    .all-heroes-box{
                        height: 396px;
                        .container-top{
                            width: 480px; height: 375px; position: absolute; top: 10px; left: 10px;
                            .rating-ped-box {
                                width: 480px; height: 144px; position: absolute; top: 0; left: 0;
                                .rating-ped-box-num {
                                    width: 114px; height: 24px; position: absolute; bottom: 0px;
                                    background: linear-gradient(180deg, #6d5e52 0%, #493d34 100%);
                                    .ped-box-num-text {
                                        width: 100%; height: 24px;
                                        color: #fff; line-height: 24px; font-size: 14px;
                                        text-align: center; text-shadow: 0 2px 4px rgba(0, 0, 0, 0.75);
                                        &.var2, &.var4{
                                ...
                                .ped-box {
                                    width: 114px; height: 144px; position: absolute; bottom: 0px;
                                    ...
                                    .ped-box-prize {
                                        width: 100px; height: 100px; position: absolute; top: 8px; left: 7px;
                                        background-size: 100%;
                                        &.noreward{
                                    ...
                                    .ped-box-noreward{
                                        width: 114px; height: 60px; position: absolute; top: 0; left: 0;
                                        color: #fff; font-size: 12px;  font-weight: bold; text-align: center;
                                        text-transform: uppercase; line-height: 60px; text-shadow: 0 1px 2px rgba(0, 0, 0, 0.35);
                                    }
                                    &.rate1 {
                                        height: 84px;
                                        .ped-box-prize {
                            ...
                            .rating-scroll-name-box {
                                width: 470px; height: 24px; position: absolute; top: 152px; left: 0;
                                color: #eed9cb;
                                font-weight: bold;
                                line-height: 24px;
                                font-size: 14px;
                    ...
                    .btn-close-x{display: block;}
                    .rating-right-box{
                        width: 575px; height: 505px; position: absolute; top: 5px; right: 9px;
...
const V2ScreenRating = styled.div`
  ${V2ScreenRatingStyles}
`;

export { V2ScreenRatingStyles, V2ScreenRating };
