    ...
    })(
        {
            1: [
                function (require, module, exports) {
                    ...
                    var _AnimatorTimeline2 =
                        _interopRequireDefault(_AnimatorTimeline);
                        ...
                        _createClass(Animator, null, [
                            {
                                ...
                                value: function play(
                                    ...
                                    for (
                                        var i = 0, len = instance.labels.length;
                                        i < len;
                                        i++
                                    ) {
                                        ...
                                        if (label.label === event) {
                                            ...
                                            label.label ===
                                            event + this.STOP_LABEL
                                        ) {
                                            endLabel = label;
                                        } else if (
                                            label.label ===
                                            event + this.LOOP_LABEL
                                        ) {
                                            loop = true;
                                            endLabel = label;
                                        }
                                    ...
                                    if (!startLabel) {
                                        throw new Error(
                                            "No start label matching '" +
                                                event +
                                                "'"
                                        );
                                    } else if (!endLabel) {
                                        throw new Error(
                                            "No end label matching '" +
                                                event +
                                                "'"
                                        );
                                    }
                                    ...
                                    // Add a new timeline
                                    var timeline =
                                        _AnimatorTimeline2.default.create(
                                            instance,
                                            loop,
                                            startLabel.position,
                                            endLabel.position,
                            ...
                            },
                            {
                                ...
                                value: function stop(instance) {
                                    for (
                                        var i = 0, len = this._timelines.length;
                                        i < len;
                                        i++
                                    ) {
                            ...
                            },
                            {
                                ...
                                value: function _internalStop(timeline) {
                                    this._timelines.splice(
                                        this._timelines.indexOf(timeline),
                                        1
                                    );
                            ...
                            },
                            {
                                ...
                                value: function _update() {
                                    for (
                                        var i = this._timelines.length - 1;
                                        i >= 0;
                                        i--
                                    ) {
                            ...
                            [
                                ...
                                },
                                {
                                    ...
                                    value: function update() {
                                        if (
                                            this.instance.currentFrame >=
                                            this.end
                                        ) {
                                            if (this.loop) {
                                                this.instance.gotoAndPlay(
                                                    this.start
                                                );
                                            } else {
                                ...
                                },
                                {
                                    key: "stop",
                                    value: function stop() {
                                        PIXI.animate.Animator._internalStop(
                                            this
                                        );
                                    },
                    ...
                    var MovieClip = (function (_Container) {
                        ...
                        function MovieClip(
                            ...
                            var _this = _possibleConstructorReturn(
                                this,
                                Object.getPrototypeOf(MovieClip).call(this)
                            );
                            ...
                            if (_this.mode === MovieClip.INDEPENDENT) {
                                _this._tickListener =
                                    _this._tickListener.bind(_this);
                        ...
                        _createClass(MovieClip, [
                            ...
                            },
                            {
                                ...
                                value: function _parseProperties(properties) {
                                    ...
                                    if (typeof properties.t === "string") {
                                        properties.t =
                                            _utils2.default.hexToUint(
                                                properties.t
                                            );
                                    } else if (
                                        typeof properties.v === "number"
                                    ) {
                            ...
                            },
                            {
                                ...
                                value: function addTimedChild(
                                    ...
                                    for (
                                        i =
                                            this._timedChildTimelines.length -
                                            1;
                                        i >= 0;
                                        --i
                                    ) {
                                        if (
                                            this._timedChildTimelines[i]
                                                .target === instance
                                        ) {
                                            timeline =
                                                this._timedChildTimelines[i];
                                    ...
                                    if (!timeline) {
                                        ...
                                        this._timedChildTimelines.push(
                                            timeline
                                        );
                                    }

                                    // Fill the timeline with keyframe booleans
                                    _utils2.default.fillFrames(
                                        timeline,
                                        startFrame,
                                        duration
                                    );
                                    ...
                                    if (keyframes) {
                                        if (typeof keyframes === "string") {
                                            keyframes =
                                                _utils2.default.deserializeKeyframes(
                                                    keyframes
                                                );
                                        }
                                    ...
                                    if (typeof startFrame === "string") {
                                        ...
                                        if (index === undefined) {
                                            throw (
                                                "The label '" +
                                                startFrame +
                                                "' does not exist on this timeline"
                                            );
                                        }
                                        startFrame = index;
                                    }
                            ...
                            },
                            {
                                ...
                                value: function advance(time) {
                                    ...
                                    this.currentFrame = Math.floor(
                                        this._t * this._framerate + 0.00000001
                                    );
                            ...
                            },
                            {
                                ...
                                value: function _goto(positionOrLabel) {
                                    var pos =
                                        typeof positionOrLabel === "string"
                                            ? this._labelDict[positionOrLabel]
                                            : positionOrLabel;
                                    if (pos === undefined) {
                                        // jshint ignore:line
                                        return;
                            ...
                            },
                            {
                                ...
                                value: function _updateTimeline() {
                                    ...
                                    var startFrame =
                                        this._prevPos < 0 ? 0 : this._prevPos;
                                    this._setTimelinePosition(
                                        startFrame,
                                        this.currentFrame,
                                        synched ? false : this.actionsEnabled
                                    );
                            ...
                            },
                            {
                                ...
                                value: function _setTimelinePosition(
                                    startFrame,
                                    currentFrame,
                                    doActions
                                ) {
                                    ...
                                    var timedChildTimelines =
                                        this._timedChildTimelines;
                                    var depthSorted = this._depthSorted;
                                    for (
                                        i = 0,
                                            length = timedChildTimelines.length;
                                        i < length;
                                        ++i
                                    ) {
                                        var target =
                                            timedChildTimelines[i].target;
                                        var shouldBeChild =
                                            timedChildTimelines[i][
                                                currentFrame
                                            ];
                                    ...
                                    for (
                                        i = 0, length = depthSorted.length;
                                        i < length;
                                        i++
                                    ) {
                                        var _target = depthSorted[i];
                                        var currentIndex =
                                            this.children.indexOf(_target);
                                        if (currentIndex !== i) {
                    ...
                    Object.defineProperty(ShapesCache, "add", {
                        ...
                        value: function value(prop, items) {
                            ...
                            if (typeof items === "string") {
                                items =
                                    _utils2.default.deserializeShapes(items);
                            }
            ...
            6: [
                function (require, module, exports) {
                    ...
                    var p = (Timeline.prototype = Object.create(
                        Array.prototype
                    ));
                    ...
                    p.addTween = function (
                        ...
                        for (prop in properties) {
                            ...
                            //otherwise, get the current value
                                ...
                                var startValue = (startProps[prop] =
                                    this.getPropFromShorthand(prop));
    ...
    return value % TWO_PI;*/
                    ...
                    var AnimateUtils = (function () {
                        ...
                        _createClass(AnimateUtils, null, [
                            ...
                            },
                            {
                                ...
                                value: function deserializeKeyframes(
                                    keyframes
                                ) {
                                    var result = {};
                                    var i = 0;
                            ...
                            },
                            {
                                ...
                                value: function addMovieClips(item) {
                                    if (
                                        item instanceof PIXI.animate.MovieClip
                                    ) {
                                        item._timedChildTimelines.forEach(
                                            function (timeline) {
                                                var index =
                                                    item.children.indexOf(
                                                        timeline.target
                                                    );
                                                if (index === -1) {
                                                    _prepare.add(
            ...
            11: [
                function (require, module, exports) {
                     ...
                     * @return {PIXI.Container} THe child
                     */
                    PIXI.Container.extend = PIXI.Container.e = function (
                        child
                    ) {
            ...
            12: [
                function (require, module, exports) {
                    ...
                    p.setMask = p.ma = function (mask) {
                        ...
                        if (mask) {
                            if (
                                !(mask instanceof PIXI.Graphics) &&
                                !(mask instanceof PIXI.Sprite)
                            ) {
                                if (
                     ...
                     * @return {PIXI.DisplayObject} THe child
                     */
                    PIXI.DisplayObject.extend = PIXI.DisplayObject.e =
                        function (child) {
                            child.prototype = Object.create(p);
                            child.prototype.__parent = p;
                            child.prototype.constructor = child;
            ...
            13: [
                function (require, module, exports) {
                    ...
                    p.ls = function () {
                        console.warn(
                            "Linear gradient strokes are not supported"
                        );
                        return this;
                    };
                    ...
                    p.rs = function () {
                        console.warn(
                            "Radial gradient strokes are not supported"
                        );
                        return this;
                    };
                },
            ...
            15: [
                function (require, module, exports) {
                    ...
                    p.setShadow = p.sh = function (color, angle, distance) {
                        ...
                        style.dropShadowColor = isUndefinedOr(
                            color,
                        ...
                        style.dropShadowDistance = isUndefinedOr(
                            distance,
                     ...
                     */
                    var isUndefinedOr = function isUndefinedOr(
                        value,
                        defaultValue
                    ) {
            ...
            16: [
                function (require, module, exports) {
                    ...
                    var _DisplayObject2 =
                        _interopRequireDefault(_DisplayObject);
