        ...
        for (var i = 0, n = tracks.length; i < n; i++) {
          ...
          if ((i == 0 && mix == 1) || blend == core.MixBlend.add) {
            ...
            for (var ii = 0; ii < timelineCount; ii++) {
              ...
              var timelineBlend =
                (timelineMode[ii] & (AnimationState.NOT_LAST - 1)) ==
            ...
            if (timeline instanceof core.RotateTimeline)
              ...
              if (timelineBlend == core.MixBlend.setup) {
                if (timeline instanceof core.AttachmentTimeline) {
                  ...
                  if (drawOrder) direction = core.MixDirection.mixIn;
                }
              }
              timeline.apply(
                skeleton,
    ...
    var SkeletonBinary = (function () {
      ...
      SkeletonBinary.prototype.readSkeletonData = function (binary) {
        ...
        for (var i = 0; i < n; i++) {
          ...
          if (darkColor != -1)
            core.Color.rgb888ToColor(
              (data.darkColor = new core.Color()),
              darkColor
            );
      ...
      SkeletonBinary.prototype.readAnimation = function (
          ...
          for (var ii = 0, nn = input.readInt(true); ii < nn; ii++) {
            ...
            switch (timelineType) {
              ...
              case SkeletonBinary.SLOT_COLOR: {
                ...
                duration = Math.max(
                  duration,
                  timeline.frames[(frameCount - 1) * core.ColorTimeline.ENTRIES]
                );
                break;
              }
              case SkeletonBinary.SLOT_TWO_COLOR: {
                ...
                duration = Math.max(
                  duration,
                  timeline.frames[
                    (frameCount - 1) * core.TwoColorTimeline.ENTRIES
                  ]
                );
                break;
              }
            ...
            switch (timelineType) {
              case SkeletonBinary.BONE_ROTATE: {
                ...
                duration = Math.max(
                  duration,
                  timeline.frames[
                    (frameCount - 1) * core.RotateTimeline.ENTRIES
                  ]
                );
                break;
              }
              ...
              case SkeletonBinary.BONE_SHEAR: {
                ...
                duration = Math.max(
                  duration,
                  timeline.frames[
                    (frameCount - 1) * core.TranslateTimeline.ENTRIES
                  ]
                );
                break;
              }
        ...
        for (var i = 0, n = input.readInt(true); i < n; i++) {
          ...
          duration = Math.max(
            duration,
            timeline.frames[
              (frameCount - 1) * core.IkConstraintTimeline.ENTRIES
            ]
          );
        }
        for (var i = 0, n = input.readInt(true); i < n; i++) {
          ...
          duration = Math.max(
            duration,
            timeline.frames[
              (frameCount - 1) * core.TransformConstraintTimeline.ENTRIES
            ]
          );
        }
        for (var i = 0, n = input.readInt(true); i < n; i++) {
            ...
            switch (timelineType) {
              ...
              case SkeletonBinary.PATH_MIX: {
                ...
                duration = Math.max(
                  duration,
                  timeline.frames[
                    (frameCount - 1) * core.PathConstraintMixTimeline.ENTRIES
                  ]
                );
                break;
              }
      ...
      SkeletonBinary.PositionModeValues = [
        core.PositionMode.Fixed,
        core.PositionMode.Percent,
      ];
      SkeletonBinary.SpacingModeValues = [
        core.SpacingMode.Length,
        core.SpacingMode.Fixed,
        core.SpacingMode.Percent,
      ];
      SkeletonBinary.RotateModeValues = [
        core.RotateMode.Tangent,
        core.RotateMode.Chain,
        core.RotateMode.ChainScale,
      ];
      ...
      SkeletonJson.prototype.readAnimation = function (
        ...
        if (map.events) {
          ...
          for (var i = 0; i < map.events.length; i++) {
            ...
            var event_6 = new core.Event(
              core.Utils.toSinglePrecision(this.getValue(eventMap, "time", 0)),
              eventData
            );
  ...
  var AtlasParser = (function () {
    ...
    AtlasParser.use = function (resource, next) {
      ...
      var isBinarySpineModel =
        isBuffer(resource) &&
        (resource.extension === "skel" || resource.metadata.spineMetadata);
      ...
      if (metadataAtlas && metadataAtlas.pages) {
        parser.attachmentLoader = new pixi_spine.core.AtlasAttachmentLoader(
          metadataAtlas
        );
