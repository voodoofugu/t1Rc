...
export default memo(function RelicsPop({ event }) {
  let data = [
    ...
    {
      summer: [
        "img/images/hero-all/tithero-854/x2/tithero-4.jpg",
        "Forbidden Heaven",
        [
          "img/evPopArts/cur_palace01.png",
          "img/evPopArts/cur_palace02.png",
          "img/evPopArts/cur_palace03.png",
          "img/evPopArts/cur_palace04.png",
          "img/evPopArts/cur_palace05.png",
          "img/evPopArts/cur_palace06.png",
          "img/evPopArts/cur_palace07.png",
          "img/evPopArts/cur_palace08.png",
          "img/evPopArts/cur_palace09.png",
          "img/evPopArts/cur_palace10.png",
        ],
        "img/evPopArts/cur_palace_all.png",
        "img/bGs/interior05.jpg",
      ],
    },
    {
      autumn: [
