...
export default memo(function RelicsPop({ event }) {
  let data = [
    ...
    {
      summer: [
        "img/images/hero-all/tithero-812/x2/tithero-4.jpg",
        "Golden Mirage",
        [
          "img/evPopArts/gem-01.png",
          "img/evPopArts/gem-02.png",
          "img/evPopArts/gem-03.png",
          "img/evPopArts/gem-04.png",
          "img/evPopArts/gem-05.png",
          "img/evPopArts/gem-06.png",
          "img/evPopArts/gem-07.png",
          "img/evPopArts/gem-08.png",
          "img/evPopArts/gem-09.png",
          "img/evPopArts/gem-10.png",
        ],
        "img/evPopArts/gems-box.png",
        "img/bGs/egypt_bg01.jpg",
      ],
    },
    {
      autumn: [
