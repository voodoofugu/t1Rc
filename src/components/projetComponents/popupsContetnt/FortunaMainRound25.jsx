...
export default function FortunaMainRound25() {
  return (
      ...
      <div className="fortuna-main-controls-box">
        <div className="rjackpot-box collected">
          ...
          <div className="rjackpot-box-collected-label">
            <div className="rjackpot-box-collected-label-text">collected</div>
          </div>
        </div>
        ...
        <div className="rrules-box">
          <div className="rules-text">
            ...
            <div>
              2. Each use of the Push button gives a prize and increases points
              counter.
            </div>
            <div>
