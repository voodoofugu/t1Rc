        ...
        : event === "bf"
          ...
          : event === "vl"
            ...
            : event === "spring"
              ...
              : event === "summer"
                ? "images/hero-all/tithero-851/icons/break-girl4"
                : event === "autumn"
            ...
            : event === "spring"
              ...
              : event === "summer"
                ? [
                    "BuyShop",
                    {
                      img1: "evPopArts/sinful_sorcery_pass_01",
                      img2: "evPopArts/sinful_sorcery_pass_02",
                      img3: "evPopArts/sinful_sorcery_pass_03",
                    },
                  ]
                : event === "sexpedition"
                  ? [
      ...
      <div className="btlpass-box-all">
        <div className="btlpass-collect-box-all">
          ...
          <div className="squad-holder">
            <ItemBox
              className={`cardAva`}
              itemPic="img/evPopArts/sinful_sorcery_icon.png"
            />
            <ItemBox
              className={`cardAva`}
