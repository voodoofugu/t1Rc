...
export const cssFiles = ["screen-superhero", "notifications"];

const starBonusArr = ["", "upgrade", "congra", "congra end"];
function RlevelBox({ addClass }) {
  return (
    <div className={`rlevel-box ${addClass}`}>
...
export default function V2MainScreen19SuperheroesLounge({ pageName }) {
  const [starBonus, setStarBonus] = useState(starBonusArr[0]);
  const starBonusChange = () => {
    const currentIndex = starBonusArr.indexOf(starBonus);
    const nextIndex = (currentIndex + 1) % starBonusArr.length;
    setStarBonus(starBonusArr[nextIndex]);
  };
  ...
  return (
    <div className="main lang-ru world1">
      <div
        className="main-bg"
        style={{
          backgroundImage: "url('../img/images/back/new/04-Town-Square-2.jpg')",
        }}
      ></div>
            ...
            >
              ...
              <div className="content-box-all">
                    ...
                    <div className="filter-box">
                      <div className="btn-stars-wrap">
                        ...
                        <div className="color-btn">
                          <div className="color-btn-text">
                            <img
                              src="img/evPopArts/heroStar7.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                    ...
                    <div className="suphero-all-box">
                      ...
                      <li className="suphero-card">
                        <div className="hero-pic-box">
                          ...
                          <div className="herostar-box">
                            <div className="herostar lvl012"></div>
                          </div>
                        </div>
                        <div className="sh2-icon">
                          <img src="img/cur-c.png" loading="lazy" />
                  ...
                  <div className="suphero-right-box">
                    ...
                    <div className="rstar-box">
                      ...
                      <div className="bonus-lvl-box">
                        ...
                        <div className="bonus-lvl-box-name">71 lvl</div>
                      ...
                      <div className="bonus-lvl-box heroStar">
                        <div className="lvlbox-name">Supernova</div>
                        <div className="bonus-lvl-box-name">71 lvl</div>
                        <div className="bonus-lvl-box-bonus-box">
                          <div className="bonus-lvl-box-bonus">
                            <div className="bonus-lvl-box-bonus">
                      ...
                      <div className="rbottom-box">
                        <div className="all-btn-box">
                          ...
                          <div className="lvlup-btn heroStar">
                            <div className="essence-text-box">
                              <div className="essence-icon"></div>
                              <div className="essence-text">256</div>
                            </div>
                ...
                <div className="trophy-res-box-all">
                  ...
                  <div className="trophy-res-box blackPotion">
                    <div className="trophy-value">1000</div>
                    <div className="trophy-value-btn-add"></div>
                  </div>
                </div>
      ...
      <div
        ...
        onClick={starBonusChange}
        style={{ position: "absolute", right: "0px", marginTop: "20px" }}
      >
        <div className="color-btn-text">starBonus</div>
      </div>
    </div>
  );
}
