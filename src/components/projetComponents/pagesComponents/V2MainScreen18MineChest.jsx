...
export const cssFiles = ["v2-screen-mine-event-chest", "screen-info-pop"];

export default function V2MainScreen18MineChest({ pageName }) {
          ...
          <div className="mine-event-screen-head">
            ...
            <div className="color-btn duhbuy duhbuy2">
              <div className="color-btn-icon">
                <img src="img/evPopArts/angel_spirit.png" loading="lazy" />
              </div>
