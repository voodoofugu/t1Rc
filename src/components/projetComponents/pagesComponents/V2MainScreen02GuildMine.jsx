...
export const cssFiles = ["v2-screen-mine"];

export default function V2MainScreen02GuildMine() {
  return (
              ...
              <div className="leftside-box-all">
                ...
                <div className="guildhall-lvlup-box">
                  <div className="guildhall-lvlup-count-box">
                    <div className="guildhall-lvlup-count">18</div>
                  </div>
                  <div className="guildhall-lvlup-count-box two">
                    <div className="guildhall-lvlup-count">520</div>
                  </div>
                ...
                <div className="guildhall-nownext-box">
                  ...
                  <div className="guildhall-nownext-count">28 / 3m 45s</div>
                </div>
                ...
                <div className="guildhall-nownext-box next">
                  ...
                  <div className="guildhall-nownext-count">34 / 3m 45s</div>
                </div>
              </div>
              <div className="mine-rightside-box-all">
                <div className="mine-prg-box-all">
                  <div className="mine-prgbar-all">
                    <div className="mine-prgbar" style={{ width: "0%" }}></div>
                    <div className="mine-prgbar-text">Warehouse is full!</div>
                  </div>
                  <div className="mine-res-box">
                    <div className="mine-value">22.7M</div>
                  </div>
                </div>
                  ...
                  <div className="mine-worker-box">
                    ...
                    <div className="color-btn mithril">
                      <div className="color-btn-text">
                        <div>
                          buy
                          <span className="f-mithril">1000</span>
                        </div>
                      </div>
                    </div>
                    <div className="mine-res-timer-box">
                      <div className="mine-res-timer-name">resource timer</div>
                      <div className="mine-res-timer">-12.5%</div>
                    </div>
                  </div>
                  <div className="mine-worker-box">
                    ...
                    <div className="color-btn mithril">
                      <div className="color-btn-text">
                        <div>
                          buy
                          <span className="f-mithril">5000</span>
                        </div>
                      </div>
                    </div>
                    <div className="mine-res-timer-box">
                  ...
                  <div className="mine-worker-box buy">
                    ...
                    <div className="color-btn diamond">
                      <div className="color-btn-text">
                        <div>
                          buy
                          <span className="f-diamond">100</span>
                        </div>
                      </div>
                    </div>
                    <div className="mine-res-timer-box">
                  ...
                  <div className="mine-worker-box buy">
                    ...
                    >
                      <div className="color-btn-text">
                        <div>
                          buy
                          <span className="f-diamond">500</span>
                        </div>
                      </div>
                    </div>
                    <div className="mine-res-timer-box">
