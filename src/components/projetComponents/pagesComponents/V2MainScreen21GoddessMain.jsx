          ...
          <div className="tab-panel-box goddess-room">
            ...
            <div className="gd-box-goddess">
              ...
              <div className="gd-box-goddess-name-box">
                <div className="gd-box-goddess-name">Muse</div>
                <div className="gd-box-goddess-lvl">Level 615</div>
              </div>
              <div className="gd-box-goddess-bottom-box tall">
                ...
                <div className="gd-prgbar-box">
                  ...
                  <div className="gd-prgbar-text">327/350</div>
                </div>
                <div className="gd-star-box lvl01"></div>
              </div>
            </div>
            <div className="gd-right-box-all">
              <div className="gd-attr-box-all" style={{ top: "10px" }}>
                <div className="gd-attr-box" style={{}}>
                  <div className="gd-attr-girl-box disabled">
                    <div className="hero-avatar-box">
                      <img
                        className="hero-avatar"
                      ...
                      <div className="gd-hero-name">Mi Hyo</div>
                    </div>
                    <div className="gd-lvl-pds-box-all">
                      <div className="hero-level-box">
                        buff lvl
                        <div className="hero-level">100</div>
                      </div>
                      <div className="hero-dps-box">
                        dps
                        <div className="hero-dps">3.51OD29</div>
                      </div>
                      <div className="hero-dps-box cw">
                        CW
                        <div className="hero-dps">0.3%</div>
                      </div>
                    ...
                    <div className="color-btn green disabled0">
                      <div className="color-btn-text">
                        ...
                        <div className="color-btn-text1">buff up</div>
                      </div>
                    </div>
                    <div className="color-btn green cw">
                      <div className="color-btn-text">
                        ...
                        <div className="color-btn-text1">percent up</div>
                      </div>
                    </div>
                    <div className="color-btn green pos">
                      <div className="color-btn-text">
                        ...
                        <div className="color-btn-text1">position up</div>
                      </div>
                    </div>
                  ...
                  <div className="gd-attr-girl-box">
                    <div className="hero-avatar-box">
                      ...
                      <div className="gd-hero-name">Rika Mahojo</div>
                    </div>
                    <div className="gd-lvl-pds-box-all">
                      <div className="hero-level-box">
                        buff lvl
                      ...
                      <div className="hero-dps-box">
                        dps
                        <div className="hero-dps">948OD29</div>
                      </div>
                      <div className="hero-dps-box cw">
                        CW
                        <div className="hero-dps">0.3%</div>
                  ...
                  <div className="gd-attr-girl-box">
                    <div className="hero-avatar-box">
                      ...
                      <div className="gd-hero-name">Sango Yudoku</div>
                    </div>
                    <div className="gd-lvl-pds-box-all">
                      <div className="hero-level-box">
                        buff lvl
                      ...
                      <div className="hero-dps-box">
                        dps
                        <div className="hero-dps">42.1DD29</div>
                      </div>
                      <div className="hero-dps-box cw">
                        CW
                        <div className="hero-dps">0.3%</div>
                  ...
                  <div className="gd-attr-girl-box">
                    <div className="hero-avatar-box">
                      ...
                      <div className="gd-hero-name">Takaro Kaminoken</div>
                    </div>
                    <div className="gd-lvl-pds-box-all">
                      <div className="hero-level-box">
                        buff lvl
                      ...
                      <div className="hero-dps-box">
                        dps
                        <div className="hero-dps">3.21KD30</div>
                      </div>
                      <div className="hero-dps-box cw">
                        CW
                        <div className="hero-dps">0.3%</div>
                  ...
                  <div className="gd-attr-girl-box">
                    <div className="hero-avatar-box">
                      ...
                      <div className="gd-hero-name">Ume Shinpu</div>
                    </div>
                    <div className="gd-lvl-pds-box-all">
                      <div className="hero-level-box">
                        buff lvl
                      ...
                      <div className="hero-dps-box">
                        dps
                        <div className="hero-dps">2.9OD29</div>
                      </div>
                      <div className="hero-dps-box cw">
                        CW
                        <div className="hero-dps">0.3%</div>
                  ...
                  <div className="gd-attr-girl-box">
                    <div className="hero-avatar-box">
                      ...
                      <div className="gd-hero-name">Amaya Karasu</div>
                    </div>
                    <div className="gd-lvl-pds-box-all">
                      <div className="hero-level-box">
                        buff lvl
                      ...
                      <div className="hero-dps-box">
                        dps
                        <div className="hero-dps">15.4DD29</div>
                      </div>
                      <div className="hero-dps-box cw">
                        CW
                        <div className="hero-dps">0.3%</div>
