...
export const cssFiles = ["v2-screen-cw-offer-pop"];

export default function V2MainScreen15CwOfferPop() {
  return (
        ...
        <div className="m-popup cw-offers-pop" style={{ display: "block" }}>
          ...
          <div className="offers-card-box">
            <div className="offers-but-box">
              <img src="img/v2-x2.png" alt="" loading="lazy" />
            </div>
          ...
          <div className="offers-card-box">
            <div className="offers-but-box">
              <img src="img/v2-cw-icon-maps.png" alt="" loading="lazy" />
            </div>
            <div className="offers-text-box">
              <div className="offers-text">
                Clan wars
          ...
          <div className="offers-card-box">
            <div className="offers-but-box">
              <img src="img/v2-cw-icon-maps-both.png" alt="" loading="lazy" />
            </div>
            <div className="offers-text-box">
              <div className="offers-text">
                Both
