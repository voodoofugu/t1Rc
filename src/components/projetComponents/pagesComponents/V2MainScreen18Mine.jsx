  ...
  return (
    <div className="main lang-ru world1">
      <div
        className="main-bg"
        style={{
          backgroundImage: "url('../img/images/back/new/04-Town-Square-1.jpg')",
        }}
      ></div>
      <div className="mine-event-screen">
        ...
        <div className="mine-event-screen__resources">
          ...
          <div className="resource">
            <img src="img/v2-mn-pr2.png" alt="" style={{}} loading="lazy" />
            <div className="resource__count">50</div>
          </div>
          <div className="resource">
            <img src="img/v2-mn-pr3.png" alt="" style={{}} loading="lazy" />
            <div className="resource__count">10</div>
          </div>
          <div className="resource">
            <img src="img/v2-mn-pr4.png" alt="" style={{}} loading="lazy" />
