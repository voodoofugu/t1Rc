...
export const cssFiles = ["v2-screen-cw-guildmanage-p"];

export default function V2MainScreen15CwGuildmanagePPop() {
  return (
          ...
          <div className="cw-clan-manage-p-box-all">
            ...
            <div className="cw-clan-manage-p-btn-box">
              <div className="color-btn">
                <div className="color-btn-text">appoint officials</div>
              </div>
              <div className="color-btn">
                <div className="color-btn-text">appoint leader</div>
              </div>
              <div className="color-btn">
                <div className="color-btn-text">kick off</div>
              </div>
            </div>
          </div>
