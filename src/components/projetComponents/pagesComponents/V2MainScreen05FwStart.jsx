...
export const cssFiles = ["v2-screen-fw-main"];

export default function V2MainScreen05FwStart() {
  return (
                ...
                <div>
                  ...
                  <div className="fw-info-box">
                    ...
                    <div className="fw-fraction-rules-text">
                      ...
                      <div>
                        2. Each war begins with starting points at the center of
                        the map.
                      </div>
                      <div>
                      ...
                      <div>
                        4. You can take part in the war, exposing your troops to
                        attack or defend the cells of the field.
                      </div>
                      <div>
                      ...
                      <div>
                        7. Participate in the Faption War, seize the land, earn
                        contribution points and take a worthy place at the top!
                      </div>
                    </div>
                  </div>
                </div>
