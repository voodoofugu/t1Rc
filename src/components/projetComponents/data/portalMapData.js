...
const mapsData = {
  ...
  2: [
    { name: "exit to the tower", visited: false },
    { name: "cursed castle", visited: false },
    { name: "watch tower", visited: false },
    { name: "suspicious steppe", visited: false },
    { name: "great tree", visited: false },
