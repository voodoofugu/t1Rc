...
const V2MainScreen01DarkWorldComponent = () => {
    ...
    useEffect(() => {
        if (pageContainer && !pageContainer.classList.contains("noScripts")) {
            ...
            const aN = document.querySelector(
            ...
            const bW = document.querySelector(".m-popup.busters.watch");
            const bC = document.querySelector(".m-popup.busters.dark-coins");
            const bD = document.querySelector(".m-popup.busters.dps");
            ...
            const bWb = document.querySelector(".buster-btn.buster-time");
            bWb.addEventListener("click", () => {
                re.style.display = "block";
                setTimeout(function () {
            ...
            const bCb = document.querySelector(".buster-btn.buster-dark");
            ...
            const bDb = document.querySelector(".buster-btn.buster-dps");
            ...
            const aGb = document.querySelector(
                ".resource-dark_gold .resource-btn-add"
            );
            ...
            const taW = document.querySelector(".tabs-all.w-house");
            const taQ = document.querySelector(".tabs-all.squests");

            const conH = document.querySelector(".heroes-list-all-box");
            const conW = document.querySelector(".angels-all-box");
            const conS = document.querySelector(".skills-all-box");
            const conQ = document.querySelector(".journal-story");
    ...
    return (
        ...
        <div className="main world3">
            ...
            <div className="right-side">
                <div className="darkOil-progress-bar-wrap">
                ...
                <div className="world-portal world1">
                    <img src="img/portal-world1.png" loading="lazy" />
                    <div className="title">Earthworld</div>
                </div>
                <div className="buster-box">
                    <div className="buster-btn buster-time">
                        <div className="buster-icn"></div>
                    </div>
                    <div className="buster-btn buster-dark x2 active">
                        <div className="buster-icn"></div>
                        <div className="timerbox">
                            <div className="timer">4:32:33</div>
                        </div>
                    </div>
                    <div className="buster-btn buster-dps x4">
                        <div className="buster-icn"></div>
                    </div>
                </div>
            ...
            <div id="popupAll" className="popup-hiden">
                <div id="popupWrapper" className="popup-layer">
                    ...
                    <div id="popupContainer" className="popup-in">
                        ...
                        <div className="m-popup sign-in pop-reg">
                            ...
                            <div className="content sign-up2">
                                <div className="text-1">
                                    На ваш почтовый адрес было отправлено письмо
                                    с кодом подтверждения. Пожалуйста, введите
                                    его тут
                                </div>
                        ...
                        <div className="m-popup angels-supheros-notadded">
                            ...
                            <div className="content">
                                <div className="header-box">
                                    <div className="header-text-wrap">
                                        <div className="header-text">
                                            Click to attach Your first Superhero
                                            to the Angel!
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="m-popup angels-supheros-add">
                            ...
                            <div className="content">
                                ...
                                <div className="header-box">
                                    <div className="header-text-wrap">
                                        <div className="header-text">
                                            Choose from the list and attach to
                                            the Angel
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="m-popup busters watch">
                        ...
                        <div className="m-popup busters dark-coins">
                            <div className="title">Нужен Бонус Сейчас?</div>
                            <div className="content">
                                <div className="buster-imgs-box">
                                    <div className="buster-stand"></div>
                        ...
                        <div className="m-popup busters dps">
                            <div className="title">Нужен Бонус Сейчас?</div>
                            <div className="content">
                                <div className="buster-imgs-box">
                                    <div className="buster-stand"></div>
                                    <div className="buster-icn"></div>
                                    <div className="buster-value">x4</div>
                                </div>
                                <div className="title">
                                    Получи
                                    <div className="dps-value">DPS x4</div>
                                </div>
                                <div className="text-description">
                                    Описание оффера, текст про оффер
                                </div>
                            ...
                            <div className="content">
                                <div className="text-box">
                                    <div className="text">
                                        ...
                                        <br />
                                        <li>
                                            You can get Angel and her Stars by
                                            collecting Angel Soul Pieces from
                                            Angel Chests in the Dark Angel
                                            Garden. You will need Angel Spirit
                                            to open chests. Angel Spirit can be
                                            collected from various events in the
                                            game and at the Spirit Shop. The
                                            buff multiplier increases
                                            significantly when Angels gain new
                                            stars.
                                        </li>
                                        <br />
                                        <li>
                                            Each Angel has six Heroines attached
                                            to her. You can add more heroines to
                                            each Angel. You can buff each
                                            Heroine. Also, Superheroines can be
                                            attached to each Angel. Combine them
                                            in such a way as to get the most
                                            power.
                                        </li>
                                        <br />
                                        <li>
                                            You will need Angel Essence to buff
                                            Dark DPS. Angel Essence can be
                                            collected from Events and Angel
                                            Chests.
                                        </li>
                                        <br />
                                        <li>
                                            Each buff increases Angel's level
                                            required to unlock Angel's Erotic
                                            Album.
                                        </li>
                                    </div>
                                </div>
                        ...
                        <div className="m-popup add-resources-popup">
                            <div className="title">Купите еще Dark-Gold!</div>
                            <div className="res dark_gold">
                                <div className="item">
                                    <div className="icon dark_gold time">
                                        ...
                                        <div className="gold">
                                            <img
                                                src="img/ic-abil-gold.png"
                                                loading="lazy"
                                            />
                                        </div>
                                        <div className="shards">
                                            <img
                                                src="img/ic-abil-butil.png"
                                                loading="lazy"
                                            />
                                        </div>
                                        <div className="gems">
                                            <img
                                                src="img/ic-abil-rubin.png"
                                                loading="lazy"
                                            />
                                        </div>
                                        <div className="gold-shards">
                                            <img
                                                src="img/ic-abil-gold-but.png"
                                                loading="lazy"
                                            />
                                        </div>
                                        <div className="ice_gold">
                                            <img
                                                src="img/ic-ice_gold.png"
                                                loading="lazy"
                                            />
                                        </div>
                                        <div className="dark_gold">
                                            <img
                                                src="img/v2-res-dark.png"
                                                loading="lazy"
                                            />
                                        </div>
                                    ...
                                    <div className="desc-box with-reward">
                                        ...
                                        <div className="desc-price">
                                            <span>
                                                <span className="price dark_gold glow">
                                                    2.02qD13
                                                </span>
                                            </span>
                                        </div>
                                        <div className="decs-text">
                                            You instantly get Gold, as if you
                                            played for 1h.
                                        </div>
                                    </div>
