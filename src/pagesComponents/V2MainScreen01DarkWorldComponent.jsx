      ...
      <div className="quest-box-all">
        <div className="quest-box-scroll">
          <div className="quest-box">
            ...
            >
              <img className="icon" src="img/ic-hero-211.png" loading="lazy" />
              <div className="timerbox">
            ...
            >
              <img className="icon" src="img/v2-ico-gold.png" loading="lazy" />
              <div className="timerbox">
                <div className="timer">23:36:10</div>
              </div>
            </li>
            <li className="quest open" style={{ animationDelay: "750ms" }}>
              <img className="icon" src="img/v2-ico-quest.png" loading="lazy" />
            </li>
          </div>
        </div>
