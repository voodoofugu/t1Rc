...
const V2MainScreen14NsaleStupenPopComponent = () => {
    return (
        <>
            <div className="main world1">
                ...
                <div className="popup-layer" style={{ display: "block" }}>
                    ...
                    <div
                        className="mn-popup nsale-stupen pop"
                        style={{ display: "block" }}>
                        ...
                        <div className="nm-pop-content">
                            ...
                            <div className="np-pop-stupen-pop-m-box-all">
                                <div className="np-pop-stupen-pop-m-pic"></div>
                                <div className="np-pop-stupen-pop-m-count">
                                    5454.5
                                </div>
                            </div>
                            ...
                            <div className="np-pop-stupen-pop-rew-box-all">
                                <div className="np-pop-stupen-pop-rew-box">
                                    ...
                                    <div className="np-pop-stupen-pop-rew-box-limit">
                                        limit: 99
                                    </div>
                                    <div className="color-btn">
                                        <div className="color-btn-text">
                                            buy<span className="f-ball"></span>
                                            6969K
                                        </div>
                                    </div>
                                </div>
...
export default React.memo(V2MainScreen14NsaleStupenPopComponent);
