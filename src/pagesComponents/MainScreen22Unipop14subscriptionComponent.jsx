          ...
          <div className="left-panel">
            <div className="heroes-list">
              <div className="dps-dpc-panel">
                <div className="dpc">
                  ...
                  <div className="mlt-prm">x3212</div>
                  <div className="title">
                    DPC<div className="icon-dpc"></div>
                  </div>
                </div>
                <div className="dps">
                  ...
                  <div className="mlt-prm">x3212</div>
                  <div className="title">
                    DPS<div className="icon-dps"></div>
                  </div>
                </div>
              ...
              <ul className="all-heroes">
                <ul className="my-heroes">
                  <li className="hero-card disabled">
                    <div className="avatar">
                      <img className="ava" src="img/ava1.png" loading="lazy" />
                    </div>
                    <div className="dps">234234 K</div>
                    <div className="name">JOHN DOEHOVARIUS</div>
                    <div className="lvl">
                      <div className="n">300</div>
                    </div>
                    <div className="btn-buy disabled">
                      <div className="price gold">234234</div>
                      <div className="txt">BUY</div>
                    </div>
                  </li>
                  <li className="hero-card disabled">
                    <div className="avatar">
                      <img className="ava" src="img/ava2.jpg" loading="lazy" />
                    </div>
                  ...
                  <li className="hero-card">
                    <div className="avatar">
                      <img className="ava" src="img/ava3.jpg" loading="lazy" />
                    </div>
                    <div className="abil-ready"></div>
                    ...
                    <div className="btn-buy">
                      <div className="price gold">23423</div>
                      <div className="txt">BUY</div>
                    </div>
                  </li>
                  <li className="hero-card">
                    <div className="avatar">
                      <img className="ava" src="img/ava4.jpg" loading="lazy" />
                    </div>
                    <div className="abil-ready"></div>
                ...
                <ul className="new-heroes">
                  <li className="hero-card">
                    ...
                    <div className="name">JOHN DOEHOVARIUSDSFASDFAS</div>
                    <div className="btn-buy">
                      <div className="price gold">234234</div>
                    </div>
                  </li>
            ...
            <div className="loc-list">
              ...
              <div className="loc-back">
                <img className="icon" src="img/ico-loc.png" loading="lazy" />
            ...
            <div className="unipop-box-content-all">
              ...
              <div className="unipop-box-right-box">
                <div className="right-box-f">
                  <div className="right-box-f-name-box">subscription</div>
                  <div className="sub-box-all">
                    <div className="sub-box">
                      <div className="sub-box-name-box">
                        <div className="sub-box-name-text">
                          mountly subscription <br />
                          card
                          <br />
                        </div>
                      </div>
                      <div className="sub-purhase-box">
                        <div className="sub-purhase-text">first purchase</div>
                        <div className="sub-purhase">
                          <div className="sub-purhase-pic"></div>
                          <div className="sub-purhase-num">6868</div>
                        </div>
                      ...
                      <div className="sub-purhase-box daily">
                        <div className="sub-purhase-text">daily rewards</div>
                        <div className="sub-purhase">
                          <div className="sub-purhase-pic"></div>
                          <div className="sub-purhase-num">6868</div>
                        </div>
                      ...
                      <div className="sub-purhase-box total">
                        <div className="sub-purhase-text">total rewards</div>
                        <div className="sub-purhase">
                          <div className="sub-purhase-pic"></div>
                          <div className="sub-purhase-num">6868</div>
                        </div>
                    ...
                    <div className="sub-box gold">
                      <div className="sub-box-name-box">
                        <div className="sub-box-name-text">
                          deluxe mountly subscription card
                        </div>
                      </div>
                      <div className="sub-purhase-box">
                        <div className="sub-purhase-text">first purchase</div>
