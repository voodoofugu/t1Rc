                ...
                <div className="popup-layer" style="display: block">
                    ...
                    <div className="m-popup guildboss1" style="display: block">
                        ...
                        <div className="cw-guildboss-box-left">
                            ...
                            <div className="cw-guildboss-d-progress-box">
                                <div
                                    ...
                                    style="width: 65%"></div>
                                <div className="cw-guildboss-d-progress-prg-text">
                                    65%
                                </div>
                            </div>
                            <div className="cw-guildboss-d-timer-box">
                                <div className="cw-guildboss-d-timer">
                                    05:35:15
                                </div>
                            </div>
                        ...
                        <div className="cw-guildboss-box-right">
                            <div className="cw-guildboss-box-right-name">
                                damage ranking
                            </div>
