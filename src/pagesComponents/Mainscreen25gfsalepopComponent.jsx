...
import gfSalePop from "../styles/gf-sale-pop.scss";
          ...
          <div className="left-panel">
                ...
                <ul className="my-heroes">
                  <li className="hero-card disabled">
                    <div className="avatar">
                      <img className="ava" src="img/ava1.png" />
                    </div>
                  ...
                  <li className="hero-card disabled">
                    <div className="avatar">
                      <img className="ava" src="img/ava2.jpg" />
                    </div>
                  ...
                  <li className="hero-card">
                    <div className="avatar">
                      <img className="ava" src="img/ava3.jpg" />
                    </div>
                    <div className="abil-ready"></div>
                  ...
                  <li className="hero-card">
                    <div className="avatar">
                      <img className="ava" src="img/ava4.jpg" />
                    </div>
                    <div className="abil-ready"></div>
            ...
            <div className="skills">
              <ul className="skill-list">
                <li className="skill">
                  <img className="icon" src="img/skill-ico1.png" />
                </li>
                <li className="skill">
