...
const RegCont = styled.div`
  /* Применяем стили из пропсов */
  width: ${(props) => props.width || "1200px"};
  height: ${(props) => props.height || "640px"};
  background-color: ${(props) => props.backgroundColor || "#9f8978"};
  ...
  div.main {
    ...
    background-position: -14px -14px, 537px -14px, -14px 336px, 537px 336px,
      0px 280px, center, center;
    background-repeat: no-repeat;
    background-size: 28px, 28px, 28px, 28px, 100% 20%, 100%, 100%;
    box-shadow: 0 0 0 3px #dd9542, 0 2px 6px 4px rgba(0, 0, 0, 0.3),
      inset 0 0 4px 1px rgba(0, 0, 0, 0.2), 0 0 0 4px rgba(0, 0, 0, 0.2);
    animation: appearance 0.2s cubic-bezier(0.455, 0.03, 0.515, 0.955) both
      0.28s;
  }
  div.main:before,
  div.main:after {
    ...
    width: 90%;
    height: 5px;
    background: radial-gradient(#ffa 0%, #ffa 10%, rgba(255, 255, 170, 0) 70%);
    position: absolute;
    left: 50%;
  ...
  div.info {
    ...
    color: #ffa;
    line-height: 30px;
    text-shadow: 0 2px 1px rgba(0, 0, 0, 0.6), 0 0 10px rgba(0, 0, 0, 0.6),
  ...
  .info .btn-ok {
    ...
    box-shadow: inset 0 -20px 5px rgba(200, 119, 37, 0.59),
      ...
      inset 0 0 3px rgba(0, 0, 0, 0.2), 0 0 1px 1px rgba(0, 0, 0, 0.2);
  ...
  .info .btn-ok:hover {
    ...
    box-shadow: inset 0 -20px 5px rgba(200, 119, 37, 0.59),
      ...
      inset 0 0 3px rgba(0, 0, 0, 0.2), 0 0 1px 1px rgba(0, 0, 0, 0.5);
  }
  .info .btn-ok:active {
    line-height: 44px;
  ...
  .info .btn-ok:after {
    ...
    pointer-events: none;
    filter: brightness(0.1) drop-shadow(0 1px 1px rgba(255, 255, 255, 0.2))
