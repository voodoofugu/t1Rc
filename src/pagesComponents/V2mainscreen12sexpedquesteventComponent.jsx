...
const V2MainScreen12SexpedQuesteventComponent = () => {
    return (
        <>
            <div className="main world1">
                ...
                <div className="popup-layer" style="display: block">
                    ...
                    <div
                        className="m-popup sexped-questevent"
                        style="display: block">
                        <div className="title">Sexpedition - quest event</div>
                        <div className="color-box"></div>
                        <div className="xmas-daily-prg-box-all">
                            <div className="xmas-prg-girl"></div>
                            <div className="xmas-prg-bar-box">
                                <div className="xmas-prg-name-pic"></div>
                                <div className="xmas-prg-bar">
                                    <div className="xmas-prg"></div>
                                </div>
                            </div>
                            <div className="xmas-reward-chest-box">
                            ...
                            <div className="xmas-reward-chest-box v2 collect">
                                <div className="xmas-prg-bar-num-line">
                                    <div className="xmas-prg-bar-num">70</div>
                                </div>
                                <div className="xmas-level-rew-pic">
                                    <img src="rc/v2-xmas-chest-purple.png" />
                                </div>
                                <div className="xmas-level-rew-num-check"></div>
                                <div className="color-btn green">
                                    <div className="color-btn-text">
                            ...
                            <div className="xmas-reward-chest-box v3 check">
                                <div className="xmas-prg-bar-num-line">
                        ...
                        <div className="xmas-daily-box-all">
                            ...
                            <div className="xmas-daily-box right">
                                <div className="daily-parth-box">
                                    <div className="daily-parth-text">
                                        Пройди 10000 этажей в башне
                                    </div>
...
export default React.memo(V2MainScreen12SexpedQuesteventComponent);
