                            ...
                            <div className="unipop-box-left-box">
                                <div className="unipop-scroll-box">
                                    ...
                                    <div className="unipop-box">
                                        ...
                                        <div className="unipop-timer top">
                                            27:52:32
                                        </div>
                                    </div>
                                    <div className="unipop-box">
                                ...
                                <div className="right-box-f sv">
                                    ...
                                    <div className="event-btlpass-collect-box-all">
                                        <div className="event-btlpass-collect-box-text">
                                            Dear players! We wish you Merry
                                            Christmas and Happy Holidays. Don't
                                            miss out on our Winter Wonder deals:
                                            these hot girls can't wait to warm
                                            you up during cold winter days!
                                        </div>
