    ...
    return (
        <>
            <div className="main rpg-poly world1">
                ...
                <div className="rpg_poly-bottom-bar">
                                ...
                                <div
                                    ...
                                    <div className="popup-wrap">
                                        <div className="bar_quest">
                                            Finish 10 levels
                                            <div className="bar_quest-chip_value">
                                                2
                                            </div>
                                        </div>
                                        <div className="bar_quest">
                    ...
                    <div className="dice-wrap">
                        <div className="dice-white">
                            <div className="dice-white-value dice-value">
                                1/0
                            </div>
                            <div className="dice-white-button dice-button">
                                roll dice
                            </div>
                        </div>
                        <div className="dice-gold">
                            <div className="dice-gold-value dice-value">
                                1/0
                            </div>
                            <div className="dice-gold-button dice-button">
                                roll dice
                            </div>
                        </div>
                    </div>
                ...
                <div className="rpg_poly-top-bar">
                    <div className="parameters-wrap">
                        ...
                        <div className="currency-parameter parameters">
                            <div className="currency-value parameters-value">
                                999
                            </div>
                        </div>
                        <div className="strength-parameter parameters">
                            <div className="strength-value parameters-value">
                                999
                            </div>
                        </div>
                        <div className="dexterity-parameter parameters">
                            <div className="dexterity-value parameters-value">
                                999
                            </div>
                        </div>
                        <div className="intelligence-parameter parameters">
                            <div className="intelligence-value parameters-value">
                                999
                            </div>
                        </div>
                    </div>
                    <div className="backpack-button rpg_poly-button">
                        backpack
                    </div>
                                    ...
                                    <div className="quest-info-wrap">
                                        <div className="quest-info-text_block">
                                            <div className="quest-info-text">
                                                Локализация: Девушка говорит,
                                                что попала в беду и просит ей
                                                помоч. Ей требуются определённые
                                                предметы, чтобы продолжить
                                                путешествие. Пожалуйста
                                                принесите следующие предметы:
                                            </div>
                                        </div>
                                    </div>
                                    <div className="quest_item-reward-wrap item_activ">
                                        <div className="quest_button-wrap">
                                            <div className="quest_item-button quest_button">
                                                item
                                            </div>
                                        ...
                                        <div className="quest-item-wrap">
                                            <div className="quest-item done">
                                                ...
                                                <div className="quest-item_value">
                                                    10
                                                    <div className="item-needful_value">
                                                        /10
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div
                    className="popupWrapper shop-popup"
                    style={{ display: "none" }}>
                    <div
                        className="screen-blend-55"
                        style={{ display: "block" }}></div>
