                        ...
                        <div className="hero-card-box-all">
                          <div className="hero-card starterpack">
                            ...
                            <div className="hero-dps-box">
                              <div className="st-time">00:00:00</div>
                            </div>
                            <div className="hero-name-box">
                              <div className="hero-name">Black Friday</div>
                            </div>
                          ...
                          <div className="hero-card">
                            ...
                            <div className="hero-level-box">
                              level
                              <div className="hero-level">1</div>
                            </div>
                            <div className="hero-dps-box">
                              dps
                              <div className="hero-dps">1.32KD3</div>
                            </div>
                            <div className="hero-name-box">
                            ...
                            <div className="color-btn green disabled">
                              <div className="color-btn-text">
                                <div className="gold">
                                  <span className="f-gold">743ND3</span>
                                </div>
                                <div className="color-btn-text1">Lvl Up</div>
                              </div>
                            </div>
                          </div>
                          <div className="hero-card">
                            ...
                            <div className="hero-dps-box">
                              dps
                              <div className="hero-dps">1.23s</div>
                            </div>
                            <div className="hero-name-box">
                              <div className="hero-name">Takayama Bunko</div>
                            </div>
                            <div className="color-btn green">
                              <div className="color-btn-text">
                                <div className="gold">
                                  <span className="f-gold">2.15O</span>
                                </div>
                                <div className="color-btn-text1">Lvl Up</div>
                              </div>
                            </div>
                          ...
                          <div className="hero-card">
                            ...
                            <div className="hero-dps-box">
                              dps
                              <div className="hero-dps">2.8s</div>
                            </div>
                            <div className="hero-name-box">
                              <div className="hero-name">Miyasaki Keiko</div>
                            </div>
                            <div className="color-btn green">
                              <div className="color-btn-text">
                                <div className="gold">
                                  <span className="f-gold">1.29O</span>
                                </div>
                                <div className="color-btn-text1">Lvl Up</div>
                              </div>
                            </div>
                          ...
                          <div className="hero-card">
                            ...
                            <div className="hero-dps-box">
                              dps
                              <div className="hero-dps">950Q</div>
                            </div>
                            <div className="hero-name-box">
                              <div className="hero-name">Konya Suzume</div>
                            </div>
                            <div className="color-btn green">
                              <div className="color-btn-text">
                                <div className="gold">
                                  <span className="f-gold">861S</span>
                                </div>
                                <div className="color-btn-text1">Lvl Up</div>
                              </div>
                            </div>
                          ...
                          <div className="hero-card">
                            ...
                            <div className="hero-dps-box">
                              dps
                              <div className="hero-dps">245Q</div>
                            </div>
                            <div className="hero-name-box">
                              <div className="hero-name">Teruya Fumiko</div>
                            </div>
                            <div className="color-btn green">
                              <div className="color-btn-text">
                                <div className="gold">
                                  <span className="f-gold">430S</span>
                                </div>
                                <div className="color-btn-text1">Lvl Up</div>
                              </div>
                            </div>
                          ...
                          <div className="hero-card">
                            ...
                            <div className="hero-dps-box">
                              dps
                              <div className="hero-dps">1.05s</div>
                            </div>
                            <div className="hero-name-box">
                              <div className="hero-name">Enomoto Runa</div>
                            </div>
                            <div className="color-btn green">
                              <div className="color-btn-text">
                                <div className="gold">
                                  <span className="f-gold">895S</span>
                                </div>
                                <div className="color-btn-text1">Lvl Up</div>
                              </div>
                            </div>
                          ...
                          <div className="hero-card">
                            ...
                            <div className="hero-dps-box">
                              dps
                              <div className="hero-dps">741Q</div>
                            </div>
                            <div className="hero-name-box">
                              <div className="hero-name">Ogata Wayoko</div>
                            </div>
                            <div className="color-btn green">
                              <div className="color-btn-text">
                                <div className="gold">
                                  <span className="f-gold">186S</span>
                                </div>
                                <div className="color-btn-text1">Lvl Up</div>
                              </div>
                            </div>
                            ...
                            <div className="rating-scroll">
                              <div>
                                ...
                                <div className="rating-card color2 ">
                                  ...
                                  <div className="name">cthulhujoker</div>
                                  <div className="points">425</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card  ">
                                  <div className="number">2</div>
                                  <div className="name">arys</div>
                                  <div className="points">265</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card color2 ">
                                  <div className="number">3</div>
                                  <div className="name">Ninjagaiden</div>
                              ...
                              <div>
                                ...
                                <div className="rating-card  ">
                                  ...
                                  <div className="name">galaser</div>
                                  <div className="points">174</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card color2 ">
                                  <div className="number">5</div>
                                  <div className="name">Galdard</div>
                                  <div className="points">145</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card  ">
                                  <div className="number">6</div>
                                  <div className="name">0verl0rd99</div>
                                  <div className="points">136</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card color2 ">
                                  <div className="number">7</div>
                                  <div className="name">andrei1991c</div>
                              ...
                              <div>
                                <div className="rating-card  ">
                                  ...
                                  <div className="name">Paddy7766</div>
                                  <div className="points">117</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card color2 ">
                                  <div className="number">9</div>
                                  <div className="name">Alex007ander</div>
                                  <div className="points">105</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card  ">
                                  <div className="number">10</div>
                                  <div className="name">TheMaleRei</div>
                              ...
                              <div>
                                <div className="rating-card color2 ">
                                  ...
                                  <div className="name">WaTdaFuq</div>
                                  <div className="points">75</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card  ">
                                  <div className="number">12</div>
                                  <div className="name">Dragah</div>
                                  <div className="points">65</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card color2 ">
                                  <div className="number">13</div>
                                  <div className="name">Andrew85994</div>
                                  <div className="points">65</div>
                                </div>
                              </div>
                              <div>
                              ...
                              <div>
                                <div className="rating-card color2 ">
                                  ...
                                  <div className="name">guest198808738</div>
                                  <div className="points">55</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card  ">
                                  <div className="number">16</div>
                                  <div className="name">ericq</div>
                              ...
                              <div>
                                <div className="rating-card color2 ">
                                  ...
                                  <div className="name">guest234399384</div>
                              ...
                              <div>
                                <div className="rating-card  ">
                                  ...
                                  <div className="name">WildIce</div>
                              ...
                              <div>
                                <div className="rating-card color2 ">
                                  ...
                                  <div className="name">tadetiany</div>
                                  <div className="points">35</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card  ">
                                  ...
                                  <div className="name">nananafufufu</div>
                              ...
                              <div>
                                <div className="rating-card color2 ">
                                  ...
                                  <div className="name">guest244499668</div>
                              ...
                              <div>
                                <div className="rating-card  ">
                                  ...
                                  <div className="name">lexx🍀777</div>
                                  <div className="points">30</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card color2 ">
                                  ...
                                  <div className="name">FrankZ98</div>
                                  <div className="points">28</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card  ">
                                  <div className="number">26</div>
                                  <div className="name">Eggieman</div>
                                  <div className="points">27</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card color2 ">
                                  <div className="number">27</div>
                                  <div className="name">guest243912461</div>
                              ...
                              <div>
                                <div className="rating-card  ">
                                  ...
                                  <div className="name">guest245147322</div>
                              ...
                              <div>
                                <div className="rating-card color2 ">
                                  ...
                                  <div className="name">cheche63</div>
                                  <div className="points">23</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card  ">
                                  ...
                                  <div className="name">Crowshou</div>
                              ...
                              <div>
                                <div className="rating-card color2 ">
                                  ...
                                  <div className="name">Anatolijj</div>
                                  <div className="points">20</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card  ">
                                  ...
                                  <div className="name">astonvip</div>
                                  <div className="points">20</div>
                                </div>
                              </div>
                              <div>
                              ...
                              <div>
                                <div className="rating-card color2 ">
                                  ...
                                  <div className="name">DaHeLLGoD</div>
                                  <div className="points">15</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card  ">
                                  ...
                                  <div className="name">Reaktor35</div>
                                  <div className="points">15</div>
                                </div>
                              </div>
                              <div>
                              ...
                              <div>
                                <div className="rating-card  ">
                                  ...
                                  <div className="name">Pupok clan RUS</div>
                                  <div className="points">15</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card color2 ">
                                  ...
                                  <div className="name">Monark273</div>
                              ...
                              <div>
                                <div className="rating-card color2 ">
                                  ...
                                  <div className="name">8286283ud8i</div>
                              ...
                              <div>
                                <div className="rating-card  ">
                                  ...
                                  <div className="name">SIVA8823</div>
                                  <div className="points">10</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card color2 ">
                                  ...
                                  <div className="name">NuclearSpam</div>
                                  <div className="points">10</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card  ">
                                  ...
                                  <div className="name">guest240205771</div>
                                  <div className="points">10</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card color2 ">
                                  ...
                                  <div className="name">thefinalfate4</div>
                                  <div className="points">10</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card  ">
                                  ...
                                  <div className="name">Virginator</div>
                                  <div className="points">10</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card color2 ">
                                  ...
                                  <div className="name">gaogaigarneo</div>
                                  <div className="points">10</div>
                                </div>
                              </div>
                              <div>
                              ...
                              <div>
                                <div className="rating-card color2 ">
                                  ...
                                  <div className="name">ZerOx4C</div>
                                  <div className="points">10</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card  ">
                                  ...
                                  <div className="name">Vitaseg</div>
                                  <div className="points">10</div>
                                </div>
                              </div>
                              <div>
                                ...
                                <div className="rating-card color2 ">
                                  ...
                                  <div className="name">Leopard627</div>
                                  <div className="points">10</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card  ">
                                  ...
                                  <div className="name">godpussy</div>
                                  <div className="points">10</div>
                                </div>
                              </div>
                              <div>
                              ...
                              <div>
                                <div className="rating-card  ">
                                  ...
                                  <div className="name">nora_cat</div>
                                  <div className="points">7</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card color2 ">
                                  ...
                                  <div className="name">Frutitos</div>
                              ...
                              <div>
                                <div className="rating-card  ">
                                  ...
                                  <div className="name">guest245059840</div>
                              ...
                              <div>
                                <div className="rating-card color2 ">
                                  ...
                                  <div className="name">Nightrythums</div>
                                  <div className="points">5</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card  ">
                                  ...
                                  <div className="name">torrent</div>
                                  <div className="points">5</div>
                                </div>
                              </div>
                              <div>
                                <div className="rating-card color2 ">
                                  ...
                                  <div className="name">guest244987472</div>
                              ...
                              <div>
                                <div className="rating-card  ">
                                  ...
                                  <div className="name">jojohron</div>
                                  <div className="points">3</div>
                                </div>
                              </div>
                            </div>
                      ...
                      <div className="plas-all-box">
                        <div className="plas-all">
                          ...
                          <div className="btn-buy">
                            <div className="price diamonds">1</div>
                      ...
                      <div className="raidboss-animation-box">
                        <div className="raidboss-animation-name-box">
                          <div className="raidboss-animation-name">
                            Get the girl and claim TOP 3 places in rating to get
                            their INTERACTIVE animations
                          </div>
                        </div>
                            ...
                            <div className="raidboss-animation-f-box girl-lock">
                              ...
                              <div className="rb-girl-lock">
                                <div className="rb-girl-lock-text">
                                  Wait for the next tower event to get her
                                </div>
                              </div>
                        ...
                        <div className="tower-relics-box gold">
                          ...
                          <div className="tower-relics-text-box">
                            <div className="tower-relics-text">
                              Lyca's normal attacks and "rapid arrows" ability
                              are able to hit 3 enemies at once
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="map-quest-box-all one">
                    <div className="map-quest-box">
                      ...
                      <div className="map-s shop">
                        <div className="s-pic-s1a">
                          <img src="img/raidboss-map-s3-a.png" loading="lazy" />
                        </div>
                        <div className="s-pic-3pic1">
                          <img
                            src="img/raidboss-map-3tower.png"
                            loading="lazy"
                          />
                        </div>
                        <div className="s-pic-3pic2">
                          <img src="img/raidboss-map-3sun.png" loading="lazy" />
                        </div>
                        <div className="s-pic-s1b">
                          <img src="img/raidboss-map-s3-b.png" loading="lazy" />
                        </div>
                      ...
                      <div className="map-quest-prgbar-all">
                        ...
                        <div className="map-quest-prgbar-text">1/3</div>
                      </div>
                    ...
                    <div className="map-quest-box">
                      ...
                      <div className="map-s pic2">
                        <div className="s-pic-s1a">
                          <img src="img/raidboss-map-s1-a.png" loading="lazy" />
                        </div>
                        <div className="s-pic-3pic1">
                          <img
                            src="img/raidboss-map-3tower.png"
                        ...
                        <div className="s-pic-3pic2">
                          <img src="img/raidboss-map-3leo.png" loading="lazy" />
                        </div>
                        <div className="s-pic-s1b">
                          <img src="img/raidboss-map-s1-b.png" loading="lazy" />
                        </div>
                        <div className="s-shop">
                          <img src="img/ic-abil-rubin.png" loading="lazy" />
                        </div>
                    ...
                    <div className="map-quest-box">
                      ...
                      <div className="map-s pic1">
                        <div className="s-pic-s1a">
                          <img src="img/raidboss-map-s2-a.png" loading="lazy" />
                        </div>
                        <div className="s-pic-3pic1">
                          <img
                            src="img/raidboss-map-3tower.png"
                        ...
                        <div className="s-pic-s1b">
                          <img src="img/raidboss-map-s2-b.png" loading="lazy" />
                        </div>
                        <div className="s-shop">
                          <img src="img/ic-abil-rubin.png" loading="lazy" />
                        </div>
                ...
                <div className="cardreward-box gold collected">
                  <div className="card-box-back">
                    ...
                    <div className="reward-pic">
                      <img
                        src="img/skill-icons/skill-icon01x2.png"
                        loading="lazy"
                      />
                    </div>
                    <div className="tower-relics-text-box">
                      <div className="tower-relics-text">
                        Lyca's normal attacks and "rapid arrows" ability are
                        able to hit 3 enemies at once
                      </div>
                    </div>
