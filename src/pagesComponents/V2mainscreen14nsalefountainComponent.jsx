...
const V2MainScreen14NsaleFountainComponent = () => {
    return (
        <>
            <div className="main world1">
                ...
                <div className="popup-layer" style={{ display: "block" }}>
                    ...
                    <div
                        className="mn-popup nsale-fountain"
                        style={{ display: "block" }}>
                        ...
                        <div className="nm-pop-content">
                            <div className="nm-pop-fon-rew-pop">
                                ...
                                <div className="nm-pop-fon-rew-pop-text">
                                    japanese samurai crests
                                </div>
                            </div>
                            <div className="nm-pop-fon-coin-box">
                                <div className="nm-pop-fon-coin">
                                    <img src="img/v2-ns-coin1.png" />
                                </div>
                                <div className="nm-pop-fon-coin-count">333</div>
                            </div>
                            <div className="nm-pop-fon-coin-box silver">
                                <div className="nm-pop-fon-coin">
                                    <img src="img/v2-ns-coin2.png" />
                                </div>
                                <div className="nm-pop-fon-coin-count">333</div>
                            ...
                            <div className="nm-pop-fon-rew-box-all">
                                ...
                                <div className="nsale-pr-box check">
                                    ...
                                    <div className="nm-pop-fon-rew-box-count">
                                        10
                                    </div>
...
export default React.memo(V2MainScreen14NsaleFountainComponent);
