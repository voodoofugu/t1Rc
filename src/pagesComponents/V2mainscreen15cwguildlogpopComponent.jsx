...
const V2MainScreen15CwGuildlogPopComponent = () => {
    return (
        <>
            <div className="main world1">
                ...
                <div className="popup-layer" style="display: block">
                    ...
                    <div className="m-popup guildlog" style="display: block">
                        <div className="title">guild log</div>
                        <div className="color-box"></div>
                        <div className="cw-clan-log-box-all">
                            <div className="cw-main-right-b-box-scroll">
                                <div className="cw-log-box">
                                    <div className="cw-log-date">06.20</div>
                                    <div className="cw-log-text">
                                        16:20 Lorem ipsum dolor sit amet,
...
export default React.memo(V2MainScreen15CwGuildlogPopComponent);
