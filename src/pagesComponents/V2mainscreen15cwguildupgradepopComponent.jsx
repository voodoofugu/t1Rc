...
const V2MainScreen15CwGuildupgradePopComponent = () => {
    return (
        <>
                ...
                <div className="popup-layer" style={{ display: "block" }}>
                    ...
                    <div
                        ...
                        <div className="cw-clan-order-box-all">
                            ...
                            <div className="cw-clan-upgrade-ab-box-str"></div>
                            ...
                            <div className="cw-clan-order-don-box-all">
                                <div className="cw-clan-order-don-box">
                                    <div className="cw-clan-order-don-text">
                                        donate
                                    </div>
                                    <div className="cw-clan-order-don">
                                        <div className="cw-clan-order-don-num">
                                            64646464K
                                        </div>
                                    </div>
                                </div>
                                <div className="cw-clan-order-don-box gold">
                                    <div className="cw-clan-order-don-text">
                                        your gold
                                    </div>
                                    <div className="cw-clan-order-don">
                                ...
                                <div className="cw-clan-order-btn-don-box">
                                    <div className="color-btn green donate">
                                        <div className="color-btn-text">
                                            donate
                                        </div>
                                    </div>
...
export default React.memo(V2MainScreen15CwGuildupgradePopComponent);
