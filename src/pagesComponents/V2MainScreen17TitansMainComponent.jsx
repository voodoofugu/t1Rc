...
// import v2ScreenTitansMain from "../styles/v2-screen-titans-main.scss";

const V2MainScreen17TitansMainComponent = () => {
  return (
    <>
      <div className="main world1">
        ...
        <div className="left-side">
          <div className="left-panel wide">
            <div className="tab-panel-box at-titans-main">
...
export default React.memo(V2MainScreen17TitansMainComponent);
