...
const V2MainScreen08UkiMainNewComponent = () => {
    return (
        <>
            <div className="main world1 world2 world3">
                        ...
                        <div className="heroes-list-all-box">
                            ...
                            <div className="journal-parth-box-all">
                                <div className="journal-parth-header">
                                    <div className="journal-header-main-info">
                                        Выполняя MAIN квесты собирай истории и
                                        получай награды
                                    </div>
                                    <div className="daily-prgbar-all">
                                        ...
                                        <div className="daily-prgbar-text">
                                            Completed Quests
                                            <div className="daily-prgbar-value">
                                                5/10
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="journal-parth-box">
                                        ...
                                        <div className="journal-parth view">
                                            <div className="journal-parth-wrap">
                                                ...
                                                <div className="text">
                                                    You are tired to fend small
                                                    orders and you decide to
                                                    create your guild. To do
                                                    this, you have to hunt for
...
export default React.memo(V2MainScreen08UkiMainNewComponent);
