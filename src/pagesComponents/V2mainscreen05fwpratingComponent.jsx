                    ...
                    <div className="left-panel wide">
                        <div className="tab-panel-box fw-p-rating">
                            ...
                            <div className="fw-left-side">
                                <div className="fw-left-box-name">
                                    top reward
                                </div>
                                ...
                                <div
                                    ...
                                    <div className="fw-rating-ped-box-all check-p0">
                                        <div className="fw-rating-ped-box-p1 rate1">
                                            <div className="fw-rating-ped-pic">
                                                <div className="">
                                                    <img src="https://cdn.faptitans.com/s1/rc/v2-fw-icon-chest3.png" />
                                                </div>
                                            </div>
                                            <div className="fw-rating-ped-num-box">
                                                <div className="fw-rating-ped-num var1">
                                                    1-3
                                                </div>
                                            </div>
                                        </div>
                                        <div className="fw-rating-ped-box-p2 rate2">
                                            <div className="fw-rating-ped-pic">
                                                <div className="">
                                                    <img src="https://cdn.faptitans.com/s1/rc/v2-fw-icon-chest2.png" />
                                                </div>
                                            </div>
                                            <div className="fw-rating-ped-num-box">
                                                <div className="fw-rating-ped-num var2">
                                                    4-20
                                                </div>
                                            </div>
                                        </div>
                                        <div className="fw-rating-ped-box-p3 rate3">
                                            <div className="fw-rating-ped-pic">
                                                <div className="">
                                                    <img src="https://cdn.faptitans.com/s1/rc/v2-fw-icon-chest1.png" />
                                                </div>
                                            </div>
                                            <div className="fw-rating-ped-num-box">
                                                <div className="fw-rating-ped-num var3">
                                                    21-100
                                                </div>
                                            </div>
                                        </div>
                                        <div className="fw-rating-ped-box-p4 rate4">
                                            ...
                                            <div className="fw-rating-ped-num-box">
                                                <div className="fw-rating-ped-num var4">
                                                    101-300
                                                </div>
                                            </div>
                                        </div>
