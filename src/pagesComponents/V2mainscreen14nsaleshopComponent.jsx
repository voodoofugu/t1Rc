...
const V2MainScreen14NsaleShopComponent = () => {
    return (
        <>
                            ...
                            <div className="nm-pop-offer-scroll-box">
                                <div className="nm-pop-offer-scroll">
                                    <div className="nm-pop-offer-box-all">
                                        ...
                                        <div className="nm-pop-offer-limit-text">
                                            limit: 1
                                        </div>
...
export default React.memo(V2MainScreen14NsaleShopComponent);
