...
import questTabStory from "../styles/quest_tab_story.scss";
import questTab from "../styles/quest_tab.scss";

const V2MainScreen08UkiStoryComponent = () => {
    return (
        <>
                        ...
                        <div className="journal-story">
                            <div className="heroes-list-all-box">
                                <div className="journal-menu-box">
                                    <div className="color-btn daily">
                                        <a className="" href="#/quests/daily">
                                    ...
                                    <div className="color-btn quest">
                                        <a className="" href="#/quests/quest">
                                            <div className="color-btn-text">
                                                main
                                            </div>
                                        </a>
                                    </div>
                                    <div className="color-btn story blue">
                                        <a className="" href="#/quests/story">
                                            <div className="color-btn-text">
                                                story
                                            </div>
                                        </a>
...
export default React.memo(V2MainScreen08UkiStoryComponent);
