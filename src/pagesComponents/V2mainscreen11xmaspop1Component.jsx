...
const V2MainScreen11XmasPop1Component = () => {
    return (
        <>
            <div className="main world1">
                        ...
                        <div className="tower-rightside-box-all">
                            ...
                            <div className="tower-prg-box-all">
                                <div className="tower-prgbar-all">
                                    ...
                                    <div className="tower-prgbar-text">
                                        event will start in
                                        <span>7D 21:59:55</span>
                                    </div>
                                </div>
                ...
                <div className="popup-layer" style="display: block">
                    ...
                    <div className="m-popup xmas-pop1" style="display: block">
                        <div className="title">X-mas celebration event</div>
                        ...
                        <div className="xmas-box-all">
                            <div className="xmas-collect-box-all">
                                <div className="xmas-collect-box">
                                    <div className="xmas-collect-box-text">
                                        collect tokens to unlock exclusive
                                        rewards!
                                    </div>
                                </div>
                                <div className="prgball-box">
                                    ...
                                    <div className="prg-all-text">
                                        you have 9998/9999
                                        <span className="ic-dildo"></span>tokens
                                    </div>
                                </div>
                            ...
                            <div className="xmas-level-box-all">
                                ...
                                <div className="xmas-level-simple-box-scroll">
                                    <div className="xmas-level-level">
                                        <div className="xmas-level-level-prg"></div>
                                    ...
                                    <div className="xmas-level-reward">
                                        <div className="xmas-level-rew-box">
                                        ...
                                        <div className="xmas-level-rew-box collect">
                                            <div className="xmas-level-rew-pic">
                                                <img src="rc/change-ic-rubin.png" />
                                            </div>
                                            <div className="xmas-level-rew-num">
                                        ...
                                        <div className="xmas-level-rew-box check">
                                            <div className="xmas-level-rew-pic">
                                                <img src="rc/change-ic-rubin.png" />
                                            </div>
                                            <div className="xmas-level-rew-num">
                                        ...
                                        <div className="xmas-level-rew-box block">
                                            <div className="xmas-level-rew-pic">
                                                <img src="rc/change-ic-rubin.png" />
                                            </div>
                                            <div className="xmas-level-rew-num">
                        ...
                        <div className="xmas-girl">
                            <img src="rc/break-girl23-ny.png" />
                        </div>
...
export default React.memo(V2MainScreen11XmasPop1Component);
