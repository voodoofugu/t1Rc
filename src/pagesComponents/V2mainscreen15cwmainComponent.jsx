                                            ...
                                            <div className="cw-main-right-b-box-scroll">
                                                ...
                                                <div className="cw-log-box user-select">
                                                    ...
                                                    <div className="cw-log-text">
                                                        ...
                                                        fuck up my ability to
                                                        bring my might up. Lots
                                                        of wasted promotions.
                                                    </div>
                                                </div>
                                                <div className="cw-log-box user-select">
                                                    <div className="cw-log-date">
                                                ...
                                                <div className="cw-log-box user-select">
                                                    ...
                                                    <div className="cw-log-text">
                                                        ...
                                                        new heroes. I had to
                                                        hire each one and now I
                                                        have to level them all
                                                        up
                                                    </div>
                                                </div>
                                                <div className="cw-log-box user-select">
                                                ...
                                                <div className="cw-log-box user-select">
                                                    ...
                                                    <div className="cw-log-text">
                                                        ...
                                                        guild base click the
                                                        dark tower and on the
                                                        top right there is a
                                                        blue icon, click there
                                                        and the same window will
                                                        open with the option of
                                                        opening the boxes on the
                                                        left
                                                    </div>
                                                </div>
                                                <div className="cw-log-box user-select">
                                                    ...
                                                    <div className="cw-log-text">
                                                        ...
                                                        bluish green icon with a
                                                        countdown of around 2
                                                        days 20 hours, click
                                                        there, a window will
                                                        opoen and on the left of
                                                        that window there is an
                                                        option of open a box or
                                                        open all boxes
                                                    </div>
                                                </div>
                                                <div className="cw-log-box user-select">
                                                ...
                                                <div className="cw-log-box user-select">
                                                    ...
                                                    <div className="cw-log-text">
                                                        ...
                                                        sitting there. All of my
                                                        gild rooms are 1000 and
                                                        only upgrade them all at
                                                        the same time by x50
                                                    </div>
                                                </div>
                                                <div className="cw-log-box user-select">
                                                    <div className="cw-log-date">
                                                ...
                                                <div className="cw-log-box user-select">
                                                    ...
                                                    <div className="cw-log-text">
                                                        ...
                                                        never have to worry
                                                        about gold to upgrade
                                                        your heros any more. And
                                                ...
                                                <div className="cw-log-box user-select">
                                                    ...
                                                    <div className="cw-log-text">
                                                        ...
                                                        promotions. I think you
                                                        can get a total of 50 or
                                                        so I. The game
                                                    </div>
                                                </div>
                                                <div className="cw-log-box user-select">
                                                    ...
                                                    <div className="cw-log-text">
                                                        ...
                                                        time. I spent a total of
                                                        an hour and got number
                                                        one. It doesn't do me
                                                        any. Good since i have
                                                        all the heros they hthey
                                                        give you for being top 3
                                                    </div>
                                                </div>
                                                <div className="cw-log-box user-select">
                                                    <div className="cw-log-date">
                                                    ...
                                                    <div className="cw-log-text">
                                                        ...
                                                        anyone. I just ay like I
                                                        always have but with
                                                ...
                                                <div className="cw-log-box user-select">
                                                    ...
                                                    <div className="cw-log-text">
                                                        ...
                                                        I've found lots of
                                                        little tricks to make
                                                        the game easier. I've
                                                        been playing a long time
                                                        now. Also have 2 # accts
                                                        to test things out
                                                        with.. my second acct wZ
                                                        blowing this one WY
                                                        until I accidentally hit
                                                ...
                                                <div className="cw-log-box user-select">
                                                    ...
                                                    <div className="cw-log-text">
                                                        ...
                                                        from another team to
                                                        read it then go tell his
                                                        buddies. That would
                                                        create too much
                                                        competition... Y k ow?
                                                    </div>
                                                ...
                                                <div className="cw-log-box user-select">
                                                    ...
                                                    <div className="cw-log-text">
                                                        ...
                                                        do to get there quickly
                                                        like I did but you need
                                                        to install discord. I
                                                        won't tell you here.
                                                ...
                                                <div className="cw-log-box user-select">
                                                    ...
                                                    <div className="cw-log-text">
                                                        ...
                                                        used to be in top 3.
                                                        Used to reborn too. Then
                                                        I realuzed reborn is no
                                                        good. Reborn is what you
                                                        do to get the blue and
                                                        orange symbols for the
                                                        master whatever it is
                                                    </div>
                                                </div>
                                                <div className="cw-log-box user-select">
                                                    <div className="cw-log-date">
                                                ...
                                                <div className="cw-log-box user-select">
                                                    ...
                                                    <div className="cw-log-text">
                                                        ...
                                                        further my game I don't
                                                        bother with it.
                                                        Especially if it wants
                                                        me to reborn
                                                    </div>
                                                </div>
                                                <div className="cw-log-box user-select">
                                                ...
                                                <div className="cw-log-box user-select">
                                                    ...
                                                    <div className="cw-log-text">
                                                        ...
                                                        floor 13 in fapopoly
                                                        without free reborns? Or
                                ...
                                <div className="cw-main-right-box-all">
                                    <div>
                                        <div className="cw-main-right-a-box">
                                            <div className="cw-main-right-a-box-name">
                                                Valhalla
                                            </div>
