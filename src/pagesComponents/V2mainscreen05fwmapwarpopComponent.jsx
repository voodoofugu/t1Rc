...
const V2MainScreen05FwMapWarpopComponent = () => {
    return (
        <>
            <div className="main world1">
                ...
                <div className="fw-warpop-box-all left">
                    ...
                    <div className="fw-warpop-box-pic">
                        <img src="img/v2-fw-map-bg3-1.jpg" />
                    </div>
                    ...
                    <div className="fw-warpop-effect-box-all">
                        ...
                        <div className="fw-warpop-income-box">
                            <div className="fw-warpop-income-name">
                                contribution income
                            </div>
                    ...
                    <div className="fw-warpop-at-def-box-all defence">
                        ...
                        <div className="fw-warpop-army-power-box">
                            ...
                            <div className="fw-warpop-army-power-num">
                                69696969
                            </div>
                        </div>
...
export default React.memo(V2MainScreen05FwMapWarpopComponent);
