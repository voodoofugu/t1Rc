...
import screenUnipopStarterpack from "../styles/screen-unipop-starterpack.scss";

const V2Unipop20StarterpackComponent = () => {
    return (
        <>
            <div className="main">
...
export default React.memo(V2Unipop20StarterpackComponent);
