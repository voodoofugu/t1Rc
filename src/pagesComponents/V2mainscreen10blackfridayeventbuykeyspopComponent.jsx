          ...
          >
            ...
            <div className="keys-card-box">
              <div className="keys-but-box">
                <img src="img/v2-bf-key-pop1-gold.png" alt="" />
              </div>
            ...
            <div className="keys-card-box">
              <div className="keys-but-box">
                <img src="img/v2-bf-key-pop2-gold.png" alt="" />
              </div>
            ...
            <div className="keys-card-box">
              <div className="keys-but-box">
                <img src="img/v2-bf-key-pop3-gold.png" alt="" />
              </div>
            ...
            <div className="keys-card-box">
              <div className="keys-but-box">
                <img src="img/v2-bf-key-pop4-gold.png" alt="" />
              </div>
