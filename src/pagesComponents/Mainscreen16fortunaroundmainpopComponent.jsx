                ...
                <div className="header">
                    <div className="res-panel">
                        <div className="res gold">
                            <div className="value">20349 T</div>
                            <div className="mlt-prm">x3212</div>
                            <div className="mlt-tmp">
                                <div className="v">32342</div>
                                <div className="t">12:22</div>
                            </div>
                            <div className="btn-add"></div>
                        </div>
                        <div className="res cri">
                            <div className="value">20349 T</div>
                            <div className="mlt-prm">x3212</div>
                            <div className="mlt-tmp">
                                <div className="v">32342</div>
                    ...
                    <div className="left-panel">
                        <div className="heroes-list">
                            ...
                            <ul className="all-heroes">
                                <ul className="my-heroes">
                                    <li className="hero-card disabled">
                                    ...
                                    <li className="hero-card disabled">
                                        ...
                                        <div className="dps">234234 T</div>
                                        <div className="name">
                                            JOHN DOEHOVARIUS
                                        </div>
                                        <div className="lvl">
                                    ...
                                    <li className="hero-card">
                                        ...
                                        <div className="abil-ready"></div>
                                        <div className="dps">234234 M</div>
                                        <div className="name">
                                            JOHN DOEHOVARIUS
                                        </div>
                                        <div className="lvl">
                                    ...
                                    <li className="hero-card">
                                        ...
                                        <div className="abil-ready"></div>
                                        <div className="dps">234234 R</div>
                                        <div className="name">
                                            JOHN DOEHOVARIUS
                                        </div>
                                        <div className="lvl">
                                            <div className="n">1123</div>
                                        </div>
                                        <div className="btn-buy">
                                            <div className="price gold">
                                                234234
                                ...
                                <div className="new-heroes-title">
                                    Earn gold and unlock new heroes
                                </div>

                                <ul className="new-heroes">
                                    <li className="hero-card">
                                        <div className="avatar"></div>
                                        <div className="dps">234234</div>
                                        <div className="name">
                                            JOHN DOEHOVARIUSDSFASDFAS
                                        </div>
                                        <div className="btn-buy">
                                            <div className="price gold">
                                                234234
 ...
 */}
                    ...
                    <ul className="tabs">
                        <li className="heroes selected"></li>
                        <li className="shop"></li>
                        <li className="achiev disable"></li>
                        <li className="stat"></li>
                        <li className="guild disable"></li>
                ...
                <div className="popup-layer" style={{ display: "block" }}>
                    ...
                    <div
                        ...
                        <div className="fortuna-main-box">
                            ...
                            <div className="push-timer">
                                Next free push in:
                                <span className="push-timer-time">
                                    23:59:59
                                </span>
                            </div>
                            <div className="place">
                                <div className="place-text">
                                    Your place:
                                    <div>Not in rating</div>
                                </div>
                            </div>
                            <div className="fortuna-wheel-all">
                                <div className="fortuna-wheel-box">
                                    <div className="fortuna-wheel b1 good girl doublespin">
                                        <div className="fortuna-prize">
                                            <img
                                                className="prize-pic"
                                                src="rc/icons/ic-abil-185.jpg"
                                            />
                                    ...
                                    <div className="fortuna-wheel b17">
                                        <div className="fortuna-prize">
                                            <img
                                                className="prize-pic"
                                                src="rc/icons/ic-abil-185.jpg"
                                    ...
                                    <div className="fortuna-wheel b18">
                                        <div className="fortuna-prize">
                                            <img
                                                className="prize-pic"
                                                src="rc/icons/ic-abil-185.jpg"
                                    ...
                                    <div className="fortuna-wheel b19">
                                        <div className="fortuna-prize">
                                            <img
                                                className="prize-pic"
                                                src="rc/icons/ic-abil-185.jpg"
                                    ...
                                    <div className="fortuna-wheel b20">
                                        <div className="fortuna-prize">
                                            <img
                                                className="prize-pic"
                                                src="rc/icons/ic-abil-185.jpg"
                                    ...
                                    <div className="fortuna-wheel b21">
                                        <div className="fortuna-prize">
                                            <img
                                                className="prize-pic"
                                                src="rc/icons/ic-abil-185.jpg"
                                    ...
                                    <div className="fortuna-wheel b22">
                                        <div className="fortuna-prize">
                                            <img
                                                className="prize-pic"
                                                src="rc/icons/ic-abil-185.jpg"
                                    ...
                                    <div className="fortuna-wheel b23">
                                        <div className="fortuna-prize">
                                            <img
                                                className="prize-pic"
                                                src="rc/icons/ic-abil-185.jpg"
                                    ...
                                    <div className="fortuna-wheel b24">
                                        <div className="fortuna-prize">
                                            <img
                                                className="prize-pic"
                                                src="rc/icons/ic-abil-185.jpg"
                                    ...
                                    <div className="fortuna-wheel b25">
                                        <div className="fortuna-prize">
                                            <img
                                                className="prize-pic"
                                                src="rc/icons/ic-abil-185.jpg"
                                ...
                                <div className="fortuna-wheel-center">
                                    <div className="fortuna-btn-box">
                                        ...
                                        <div className="color-btn green x10">
                                            <div className="color-btn-text">
                                                push x10
                                                <span className="ff-but"></span>
                                                9999
                            ...
                            <div className="fortuna-main-controls-box">
                                <div className="rjackpot-box collected">
                                    <div className="rname-box">Jackpot</div>
                                    <div className="fortuna-reward-box-all">
                                        <div className="fortuna-reward-box claim-btn">
                                            <div className="fortuna-reward-bg">
                                                <div className="fortuna-reward">
                                                    <img src="images/superhero/suphero-240/x1/avatar/240sh-ava-1.jpg" />
                                                </div>
                                            </div>
                                        ...
                                        <div className="fortuna-reward-box">
                                            <div className="fortuna-reward-bg">
                                                <div className="fortuna-reward">
                                                    <img src="images/superhero/suphero-241/x1/avatar/241sh-ava-1.jpg" />
                                                </div>
                                            </div>
                                            <div className="fortuna-reward-claim-btn">
                                                6969k
                                        ...
                                        <div className="fortuna-reward-box">
                                            <div className="fortuna-reward-bg">
                                                <div className="fortuna-reward">
                                                    <img src="images/superhero/suphero-242/x1/avatar/242sh-ava-1.jpg" />
                                                </div>
                                            </div>
                                            <div className="fortuna-reward-claim-btn">
                                                6969k
                                    ...
                                    <div className="fortuna-reward-box-all second">
                                        <div className="fortuna-reward-box claim-btn">
                                            <div className="fortuna-reward-bg">
                                                <div className="fortuna-reward">
                                                    <img src="images/superhero/suphero-240/x1/avatar/240sh-ava-1.jpg" />
                                        ...
                                        <div className="wf-jp-2-cloaker">
                                            Buy pack to unlock double rewards
                                    ...
                                    <div className="rjackpot-box-collected-label">
                                        <div className="rjackpot-box-collected-label-text">
                                            collected
                                        </div>
                                    </div>
                                </div>
                                <div className="rrevard-box">
                                    ...
                                    <div className="fortuna-reward-btn color-btn blue">
                                        show all
                                    </div>
                                ...
                                <div className="rrules-box">
                                    <div className="rules-text">
                                        <div>
                                            1. During the time of the event, you
                                            can spin the Great Wheel of Fortune
                                            for diamonds.
                                        </div>
                                        <div>
                                            2. Each use of the Push button gives
                                            a prize and increases points
                                            counter.
                                        </div>
                                        <div>
                                            3. As soon as enough points
                                            accumulate, you can get a guaranteed
                                            prize!
                                        </div>
                                        <div>
                                            4. Each push increases the chance to
                                            get Jackpot!
                                        </div>
                                    </div>
                                </div>
...
export default React.memo(MainScreen16FortunaRoundMainpopComponent);
