...
const V2MainScreen16PseInfoPopComponent = () => {
    return (
        <>
                        ...
                        <div className="pse-cf-right-box-all">
                            ...
                            <div className="pse-cf-res-shop-box-all">
                                ...
                                <div className="pse-cf-res-rules-box">
                                    <div className="pse-cf-res-rules-text-box">
                                        <div className="pse-cf-res-rules-text">
                                            EXCHANGE them for choosen rewards.
                                            For each you will get additional
                                            item
                                        </div>
                                    </div>
                                </div>
                                <div className="pse-cf-res-rules-box">
                                    <div className="pse-cf-res-rules-text-box">
                                        <div className="pse-cf-res-rules-text">
                                            COLLECT 10 special items and TAKE
                                            most powerful girl here
                                        </div>
                                    </div>
                                </div>
                            </div>
