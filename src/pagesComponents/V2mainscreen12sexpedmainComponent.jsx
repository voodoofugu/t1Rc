                    ...
                    <div className="sexped-mission-left-side">
                        ...
                        <div className="sexped-mission-description">
                            ...
                            <div className="text-hint-wrap">
                                <div className="text">
                                    Choose/Drag and drop your heroes
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="sexped-mission-right-side">
                        <div className="sexped-mission-team-name">
                            sexpedition team
                        </div>
                        ...
                        <div className="sexped-mission-team-rewards-box">
                            <div className="sexped-mission-rewards-box firstclear check">
                                <div className="sexped-mission-rewards-text">
                                    1st clear
                                </div>
                        ...
                        <div className="m-popup info-pop">
                            ...
                            <div className="content">
                                <div className="text-box">
                                    <div className="text">
                                        <div>
                                            1. The strength of the heroine is
                                            the number of her promotions.
                                        </div>
                                        <div>
                                            2. The strength of a superheroine is
                                            the number of her stars.
                                        </div>
                                        <div>
                                            3. Sexpedition consists of a chain
                                            of battles that follow each other.
                                        </div>
                                        <div>
                                            4. Each battle requires a certain
                                            amount of energy.
                                        </div>
                                        <div>
                                            5. Each battle has its own
                                            limitations on the available
                                            heroines.
                                        </div>
                                        <div>
                                            6. The reward for fighting is chaos
                                            chests and coins of chaos. For coins
                                            of chaos, you can buy additional
                                            chaos chests in the store.
                                        </div>
                                        <div>
                                            7. Opening a chaos chest gives
                                            points for the rating of the
                                            sexpedition, can give points for
                                            energy and superheroes.
                                        </div>
                                        <div>
                                            8. Those who take the highest places
                                            in the ranking will receive unique
                                            superheroines.
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="xmas-daily-prg-box-all">
                                ...
                                <div className="xmas-reward-chest-box undefined undefined undefined">
                                    <div className="xmas-prg-bar-num-line">
                                        <div className="xmas-prg-bar-num">
                                            30
                                        </div>
                                    </div>
