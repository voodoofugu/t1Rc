          ...
          <div className="quest-box wrap closed">
            ...
            <div className="quest-wrap">
              ...
              <div className="quest xmas-ny">
                <img className="icon" src="img/ic-ny-sneg.png" loading="lazy" />
                <div className="timerbox">
                  <div className="timer">287:21:43</div>
                </div>
              </div>
          ...
          <div className="quest-box wrap closed">
            ...
            <div className="quest-wrap">
              ...
              <div className="quest vl-pass">
                <img className="icon" src="img/ic-vl-pass.png" loading="lazy" />
                <div className="timerbox">
                  <div className="timer">287:21:43</div>
                </div>
              </div>
              <div className="quest vl">
                <img className="icon" src="img/ic-vl-orgy.png" loading="lazy" />
                <div className="timerbox">
                  <div className="timer">287:21:43</div>
                </div>
              </div>
              <div className="quest dual-pack-vl">
                <img className="icon" src="img/v2-vl-ball.png" loading="lazy" />
                <div className="timerbox">
                  <div className="timer">00:00:00</div>
                </div>
              </div>
          ...
          <div className="quest-box wrap closed">
            ...
            <div className="quest-wrap">
              <div className="quest lose-boss">
                <img className="icon" src="img/back-girl.png" loading="lazy" />
                <div className="timerbox">
                ...
                <div className="btlpass-level-box-all">
                  ...
                  <div className="btlpass-level-simple-box-scroll indiana-scroll-container">
                    ...
                    <div className="btlpass-level-elite">
                      ...
                      <div className="btlpass-level-rew-box block">
                        <div className="btlpass-level-rew-pic">
                          <img src="img/ic-krasn-butil@2x.png" loading="lazy" />
                        </div>
                        <div className="btlpass-level-rew-good"></div>
                ...
                <div className="main-relics-bonus-box">
                  ...
                  <div className="relics-coll-box-all">
                    ...
                    <div className="relics-coll-box r2">
                      ...
                      <div className="relics-coll">
                        <div className="relics-coll-pic">
                          <img src="img/v2-vl-candys-box.png" loading="lazy" />
                        </div>
                      </div>
                      <div className="relics-coll-check"></div>
                      <div className="color-btn blue">
              ...
              <div className="main-relics-right-box-all">
                <div className="main-relics-bonus-box">
                  ...
                  <div className="relics-coll-box-all">
                    ...
                    <div className="relics-coll-box r2">
                      ...
                      <div className="relics-coll">
                        <div className="relics-coll-pic">
                          <img src="img/ic-march-bouquet.png" loading="lazy" />
                        </div>
                      </div>
                      <div className="relics-coll-check"></div>
                      <div className="color-btn blue">
                ...
                <div className="main-relics-bonus-box">
                  <div className="relics-prize-box-all">
                    <div className="relics-pack-opened-box">
                      <div className="relics-pack-opened-name">
                        <img src="img/ic-march-flower-red.png" loading="lazy" />
                      </div>
                      <div className="relics-pack-opened-count">0/10K</div>
                    </div>
                    <div className="relics-prize-box"></div>
