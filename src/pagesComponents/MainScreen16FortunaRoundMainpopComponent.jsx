...
} from "../styleComponents/ScreenFortunaRoundMain.jsx";

const MainScreen16FortunaRoundMainpopComponent = () => {
    return (
        <HelmetProvider>
            <div className={styleFileName}>
                <Helmet>
                    <style>
                        {`
                                ...
                                <div className="fortuna-main-controls-box">
                                    ...
                                    <div className="rrules-box">
                                        <div className="rules-text">
                                            <div>
                                                1. During the time of the event,
                                                you can spin the Great Wheel of
                                                Fortune for diamonds.
                                            </div>
                                            <div>
                                                2. Each use of the Push button
                                                gives a prize and increases
                                                points counter.
                                            </div>
                                            <div>
                                                3. As soon as enough points
                                                accumulate, you can get a
                                                guaranteed prize!
                                            </div>
                                            <div>
                                                4. Each push increases the
