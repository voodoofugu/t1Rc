            ...
            <div id="popupContainer" className="popup-in">
              <div className="m-popup hw-btlpass-pop rpg__">
                ...
                <div className="hw-btlpass-box-all">
                  ...
                  <div className="hw-btlpass-level-box-all">
                    <div className="hw-btlpass-sim-el-box">
                      <div className="hw-btlpass-level">level</div>
                      <div className="hw-btlpass-elite">rewards</div>
                    </div>
                    <div className="hw-btlpass-level-simple-box-scroll indiana-scroll-container">
                      <div className="hw-btlpass-level-level">
                        ...
                        <div className="hw-btlpass-level-level-num-box">
                          <div className="hw-btlpass-level-level-num">1</div>
                          <div className="hw-btlpass-level-level-num">2</div>
                          <div className="hw-btlpass-level-level-num">3</div>
                          <div className="hw-btlpass-level-level-num">4</div>
                          <div className="hw-btlpass-level-level-num">5</div>
                          <div className="hw-btlpass-level-level-num">6</div>
                          <div className="hw-btlpass-level-level-num">7</div>
                          <div className="hw-btlpass-level-level-num">8</div>
                          <div className="hw-btlpass-level-level-num">9</div>
                          <div className="hw-btlpass-level-level-num">10</div>
                          <div className="hw-btlpass-level-level-num">11</div>
                          <div className="hw-btlpass-level-level-num">12</div>
                          <div className="hw-btlpass-level-level-num">13</div>
                          <div className="hw-btlpass-level-level-num">14</div>
                          <div className="hw-btlpass-level-level-num">15</div>
                          <div className="hw-btlpass-level-level-num">16</div>
                          <div className="hw-btlpass-level-level-num">17</div>
                          <div className="hw-btlpass-level-level-num">18</div>
                          <div className="hw-btlpass-level-level-num">19</div>
                          <div className="hw-btlpass-level-level-num">20</div>
                          <div className="hw-btlpass-level-level-num">21</div>
                          <div className="hw-btlpass-level-level-num">22</div>
                          <div className="hw-btlpass-level-level-num">23</div>
                          <div className="hw-btlpass-level-level-num">24</div>
                          <div className="hw-btlpass-level-level-num">25</div>
                          <div className="hw-btlpass-level-level-num">26</div>
                          <div className="hw-btlpass-level-level-num">27</div>
                          <div className="hw-btlpass-level-level-num">28</div>
                          <div className="hw-btlpass-level-level-num">29</div>
                          <div className="hw-btlpass-level-level-num">30</div>
                          <div className="hw-btlpass-level-level-num">31</div>
                          <div className="hw-btlpass-level-level-num">32</div>
                          <div className="hw-btlpass-level-level-num">33</div>
                          <div className="hw-btlpass-level-level-num">34</div>
                          <div className="hw-btlpass-level-level-num">35</div>
                          <div className="hw-btlpass-level-level-num">36</div>
                          <div className="hw-btlpass-level-level-num">37</div>
                          <div className="hw-btlpass-level-level-num">38</div>
                          <div className="hw-btlpass-level-level-num">39</div>
                          <div className="hw-btlpass-level-level-num">40</div>
                          <div className="hw-btlpass-level-level-num">41</div>
                          <div className="hw-btlpass-level-level-num">42</div>
                          <div className="hw-btlpass-level-level-num">43</div>
                          <div className="hw-btlpass-level-level-num">44</div>
                          <div className="hw-btlpass-level-level-num">45</div>
                          <div className="hw-btlpass-level-level-num">46</div>
                          <div className="hw-btlpass-level-level-num">47</div>
                          <div className="hw-btlpass-level-level-num">48</div>
                          <div className="hw-btlpass-level-level-num">49</div>
                          <div className="hw-btlpass-level-level-num">50</div>
                        </div>
                      </div>
                      <div className="hw-btlpass-level-elite">
                        <div className="hw-btlpass-level-rew-box block">
                          ...
                          <div className="hw-btlpass-level-rew-num">67.2Q</div>
                        ...
                        <div className="hw-btlpass-level-rew-box block">
                          ...
                          <div className="hw-btlpass-level-rew-good"></div>
                          <div className="hw-btlpass-level-rew-num">2</div>
                          <div className="hw-btlpass-level-rew-num-check"></div>
                          <div className="color-btn green">
                            <div className="color-btn-text">собрать</div>
                          </div>
                        ...
                        <div className="hw-btlpass-level-rew-box block">
                          ...
                          <div className="hw-btlpass-level-rew-good"></div>
                          <div className="hw-btlpass-level-rew-num">3</div>
                          <div className="hw-btlpass-level-rew-num-check"></div>
                          <div className="color-btn green">
                            <div className="color-btn-text">собрать</div>
                          </div>
                        ...
                        <div className="hw-btlpass-level-rew-box block">
                          ...
                          <div className="hw-btlpass-level-rew-good"></div>
                          <div className="hw-btlpass-level-rew-num">95</div>
                          <div className="hw-btlpass-level-rew-num-check"></div>
                          <div className="color-btn green">
                            <div className="color-btn-text">собрать</div>
                          </div>
                        ...
                        <div className="hw-btlpass-level-rew-box block">
                          ...
                          <div className="hw-btlpass-level-rew-good"></div>
                          <div className="hw-btlpass-level-rew-num">4</div>
                          <div className="hw-btlpass-level-rew-num-check"></div>
                          <div className="color-btn green">
                            <div className="color-btn-text">собрать</div>
                          </div>
                        ...
                        <div className="hw-btlpass-level-rew-box block">
                          ...
                          <div className="hw-btlpass-level-rew-good"></div>
                          <div className="hw-btlpass-level-rew-num">190</div>
                          <div className="hw-btlpass-level-rew-num-check"></div>
                          <div className="color-btn green">
                            <div className="color-btn-text">собрать</div>
                          </div>
                        ...
                        <div className="hw-btlpass-level-rew-box block girl">
                          ...
                          <div className="hw-btlpass-level-rew-good"></div>
                          <div className="hw-btlpass-level-rew-num">700</div>
                          <div className="hw-btlpass-level-rew-num-check"></div>
                          <div className="color-btn green">
                            <div className="color-btn-text">собрать</div>
                          </div>
                        ...
                        <div className="hw-btlpass-level-rew-box block">
                          ...
                          <div className="hw-btlpass-level-rew-good"></div>
                          <div className="hw-btlpass-level-rew-num">6</div>
                          <div className="hw-btlpass-level-rew-num-check"></div>
                          <div className="color-btn green">
                            <div className="color-btn-text">собрать</div>
                          </div>
                        ...
                        <div className="hw-btlpass-level-rew-box block">
                          ...
                          <div className="hw-btlpass-level-rew-good"></div>
                          <div className="hw-btlpass-level-rew-num">50</div>
                          <div className="hw-btlpass-level-rew-num-check"></div>
                          <div className="color-btn green">
                            <div className="color-btn-text">собрать</div>
                          </div>
                        ...
                        <div className="hw-btlpass-level-rew-box block">
                          ...
                          <div className="hw-btlpass-level-rew-good"></div>
                          <div className="hw-btlpass-level-rew-num">100</div>
                          <div className="hw-btlpass-level-rew-num-check"></div>
                          <div className="color-btn green">
                            <div className="color-btn-text">собрать</div>
                          </div>
                ...
                <div className="hw-btlpass-girl">
                  <img src="img/break-girl753-hw.png" loading="lazy" />
                </div>
                ...
                <div className="fapop-rating-content">
                          ...
                          <div className="rating-scroll">
                            <div>
                              ...
                              <div className="rating-card color2">
                                ...
                                <div className="name">great1962 clan RUS</div>
                                <div className="points">915200</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card">
                                <div className="number">2</div>
                                <div className="name">Strannyk clan RUS</div>
                                <div className="points">792365</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card color2">
                                <div className="number">3</div>
                                <div className="name">Lalo-Reborn</div>
                                <div className="points">470045</div>
                              </div>
                            </div>
                            <div>
                              ...
                              <div className="rating-card">
                                ...
                                <div className="name">BiocanonPT</div>
                                <div className="points">454185</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card color2">
                                <div className="number">5</div>
                                <div className="name">butterman5</div>
                                <div className="points">395850</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card">
                                <div className="number">6</div>
                                <div className="name">rage_k</div>
                                <div className="points">392050</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card color2">
                                <div className="number">7</div>
                                <div className="name">guest195157216</div>
                                <div className="points">332695</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card">
                                <div className="number">8</div>
                                <div className="name">seraph26</div>
                                <div className="points">166255</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card color2">
                                <div className="number">9</div>
                                <div className="name">Brandor</div>
                                <div className="points">159065</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card">
                                <div className="number">10</div>
                                <div className="name">Abaris</div>
                                <div className="points">100240</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card color2">
                                <div className="number">11</div>
                                <div className="name">vynil22</div>
                                <div className="points">60355</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card">
                                <div className="number">12</div>
                                <div className="name">dak2mee</div>
                                <div className="points">49205</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card color2">
                                <div className="number">13</div>
                                <div className="name">Ksirion</div>
                                <div className="points">34375</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card">
                                <div className="number">14</div>
                                <div className="name">wilfridsellars</div>
                                <div className="points">28820</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card color2">
                                <div className="number">15</div>
                                <div className="name">HH1488babar666</div>
                                <div className="points">12275</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card">
                                <div className="number">16</div>
                                <div className="name">DEVIL_VALAK</div>
                                <div className="points">9630</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card color2">
                                <div className="number">17</div>
                                <div className="name">Ron85</div>
                                <div className="points">9605</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card">
                                <div className="number">18</div>
                                <div className="name">joako33</div>
                                <div className="points">9490</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card color2">
                                <div className="number">19</div>
                                <div className="name">ElDarkikoulol</div>
                                <div className="points">8880</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card">
                                <div className="number">20</div>
                                <div className="name">kuroneko4110</div>
                                <div className="points">8470</div>
                              </div>
                            </div>
                            <div>
                              ...
                              <div className="rating-card color2">
                                ...
                                <div className="name">4nubis</div>
                                <div className="points">8250</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card">
                                <div className="number">22</div>
                                <div className="name">J1MmY9</div>
                                <div className="points">8230</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card color2">
                                <div className="number">23</div>
                                <div className="name">Redpala23</div>
                                <div className="points">8070</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card">
                                <div className="number">24</div>
                                <div className="name">cjdkslagtqfhedkasj</div>
                                <div className="points">4650</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card color2">
                                <div className="number">25</div>
                                <div className="name">blubb5511</div>
                                <div className="points">3645</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card active">
                                ...
                                <div className="points">2760</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card color2">
                                <div className="number">27</div>
                                <div className="name">Count_Dan99</div>
                                <div className="points">1800</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card">
                                ...
                                <div className="points">1080</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card color2">
                                <div className="number">29</div>
                                <div className="name">Noodlearms52</div>
                            ...
                            <div>
                              <div className="rating-card">
                                ...
                                <div className="name">aharond</div>
                                <div className="points">1000</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card color2">
                                ...
                                <div className="name">tecmogod</div>
                                <div className="points">345</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card">
                                <div className="number">32</div>
                                <div className="name">biker72</div>
                                <div className="points">130</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card color2">
                                <div className="number">33</div>
                                <div className="name">Fujisaki3986</div>
                            ...
                            <div>
                              <div className="rating-card">
                                ...
                                <div className="name">Kojima2558</div>
                                <div className="points">80</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card color2">
                                ...
                                <div className="name">Bloodking6</div>
                                <div className="points">80</div>
                              </div>
                            </div>
                            <div>
                              <div className="rating-card">
                                ...
                                <div className="name">roromomo2</div>
                                <div className="points">80</div>
                              </div>
                            </div>
                            <div>
                            ...
                            <div>
                              <div className="rating-card color2">
                                ...
                                <div className="name">Ogava6114</div>
                  ...
                  <div className="fapop-topreward-box-all">
                    <div className="cardnameback">
                      <div className="card-text">top reward</div>
                    </div>
                    <div className="lhero-box">
                      <div className="lhero-pic">
                        <img
                          src="img/images/superhero/suphero-250/x2/250sh-1.jpg"
                          loading="lazy"
                        />
                      </div>
                      <div className="topname-box">
                        ...
                        <div className="lhero-name-box">
                          <div className="lhero-name">Tanigawa Kazue</div>
                        </div>
                      </div>
                      <div className="bottom-star-box-girl-count-box">
                        <div className="sh2-prgbar-all undefined">
                          ...
                          ></div>
                          <div className="sh2-prgbar-text">0/30</div>
                        </div>
                        <div className="girl-bonus-box">
                          <div className="girl-bonus-pic">
                            <img
                              src="img/images/superhero/suphero-250/x2/avatar/250sh-ava-1.jpg"
                              loading="lazy"
                            />
                          </div>
                        </div>
                      ...
                      <div className="sv-sale-bonus-box-all">
                        <div className="ashero-bonus-box">
                          <div className="acbonus-box">
                            <div className="lvlbox-name">Undercover cop</div>
                          ...
                          <div className="acbonus-box second">
                            <div className="lvlbox-name">Dangerous thing</div>
                            <div className="bonus-lvl-box-bonus-box">
                              <div className="bonus-lvl-box-bonus">
                                +4.1% dps to
