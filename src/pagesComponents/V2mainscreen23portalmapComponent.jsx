                    ...
                    <div className="dungTreas-btn">
                        <div className="dungTreas-inf-ic">
                            <div className="dungTreas-inf-box">
                                <div className="dungTreas-tit">
                                    Dungeon Treasures
                                </div>
                                <div className="dungTreas-cont">
                                    <div className="dungTreas-text">
                                        Here you can get rewards after a certain
                                        time.
                                        <br />
                                        To level up the dungeon, you will need a
                                        <p>special reward*</p>, which can be
                                        found in chests on the map.
                                    </div>
                                    <div className="mark">
                                        <img
                                            className="prize-pic"
