        ...
        <>
            <div className="main world1">
                ...
                <div className="popup-layer" style="display: block">
                    ...
                    <div
                        className="m-popup store-heroes"
                        style="display: block">
                                        ...
                                        <div className="spin-girl-box">
                                            ...
                                            <div className="spinroll-box">
                                                <div className="spinroll-girl">
                                                    <img src="rc/tithero-04-1-ava.jpg" />
                                                </div>
                                                <div className="spinroll-girl">
                                                    <img src="rc/tithero-10-2-ava.jpg" />
                                                </div>
                                                <div className="spinroll-girl">
                                                    <img src="rc/tithero-11-1-ava.jpg" />
                                                </div>
                                                <div className="spinroll-girl">
                                                    <img src="rc/tithero-19-1-ava.jpg" />
                                                </div>
                                                <div className="spinroll-girl">
                                                    <img src="rc/tithero-30-1-ava.jpg" />
                                                </div>
                                                <div className="spinroll-girl">
                                                    <img src="rc/tithero-31-2-ava.jpg" />
                                                </div>
                                                <div className="spinroll-girl">
                                                    <img src="rc/tithero-32-2-ava.jpg" />
                                                </div>
                                                <div className="spinroll-girl">
                                                    <img src="rc/tithero-33-2-ava.jpg" />
                                                </div>
                                                <div className="spinroll-girl">
                                                    <img src="rc/tithero-34-2-ava.jpg" />
                                                </div>
                                                <div className="spinroll-girl">
                                                    <img src="rc/tithero-35-2-ava.jpg" />
                                                </div>
                                            </div>
                            ...
                            <div className="rules-box-all">
                                <div className="rules-box">
                                    ...
                                    <div className="rules-text">
                                        Здесь ты повышаешь 3-х случайных героев.
                                        Нажми Крутить для начала.
                                    </div>
                                </div>
