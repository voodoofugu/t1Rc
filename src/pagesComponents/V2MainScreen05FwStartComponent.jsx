          ...
          <div className="shop-chest-box-all">
            ...
            <div>
              <div className="res-chest-btn">
                ...
                <div className="res-chest-btn-count">13</div>
          ...
          <div className="left-panel wide false false">
            <div className="">
              <div className="tab-panel-box fw-main">
                <div>
                  <div className="tab-panel-box-title">Faption Wars</div>
                  <div>
                    <div className="fw-right-side-content-box">
                      <div className="fw-flag-box fr1">
                        ...
                        <div className="color-btn disabled0">
                          <div className="color-btn-text">Wait for start</div>
                        </div>
                      </div>
                    </div>
                    <div className="fw-info-box">
                      <div className="fw-fraction-rules-title">Rules</div>
                      <div className="fw-fraction-rules-text">
                        <div>
                          1. Join Faption Wars in a crusade against the army of
                          powerful monsters.
                        </div>
                        <div>
                          2. Each war begins with starting points at the center
                          of the map.
                        </div>
                        <div>
                          3. Each war begins on Monday at 13:00 GMT and ends on
                          Friday at 13:00 GMT
                        </div>
                        <div>
                          4. You can take part in the war, exposing your troops
                          to attack or defend the cells of the field.
                        </div>
                        <div>
                          5. Your troops are your heroines and superheroes. The
                          strength of your troops depends on the number of stars
                          or promotions.
                        </div>
                        <div>
                          6. Monsters will try to fight back the map! Each round
                          there will be riots.
                        </div>
                        <div>
                          7. Participate in the Faption War, seize the land,
                          earn contribution points and take a worthy place at
                          the top!
                        </div>
                      </div>
                    </div>
...
export default React.memo(V2MainScreen05FwStartComponent);
